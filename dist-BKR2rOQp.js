...
import { A as t, B as n, E as r, H as i, K as a, R as o, V as s, g as c, i as ee, n as l, r as u, s as d, u as f, w as p } from "./dist-C56v8Vz7.js";
//#region node_modules/@lezer/css/dist/index.js
var m = 135, h = 1, te = 136, ne = 137, g = 2, _ = 138, v = 3, re = 4, y = [
	9,
	10,
	11,
	12,
	...
	8287,
	12288
], b = 58, ie = 40, x = 95, ae = 91, S = 45, oe = 46, se = 35, C = 37, w = 38, T = 92, E = 10, D = 42;
function O(e) {
...
function A(e) {
	return k(e) || e >= 97 && e <= 102 || e >= 65 && e <= 70;
}
var j = (e, t, n) => (r, i) => {
	for (let a = !1, o = 0, s = 0;; s++) {
		let { next: c } = r;
		if (O(c) || c == S || c == x || a && k(c)) !a && (c != S || s > 0) && (a = !0), o === s && c == S && o++, r.advance();
		else if (c == T && r.peek(1) != E) {
			if (r.advance(), A(r.next)) {
				do
					r.advance();
				while (A(r.next));
				r.next == 32 && r.advance();
			...
			a && r.acceptToken(o == 2 && i.canShift(g) ? t : c == ie ? n : e);
			break;
		}
	}
}, M = new l(j(te, g, ne), { contextual: !0 }), N = new l(j(_, v, re), { contextual: !0 }), P = new l((e) => {
	if (y.includes(e.peek(-1))) {
		let { next: t } = e;
		(O(t) || t == x || t == se || t == oe || t == D || t == ae || t == b && O(e.peek(1)) || t == S || t == w) && e.acceptToken(m);
	}
}), F = new l((e) => {
	if (!y.includes(e.peek(-1))) {
		let { next: t } = e;
		if (t == C && (e.advance(), e.acceptToken(h)), O(t)) {
			do
				e.advance();
			while (O(e.next) || k(e.next));
			e.acceptToken(h);
		}
	}
}), I = n({
	"AtKeyword import charset namespace keyframes media supports font-feature-values": s.definitionKeyword,
	...
	tokenizers: [
		...
		3,
		4,
		new ee("m~RRYZ[z{a~~g~aO$T~~dP!P!Qg~lO$U~~", 28, 142)
	],
	topRules: {
		StyleSheet: [0, 6],
		Styles: [1, 116]
	...
	css: () => $,
	cssCompletionSource: () => Z,
	cssLanguage: () => Q,
	defineCSSCompletionSource: () => X
}), U = null;
function W() {
...
var J = /* @__PURE__ */ new a(), pe = ["Declaration"];
function me(e) {
	for (let t = e;;) {
...
function Y(e, t, n) {
	if (t.to - t.from > 4096) {
		let r = J.get(t);
		if (r) return r;
		let a = [], o = /* @__PURE__ */ new Set(), s = t.cursor(i.IncludeAnonymous);
		if (s.firstChild()) do
			for (let t of Y(e, s.node, n)) o.has(t.label) || (o.add(t.label), a.push(t));
		while (s.nextSibling());
		return J.set(t, a), a;
	} else {
		let r = [], i = /* @__PURE__ */ new Set();
		return t.cursor().iterate((t) => {
			if (n(t) && t.matchContext(pe) && t.node.nextSibling?.name == ":") {
...
var X = (e) => (t) => {
	let { state: n, pos: r } = t, i = o(n).resolveInner(r, -1), a = i.type.isError && i.from == i.to - 1 && n.doc.sliceString(i.from, i.to) == "-";
	...
	if (e(i) || (t.explicit || a) && fe(i, n.doc)) return {
		from: e(i) || a ? i.from : r,
		options: Y(n.doc, me(i), e),
		validFor: de
	};
	if (i.name == "TagName") {
	...
	let s = i.resolve(r), c = s.childBefore(r);
...
}, Z = /* @__PURE__ */ X((e) => e.name == "VariableName"), Q = /* @__PURE__ */ d.define({
	name: "css",
	parser: /* @__PURE__ */ V.configure({ props: [/* @__PURE__ */ t.add({ Declaration: /* @__PURE__ */ c() }), /* @__PURE__ */ r.add({ "Block KeyframeList": p })] }),
	languageData: {
		commentTokens: { block: {
			open: "/*",
			close: "*/"
...
function $() {
	return new f(Q, Q.data.of({ autocomplete: Z }));
}
//#endregion
export { H as i, Q as n, X as r, $ as t };

//# sourceMappingURL=dist-BKR2rOQp.js.map