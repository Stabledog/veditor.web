...
function e(e) {
	...
	function c(e, r) {
		...
		if (e.match(/^\\[a-zA-Z@\xc0-\u1fff\u2060-\uffff]+/)) {
			...
			return a = o.hasOwnProperty(c) ? o[c] : o.DEFAULT, a = new a(), t(r, a), s(r, u), a.style;
		}
		if (e.match(/^\\[$&%#{}_]/) || e.match(/^\\[,;!\/\\]/)) return "tag";
		if (e.match("\\[")) return s(r, function(e, t) {
			return l(e, t, "\\]");
		}), "keyword";
		if (e.match("\\(")) return s(r, function(e, t) {
			return l(e, t, "\\)");
		...
		return d == "{" || d == "[" ? (a = o.DEFAULT, a = new a(), t(r, a), "bracket") : /\d/.test(d) ? (e.eatWhile(/[\w.%]/), "atom") : (e.eatWhile(/[\w\-_]/), a = i(r), a.name == "begin" && (a.argument = e.current()), a.styleIdentifier());
	}
	function l(e, t, n) {
	...
	function u(e, t) {
		var i = e.peek(), a;
		return i == "{" || i == "[" ? (a = n(t), a.openBracket(i), e.eat(i), s(t, c), "bracket") : /[ \t\r]/.test(i) ? (e.eat(i), null) : (s(t, c), r(t), c(e, t));
	}
	return {
		name: "stex",
		startState: function() {
...
//# sourceMappingURL=stex-CntQq5ZQ.js.map