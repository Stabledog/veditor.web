...
import { A as t, B as n, E as r, Et as i, H as a, I as o, K as s, Q as c, R as l, V as u, g as d, i as f, n as p, r as ee, s as m, t as te, u as ne, v as re, w as ie, x as ae, y as oe } from "./dist-CXEBfo4y.js";
import { a as se, c as h, s as ce } from "./dist-4j5R-sb6.js";
...
var je = typeof navigator == "object" && /* @__PURE__ */ /Android\b/.test(navigator.userAgent), $ = /* @__PURE__ */ c.inputHandler.of((e, t, n, r, a) => {
	if ((je ? e.composing : e.compositionStarted) || e.state.readOnly || t != n || r != ">" && r != "/" || !W.isActiveAt(e.state, t, -1)) return !1;
	let o = a(), { state: s } = o, c = s.changeByRange((e) => {
		let { head: t } = e, n = l(s).resolveInner(t - 1, -1), a;
		if (n.name == "JSXStartTag" && (n = n.parent), !(s.doc.sliceString(t - 1, t) != r || n.name == "JSXAttributeValue" && n.to > t)) {
			...
			if (r == "/" && n.name == "JSXStartCloseTag") {
				...
				if (r && e.from == t - 2 && ((a = Q(s.doc, r.firstChild, t)) || r.firstChild?.name == "JSXFragmentTag")) {
					let e = `${a}>`;
					return {
						range: i.cursor(t + e.length, -1),
						changes: {
							from: t,
							insert: e
						}
...
//# sourceMappingURL=dist-BEnnoCKA.js.map