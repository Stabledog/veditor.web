import { A as e, B as t, E as n, H as r, K as i, R as a, V as o, n as s, r as ee, s as te, t as ne, u as re, w as ie, y as c } from "./dist-CVKUUr4R.js";
import { a as ae, c as l, s as oe } from "./dist-DnNU6R8z.js";
//#region node_modules/@lezer/python/dist/index.js
var se = 1, u = 194, d = 195, ce = 196, f = 197, le = 198, ue = 199, de = 200, fe = 2, p = 3, m = 201, h = 24, pe = 25, me = 49, he = 50, ge = 55, _e = 56, ve = 57, ye = 59, be = 60, xe = 61, Se = 62, Ce = 63, we = 65, Te = 238, Ee = 71, De = 241, Oe = 242, ke = 243, Ae = 244, g = 245, _ = 246, v = 247, y = 248, b = 72, x = 249, S = 250, C = 251, je = 252, Me = 253, Ne = 254, Pe = 255, Fe = 256, Ie = 73, Le = 77, Re = 263, ze = 112, Be = 130, Ve = 151, He = 152, Ue = 155, w = 10, T = 13, E = 32, D = 9, O = 35, We = 40, Ge = 46, k = 123, A = 125, j = 39, M = 34, N = 92, P = 111, Ke = 120, qe = 78, Je = 117, Ye = 85, Xe = /* @__PURE__ */ new Set([
	pe,
	me,
	he,
	Re,
...
var Ze = new s((e, t) => {
	let n;
	if (e.next < 0) e.acceptToken(ue);
	else if (t.context.flags & L) F(e.next) && e.acceptToken(le, 1);
	else if (((n = e.peek(-1)) < 0 || F(n)) && t.canShift(f)) {
		let t = 0;
		for (; e.next == E || e.next == D;) e.advance(), t++;
		(e.next == w || e.next == T || e.next == O) && e.acceptToken(f, -t);
	} else F(e.next) && e.acceptToken(ce, 1);
}, { contextual: !0 }), Qe = new s((e, t) => {
	let n = t.context;
	if (n.flags) return;
	let r = e.peek(-1);
	if (r == w || r == T) {
		...
		for (;;) {
			if (e.next == E) t++;
			else if (e.next == D) t += 8 - t % 8;
			else break;
			e.advance(), r++;
		}
		t != n.indent && e.next != w && e.next != T && e.next != O && (t < n.indent ? e.acceptToken(d, -r) : e.acceptToken(u));
	}
}), L = 1, R = 2, z = 4, B = 8, V = 16, H = 32;
function U(e, t, n) {
	this.parent = e, this.indent = t, this.flags = n, this.hash = (e ? e.hash + e.hash << 8 : 0) + t + (t << 4) + n + (n << 6);
}
var $e = new U(null, 0, 0);
function et(e) {
	let t = 0;
	for (let n = 0; n < e.length; n++) t += e.charCodeAt(n) == D ? 8 - t % 8 : 1;
	return t;
}
var W = new Map([
	[De, 0],
	...
	[Pe, 56],
	[Fe, 60]
].map(([e, t]) => [e, t | R])), tt = new ne({
	start: $e,
	reduce(e, t, n, r) {
		return e.flags & L && Xe.has(t) || (t == Ee || t == b) && e.flags & R ? e.parent : e;
	},
	shift(e, t, n, r) {
		return t == u ? new U(e, et(r.read(r.pos, n.pos)), 0) : t == d ? e.parent : t == h || t == ge || t == ye || t == p ? new U(e, 0, L) : W.has(t) ? new U(e, 0, W.get(t) | e.flags & L) : e;
	},
	hash(e) {
		return e.hash;
	}
	...
	if (!/\w/.test(String.fromCharCode(e.next))) for (let t = 0;; t++) {
		let n = e.peek(t);
		if (n != E && n != D) {
			n != We && n != Ge && n != w && n != T && n != O && e.acceptToken(se);
			return;
		}
	}
}), rt = new s((e, t) => {
	let { flags: n } = t.context, r = n & z ? M : j, i = (n & B) > 0, a = !(n & V), o = (n & H) > 0, s = e.pos;
	for (; !(e.next < 0);) if (o && e.next == k) {
		if (e.peek(1) == k) e.advance(2);
		else {
			if (e.pos == s) {
				e.acceptToken(p, 1);
				return;
		...
		if (e.pos == s) {
			e.advance();
			let t = e.next;
			t >= 0 && (e.advance(), it(e, t)), e.acceptToken(fe);
			return;
		}
		break;
	} else if (e.next == N && !a && e.peek(1) > -1) e.advance(2);
	else if (e.next == r && (!i || e.peek(1) == r && e.peek(2) == r)) {
		if (e.pos == s) {
			e.acceptToken(m, i ? 3 : 1);
			return;
		}
		break;
	} else if (e.next == w) {
	...
	e.pos > s && e.acceptToken(de);
});
function it(e, t) {
	if (t == P) for (let t = 0; t < 2 && e.next >= 48 && e.next <= 55; t++) e.advance();
	else if (t == Ke) for (let t = 0; t < 2 && I(e.next); t++) e.advance();
	else if (t == Je) for (let t = 0; t < 4 && I(e.next); t++) e.advance();
	else if (t == Ye) for (let t = 0; t < 8 && I(e.next); t++) e.advance();
	else if (t == qe && e.next == k) {
		for (e.advance(); e.next >= 0 && e.next != A && e.next != j && e.next != M && e.next != w;) e.advance();
		e.next == A && e.advance();
	}
}
var at = t({
	...
	tokenPrec: 7668
}), G = /*@__PURE__*/ new i(), K = /*@__PURE__*/ new Set([
	"Script",
	"Body",
	"FunctionDefinition",
	"ClassDefinition",
...
var ct = {
	FunctionDefinition: /*@__PURE__*/ q("function"),
	ClassDefinition: /*@__PURE__*/ q("class"),
	ForStatement(e, t, n) {
		if (n) {
	...
	CapturePattern: /*@__PURE__*/ q("variable"),
	AsPattern: /*@__PURE__*/ q("variable"),
	__proto__: null
};
function J(e, t) {
	let n = G.get(t);
	...
	return t.cursor(r.IncludeAnonymous).iterate((t) => {
		if (t.name) {
			let e = ct[t.name];
			if (e && e(t, o, a) || !a && K.has(t.name)) return !1;
			a = !1;
		} else if (t.to - t.from > 8192) {
			for (let n of J(e, t.node)) i.push(n);
			return !1;
		}
	}), G.set(t, i), i;
}
var Y = /^[\w\xa1-\uffff][\w\d\xa1-\uffff]*$/, X = [
	"String",
	"FormatString",
	"Comment",
	"PropertyName"
...
function lt(e) {
	let t = a(e.state).resolveInner(e.pos, -1);
	if (X.indexOf(t.name) > -1) return null;
	let n = t.name == "VariableName" || t.to - t.from < 20 && Y.test(e.state.sliceDoc(t.from, t.to));
	if (!n && !e.explicit) return null;
	let r = [];
	for (let n = t; n; n = n.parent) K.has(n.name) && (r = r.concat(J(e.state.doc, n)));
	return {
		options: r,
		from: n ? t.from : e.pos,
		validFor: Y
...
], ft = /*@__PURE__*/ oe(X, /*@__PURE__*/ ae(/*@__PURE__*/ ut.concat(dt)));
function Z(e) {
...
var $ = /*@__PURE__*/ te.define({
	name: "python",
	parser: /*@__PURE__*/ st.configure({ props: [/*@__PURE__*/ e.add({
		Body: (e) => Q(e, /^\s*(#|$)/.test(e.textAfter) && Z(e) || e.node) ?? e.continue(),
		MatchBody: (e) => Q(e, Z(e) || e.node) ?? e.continue(),
		...
		"TupleExpression ComprehensionExpression ParamList ArgList ParenthesizedExpression": /*@__PURE__*/ c({ closing: ")" }),
		"DictionaryExpression DictionaryComprehensionExpression SetExpression SetComprehensionExpression": /*@__PURE__*/ c({ closing: "}" }),
		"ArrayExpression ArrayComprehensionExpression": /*@__PURE__*/ c({ closing: "]" }),
		MemberExpression: (e) => e.baseIndent + e.unit,
		"String FormatString": () => null,
		Script: (e) => {
			let t = Z(e);
			return (t && Q(e, t)) ?? e.continue();
		}
	}), /*@__PURE__*/ n.add({
...
function pt() {
	return new re($, [$.data.of({ autocomplete: lt }), $.data.of({ autocomplete: ft })]);
}
//#endregion
export { pt as python };

//# sourceMappingURL=dist-B9GXq-8W.js.map