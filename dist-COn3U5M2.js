import { A as e, B as t, E as n, Et as r, Q as i, R as a, V as o, h as s, n as c, r as l, s as u, t as d, u as f } from "./dist-CXEBfo4y.js";
...
function H(e, t) {
	let n = a(e).resolveInner(t, -1), r = null;
...
var Z = /* @__PURE__ */ i.inputHandler.of((e, t, n, i, o) => {
	if (e.composing || e.state.readOnly || t != n || i != ">" && i != "/" || !J.isActiveAt(e.state, t, -1)) return !1;
	let s = o(), { state: c } = s, l = c.changeByRange((e) => {
		let { head: t } = e, n = c.doc.sliceString(t - 1, t) == i, o = a(c).resolveInner(t, -1), s;
		if (n && i == ">" && o.name == "EndTag") {
			let n = o.parent;
		...
		} else if (n && i == "/" && o.name == "StartCloseTag") {
			let e = o.parent;
			if (o.from == t - 2 && e.lastChild?.name != "CloseTag" && (s = X(c.doc, e, t))) {
				let e = t + +(c.doc.sliceString(t, t + 1) === ">"), n = `${s}>`;
				return {
...
//# sourceMappingURL=dist-COn3U5M2.js.map