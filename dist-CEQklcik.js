import { A as e, B as t, E as n, Et as r, Q as i, R as a, V as o, Y as s, i as c, n as l, r as u, s as d, u as f, y as p } from "./dist-CXEBfo4y.js";
import { n as m } from "./dist-GoPv4FTn.js";
...
var L = /* @__PURE__ */ i.inputHandler.of((e, t, n, i) => i != "%" || t != n || e.state.doc.sliceString(t - 1, n + 1) != "{}" ? !1 : (e.dispatch(e.state.changeByRange((e) => ({
	changes: {
		from: e.from,
		to: e.to,
		insert: "%%"
	},
	range: r.cursor(e.from + 1)
})), {
	scrollIntoView: !0,
...
var z = /* @__PURE__ */ d.define({
	...
	parser: /* @__PURE__ */ D.configure({ props: [
		...
		/* @__PURE__ */ n.add({ "Statement Comment"(e) {
...
//# sourceMappingURL=dist-CEQklcik.js.map