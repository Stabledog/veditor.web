...
var Bc = class {
	...
	static define(t) {
		let n = t.props && t.props.length ? Object.create(null) : Vc, r = !!t.top | (t.skipped ? 2 : 0) | (t.error ? 4 : 0) | (t.name == null ? 8 : 0), i = new e(t.name || "", n, t.id, r);
		if (t.props) {
...
var Cl = class {
	...
	moveTo(e) {
		...
		for (; !this.done && t.from < n;) if (!(t.to >= e && t.enter(n, 1, J.IgnoreOverlays | J.ExcludeBuffers))) if (t.to <= e) t.next(!1) || (this.done = !0);
		else break;
	}
	hasNode(e) {
