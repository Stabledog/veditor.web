import { B as e, V as t, Y as n, n as r, r as i, s as a, u as o } from "./dist-CVKUUr4R.js";
import { n as s } from "./dist-CyEv4xQF.js";
import { r as c } from "./dist-y7CIGpkK.js";
//#region node_modules/@codemirror/lang-angular/dist/index.js
var l = 1, u = 33, d = 34, f = 35, p = 36, m = /*@__PURE__*/ new r((e) => {
	let t = e.pos;
	for (;;) {
		if (e.next == 10) {
			e.advance();
		...
		if (e.next == 123 && e.peek(1) == 123 || e.next < 0) break;
		e.advance();
	}
	e.pos > t && e.acceptToken(l);
});
function h(e, t, n) {
	return new r((r) => {
		let i = r.pos;
		for (; r.next != e && r.next >= 0 && (n || r.next != 38 && (r.next != 123 || r.peek(1) != 123));) r.advance();
		r.pos > i && r.acceptToken(t);
	});
}
var g = /*@__PURE__*/ h(39, u, !1), _ = /*@__PURE__*/ h(34, d, !1), v = /*@__PURE__*/ h(39, f, !0), y = /*@__PURE__*/ h(34, p, !0), b = /*@__PURE__*/ i.deserialize({
	version: 14,
	...
	tokenPrec: 0
}), x = /*@__PURE__*/ c.parser.configure({ top: "SingleExpression" }), S = /*@__PURE__*/ b.configure({ props: [/*@__PURE__*/ e({
	Text: t.content,
	...
	"EventName/Identifier": /*@__PURE__*/ t.special(t.attributeName),
	...
	"[ ]": t.bracket,
	"# '*'": t.punctuation
})] }), C = { parser: x }, w = { parser: c.parser }, T = /*@__PURE__*/ S.configure({ wrap: /*@__PURE__*/ n((e, t) => e.name == "InterpolationContent" ? C : null) }), E = /*@__PURE__*/ S.configure({
	wrap: /*@__PURE__*/ n((e, t) => e.name == "InterpolationContent" ? C : e.name == "AttributeInterpolation" ? e.node.parent?.name == "StatementAttributeValue" ? w : C : null),
	top: "Attribute"
}), D = { parser: T }, O = { parser: E }, k = /*@__PURE__*/ s({ selfClosingTags: !0 });
function A(e) {
	return e.configure({ wrap: n(M) }, "angular");
}
var j = /*@__PURE__*/ A(k.language);
function M(e, t) {
	switch (e.name) {
		case "Attribute": return /^[*#(\[]|\{\{/.test(t.read(e.from, e.to)) ? O : null;
		case "Text": return D;
	}
	return null;
}
function N(e = {}) {
	let t = k;
	if (e.base) {
		if (e.base.language.name != "html" || !(e.base.language instanceof a)) throw RangeError("The base option must be the result of calling html(...)");
		t = e.base;
	}
	return new o(t.language == k.language ? j : A(t.language), [t.support, t.language.data.of({
...
//# sourceMappingURL=dist-CQsH4RFk.js.map