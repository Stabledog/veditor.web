import { A as e, B as t, E as n, Q as r, R as i, Tt as a, V as o, Y as s, i as c, n as l, r as u, s as d, u as f, y as p } from "./dist-C56v8Vz7.js";
import { n as m } from "./dist-CppJM0lj.js";
...
function P(e) {
	let { state: t, pos: n } = e, r = i(t).resolveInner(n, -1).enterUnfinishedNodesBefore(n), a = r.childBefore(n)?.name || r.name;
	...
	if (r.name == "MemberExpression" && a == ".") return {
		type: "prop",
		target: r
	};
...
var L = /* @__PURE__ */ r.inputHandler.of((e, t, n, r) => r != "%" || t != n || e.state.doc.sliceString(t - 1, n + 1) != "{}" ? !1 : (e.dispatch(e.state.changeByRange((e) => ({
	changes: {
		from: e.from,
		to: e.to,
		insert: "%%"
...
//# sourceMappingURL=dist-Cr7EPOtY.js.map