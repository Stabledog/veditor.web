import { A as e, B as t, Dt as n, E as r, Q as i, R as a, V as o, Y as s, n as c, r as l, s as u, u as d, y as f } from "./dist-CVKUUr4R.js";
import { n as p } from "./dist-CyEv4xQF.js";
//#region node_modules/@codemirror/lang-liquid/dist/index.js
var m = 1, h = 2, g = 3, _ = 180, v = 4, y = 181, b = 5, x = 182, S = 6;
function C(e) {
	return e >= 65 && e <= 90 || e >= 97 && e <= 122;
}
var w = /*@__PURE__*/ new c((e) => {
	let t = e.pos;
	for (;;) {
		let { next: n } = e;
		if (n < 0) break;
...
var E = /*@__PURE__*/ T("endcomment", x, b), D = /*@__PURE__*/ T("endraw", y, v), O = /*@__PURE__*/ new c((e) => {
	if (e.next == 35) {
		for (e.advance(); !(e.next == 10 || e.next < 0 || (e.next == 37 || e.next == 125) && e.peek(1) == 125);) e.advance();
		e.acceptToken(S);
	}
}), k = {
	__proto__: null,
...
var N = /*@__PURE__*/ M("abs append at_least at_most capitalize ceil compact concat date default divided_by downcase escape escape_once first floor join last lstrip map minus modulo newline_to_br plus prepend remove remove_first replace replace_first reverse round rstrip size slice sort sort_natural split strip strip_html strip_newlines sum times truncate truncatewords uniq upcase url_decode url_encode where", "function"), P = /*@__PURE__*/ M("cycle comment endcomment raw endraw echo increment decrement liquid if elsif else endif unless endunless case endcase for endfor tablerow endtablerow break continue assign capture endcapture render include", "keyword"), F = /*@__PURE__*/ M("empty forloop tablerowloop in with as", "keyword"), I = /*@__PURE__*/ M("first index index0 last length rindex", "property"), L = /*@__PURE__*/ M("col col0 col_first col_last first index index0 last length rindex rindex0 row", "property");
function R(e) {
	...
	if (e.explicit && i == "|") return { type: "filter" };
	...
	return o ? {
		type: "expression",
		from: o.from
	} : e.explicit && r.name != "CommentText" && r.name != "StringLiteral" && r.name != "NumberLiteral" && r.name != "InlineComment" ? { type: "expression" } : null;
}
function z(e, t, n, r) {
	let i = [];
	for (;;) {
		...
		if (n.name == "VariableName" || n.name == "forloop" || n.name == "tablerowloop") {
			...
			if (t == "forloop") return i.length ? [] : I;
			if (t == "tablerowloop") return i.length ? [] : L;
			i.unshift(t);
			break;
		}
...
function B(e = {}) {
	let t = e.filters ? e.filters.concat(N) : N, n = e.tags ? e.tags.concat(P) : P, r = e.variables ? e.variables.concat(F) : F, { properties: i } = e;
	return (e) => {
		let a = R(e);
		if (!a) return null;
		let o = a.from ?? (a.node ? a.node.from : e.pos), s;
		return s = a.type == "filter" ? t : a.type == "tag" ? n : a.type == "expression" ? r : z(e.state, a.target, e, i), s.length ? {
			options: s,
			from: o,
			validFor: /^[\w\u00c0-\uffff]*$/
		} : null;
...
var V = /*@__PURE__*/ i.inputHandler.of((e, t, r, i) => i != "%" || t != r || e.state.doc.sliceString(t - 1, r + 1) != "{}" ? !1 : (e.dispatch(e.state.changeByRange((e) => ({
	changes: {
		from: e.from,
		to: e.to,
		insert: "%%"
...
var U = /*@__PURE__*/ u.define({
	name: "liquid",
	parser: /*@__PURE__*/ j.configure({ props: [
		/*@__PURE__*/ t({
			"cycle comment endcomment raw endraw echo increment decrement liquid in with as": o.keyword,
			"empty forloop tablerowloop": o.atom,
			"if elsif else endif unless endunless case endcase for endfor tablerow endtablerow break continue": o.controlKeyword,
			"assign capture endcapture": o.definitionKeyword,
			contains: o.operatorKeyword,
			"render include": o.moduleKeyword,
			VariableName: o.variableName,
			TagName: o.tagName,
			FilterName: /*@__PURE__*/ o.function(o.variableName),
			...
			InlineComment: o.lineComment,
			CommentText: o.blockComment,
			"{% %} {{ }}": o.brace,
			"[ ]": o.bracket,
			"( )": o.paren,
			".": o.derefOperator,
		...
		/*@__PURE__*/ e.add({
			Tag: /*@__PURE__*/ f({ closing: "%}" }),
			"UnlessDirective ForDirective TablerowDirective CaptureDirective": /*@__PURE__*/ H(/^\s*(\{%-?\s*)?end\w/),
			IfDirective: /*@__PURE__*/ H(/^\s*(\{%-?\s*)?(endif|else|elsif)\b/),
			CaseDirective: /*@__PURE__*/ H(/^\s*(\{%-?\s*)?(endcase|when)\b/)
		}),
		/*@__PURE__*/ r.add({ "UnlessDirective ForDirective TablerowDirective CaptureDirective IfDirective CaseDirective RawDirective Comment"(e) {
			let t = e.firstChild, n = e.lastChild;
			return !t || t.name != "Tag" ? null : {
				from: t.to,
				to: n.name == "EndTag" ? n.from : e.to
			};
		} })
	] }),
	languageData: {
...
function G(e) {
	return U.configure({ wrap: s((t) => t.type.isTop ? {
		parser: e.parser,
		overlay: (e) => e.name == "Text" || e.name == "RawText"
	} : null) }, "liquid");
}
var K = /*@__PURE__*/ G(W.language);
function q(e = {}) {
	let t = e.base || W, n = t.language == W.language ? K : G(t.language);
	return new d(n, [
		t.support,
		n.data.of({ autocomplete: B(e) }),
...
//# sourceMappingURL=dist-dWIhOkFw.js.map