...
import { A as t, B as n, E as r, H as i, I as a, K as o, Q as s, R as c, Tt as ee, V as l, g as u, i as d, n as f, r as p, s as te, t as ne, u as re, v as ie, w as ae, x as oe, y as se } from "./dist-C56v8Vz7.js";
import { a as ce, c as m, s as h } from "./dist-BwfSJsrB.js";
...
var le = 316, ue = 317, g = 1, de = 2, fe = 3, pe = 4, me = 318, he = 320, ge = 321, _e = 5, ve = 6, ye = 0, _ = [
	...
	8287,
	12288
], v = 125, be = 59, y = 47, b = 42, x = 43, S = 45, C = 60, w = 44, T = 63, E = 46, D = 91, O = new ne({
	start: !1,
	shift(e, t) {
...
}, { contextual: !0 }), j = new f((e, t) => {
	e.next == D && !t.context && e.acceptToken(ue);
}, { contextual: !0 }), M = new f((e, t) => {
	let { next: n } = e;
	if (n == x || n == S) {
...
]), L = /* @__PURE__ */ new o(), R = /* @__PURE__ */ new Set([
	"Script",
	"Block",
	"FunctionExpression",
	"FunctionDeclaration",
...
function B(e, t) {
	...
	return t.cursor(i.IncludeAnonymous).iterate((t) => {
		if (a) a = !1;
		else if (t.name) {
			let e = Oe[t.name];
...
var W = /* @__PURE__ */ te.define({
	...
	parser: /* @__PURE__ */ Te.configure({ props: [/* @__PURE__ */ t.add({
		...
		"Block ClassBody SwitchBody EnumBody ObjectExpression ArrayExpression ObjectType": ae,
		BlockComment(e) {
			return {
				from: e.from + 2,
				to: e.to - 2
	...
	dialect: "jsx",
	props: [/* @__PURE__ */ a.add((e) => e.isTop ? [G] : void 0)]
...
function Z(e = {}) {
	...
	return new re(t, [
		W.data.of({ autocomplete: h(H, ce(n)) }),
...
var je = typeof navigator == "object" && /* @__PURE__ */ /Android\b/.test(navigator.userAgent), $ = /* @__PURE__ */ s.inputHandler.of((e, t, n, r, i) => {
	...
	let a = i(), { state: o } = a, s = o.changeByRange((e) => {
		let { head: t } = e, n = c(o).resolveInner(t - 1, -1), i;
		if (n.name == "JSXStartTag" && (n = n.parent), !(o.doc.sliceString(t - 1, t) != r || n.name == "JSXAttributeValue" && n.to > t)) {
			...
			if (r == "/" && n.name == "JSXStartCloseTag") {
				...
				if (r && e.from == t - 2 && ((i = Q(o.doc, r.firstChild, t)) || r.firstChild?.name == "JSXFragmentTag")) {
					let e = `${i}>`;
					return {
						range: ee.cursor(t + e.length, -1),
						changes: {
							from: t,
							insert: e
						}
				...
				let r = Ae(n);
				if (r && r.name == "JSXOpenTag" && !/^\/?>|^<\//.test(o.doc.sliceString(t, t + 2)) && (i = Q(o.doc, r, t))) return {
					range: e,
					changes: {
						from: t,
						insert: `</${i}>`
...
//# sourceMappingURL=dist-N5bAzVUW.js.map