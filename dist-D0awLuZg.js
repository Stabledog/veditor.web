import { A as e, B as t, E as n, V as r, g as i, n as a, r as o, s, t as c, u as l, w as u } from "./dist-C56v8Vz7.js";
import { r as d } from "./dist-BKR2rOQp.js";
...
var le = new c({
	...
	name: "sass",
	parser: /* @__PURE__ */ Q.configure({ props: [/* @__PURE__ */ n.add({
		Block: u,
		Comment(e, t) {
			return {
				from: e.from + 2,
...
}), he = /* @__PURE__ */ $.configure({
	dialect: "indented",
	props: [/* @__PURE__ */ e.add({ "Block RuleSet": (e) => e.baseIndent + e.unit }), /* @__PURE__ */ n.add({ Block: (e) => ({
		from: e.from,
		to: e.to
	}) })]
}), ge = /* @__PURE__ */ d((e) => e.name == "VariableName" || e.name == "SassVariableName");
function _e(e) {
	return new l(e?.indented ? he : $, $.data.of({ autocomplete: ge }));
}
//#endregion
export { _e as sass };

//# sourceMappingURL=dist-D0awLuZg.js.map