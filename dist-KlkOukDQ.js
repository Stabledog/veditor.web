import { $ as e, At as t, Ct as n, Dt as r, Ft as i, Ht as a, It as o, Lt as s, Mt as c, N as l, Nt as u, Ot as d, Pt as f, Q as p, R as m, Rt as h, Tt as g, X as _, Z as v, bt as y, dt as b, et as x, kt as S, ot as C, pt as w, vt as ee, zt as te } from "./dist-CK9QBJOt.js";
...
var k = /* @__PURE__ */ u.define(), A = /* @__PURE__ */ u.define(), ue = class {
	...
	match(e) {
		...
		for (let r = 0, u = Math.min(e.length, 200), b = 0; r < u && f < l;) {
			...
			let x, S = u < 255 ? u >= 48 && u <= 57 || u >= 97 && u <= 122 ? 2 : +(u >= 65 && u <= 90) : (x = a(u)) == x.toLowerCase() ? x == x.toUpperCase() ? 0 : 2 : 1;
...
var ve = class e {
	...
	update(t) {
		let { state: n } = t, r = n.facet(j), i = (r.override || n.languageDataAt("autocomplete", E(n)).map(le)).map((e) => (this.active.find((t) => t.source == e) || new R(e, +!!this.active.some((e) => e.state != 0))).update(t, r));
	...
	accept() {
		...
		for (let r = 0; r < this.running.length; r++) {
			...
			if (this.running.splice(r--, 1), i.done) {
				let n = E(i.updates.length ? i.updates[0].startState : this.view.state), r = Math.min(n, i.done.from + +!i.active.explicit), a = new z(i.active.source, i.active.explicit, r, i.done, i.done.from, i.done.to ?? n);
