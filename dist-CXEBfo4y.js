...
var Xa = class {
	...
	constructor(e, t) {
		this.view = e, this.state = t, this.pixelViewport = {
			...
			top: 0,
			bottom: 0
		}, this.inView = !0, this.paddingTop = 0, this.paddingBottom = 0, this.contentDOMWidth = 0, this.contentDOMHeight = 0, this.editorHeight = 0, this.editorWidth = 0, this.scaleX = 1, this.scaleY = 1, this.scrollOffset = 0, this.scrolledToBottom = !1, this.scrollAnchorPos = 0, this.scrollAnchorHeight = -1, this.scaler = io, this.scrollTarget = null, this.printing = !1, this.mustMeasureContent = !0, this.defaultTextDirection = I.LTR, this.visibleRanges = [], this.mustEnforceCursorAssoc = !1;
		let n = t.facet(Sr).some((e) => typeof e != "function" && e.class == "cm-lineWrapping");
		this.heightOracle = new ja(n), this.stateDeco = ao(t), this.heightMap = Fa.empty().applyChanges(this.stateDeco, f.empty, this.heightOracle.setDoc(t.doc), [new Mr(0, 0, 0, t.doc.length)]);
...
var Hs = /* @__PURE__ */ W.baseTheme({
	...
	mousemove(e) {
		...
		if (t.length && !this.locked.has(t) && n && !Zs(n.dom, e) || this.pending) {
			let { pos: n } = t[0] || this.pending, r = t[0]?.end ?? n;
			(n == r ? this.view.posAtCoords(this.lastMove) != n : !Qs(this.view, n, r, e.clientX, e.clientY)) && (this.view.dispatch({ effects: this.setHover.of([]) }), this.pending = null);
		}
	}
	mouseleave(e) {
...
function Zs(e, t) {
	...
	return t.clientX >= n - Xs && t.clientX <= r + Xs && t.clientY >= i - Xs && t.clientY <= a + Xs;
}
...
function $s(e, t = {}) {
	let n = D.define(), r = /* @__PURE__ */ new WeakMap(), i = Ce.define({
		...
		update(e, a) {
			...
			for (let t of a.effects) t.is(n) && (e = t.value, o = void 0), (t.is(nc) && !t.value || t.value == i) && (e = []);
			return e.length && o && r.set(e, o), e;
		},
		provide: (e) => Gs.from(e)
	}), a = z.define((a) => new Ys(a, e, i, r, n, t.hoverTime || 300));
	return {
		active: i,
		extension: [
			i,
...
function ec(e, t, n, r = {}) {
	let i = e.state.facet(Js).map((t) => e.plugin(t)).filter((e) => !!e);
...
var nc = /* @__PURE__ */ D.define(), rc = /* @__PURE__ */ E.define({ combine(e) {
	let t, n;
...
var ac = /* @__PURE__ */ z.fromClass(class {
	constructor(e) {
		this.input = e.state.facet(cc), this.specs = this.input.filter((e) => e), this.panels = this.specs.map((t) => t(e));
		let t = e.state.facet(rc);
		this.top = new oc(e, !0, t.topContainer), this.bottom = new oc(e, !1, t.bottomContainer), this.top.sync(this.panels.filter((e) => e.top)), this.bottom.sync(this.panels.filter((e) => !e.top));
...
var cc = /* @__PURE__ */ E.define({ enables: ac });
function lc(e, t) {
	let n, r = new Promise((e) => n = e), i = (e) => pc(e, t, n);
	e.state.field(uc, !1) ? e.dispatch({ effects: dc.of(i) }) : e.dispatch({ effects: D.appendConfig.of(uc.init(() => [i])) });
	let a = fc.of(i);
	return {
		close: a,
		result: r.then((t) => ((e.win.queueMicrotask || ((t) => e.win.setTimeout(t, 10)))(() => {
			e.state.field(uc).indexOf(i) > -1 && e.dispatch({ effects: a });
		}), t))
	};
}
var uc = /* @__PURE__ */ Ce.define({
	create() {
		return [];
	},
	update(e, t) {
		for (let n of t.effects) n.is(dc) ? e = [n.value].concat(e) : n.is(fc) && (e = e.filter((e) => e != n.value));
		return e;
	},
	provide: (e) => cc.computeN([e], (t) => t.field(e))
}), dc = /* @__PURE__ */ D.define(), fc = /* @__PURE__ */ D.define();
function pc(e, t, n) {
...
mc.prototype.elementClass = "", mc.prototype.toDOM = void 0, mc.prototype.mapMode = C.TrackBefore, mc.prototype.startSide = mc.prototype.endSide = -1, mc.prototype.point = !0;
var hc = /* @__PURE__ */ E.define(), gc = /* @__PURE__ */ E.define(), _c = {
	class: "",
...
var bc = /* @__PURE__ */ E.define({ combine: (e) => e.some((e) => e) });
function xc(e) {
	let t = [Sc];
	return e && e.fixed === !1 && t.push(bc.of(!0)), t;
}
var Sc = /* @__PURE__ */ z.fromClass(class {
	constructor(e) {
		this.view = e, this.domAfter = null, this.prevViewport = e.viewport, this.dom = document.createElement("div"), this.dom.className = "cm-gutters cm-gutters-before", this.dom.setAttribute("aria-hidden", "true"), this.dom.style.minHeight = this.view.contentHeight / this.view.scaleY + "px", this.gutters = e.state.facet(vc).map((t) => new Ec(e, t)), this.fixed = !e.state.facet(bc);
	...
	update(e) {
		...
		this.view.state.facet(bc) != !this.fixed && (this.fixed = !this.fixed, this.dom.style.position = this.fixed ? "sticky" : "", this.domAfter && (this.domAfter.style.position = this.fixed ? "sticky" : "")), this.prevViewport = e.view.viewport;
	}
	syncGutters(e) {
		let t = this.dom.nextSibling;
		e && (this.dom.remove(), this.domAfter && this.domAfter.remove());
		let n = A.iter(this.view.state.facet(hc), this.view.viewport.from), r = [], i = this.gutters.map((e) => new Tc(e, this.view.viewport, -this.view.documentPadding.top));
	...
	updateGutters(e) {
		let t = e.startState.facet(vc), n = e.state.facet(vc), r = e.docChanged || e.heightChanged || e.viewportChanged || !A.eq(e.startState.facet(hc), e.state.facet(hc), e.view.viewport.from, e.view.viewport.to);
		if (t == n) for (let t of this.gutters) t.update(e) && (r = !0);
			...
			for (let r of n) {
				let n = t.indexOf(r);
				n < 0 ? i.push(new Ec(this.view, r)) : (this.gutters[n].update(e), i.push(this.gutters[n]));
			}
...
var Tc = class {
	...
	line(e, t, n) {
		let r = [];
		wc(this.cursor, r, t.from), n.length && (r = r.concat(n));
	...
	constructor(e, t) {
		...
		this.markers = Cc(t.markers(e)), t.initialSpacer && (this.spacer = new Dc(e, 0, 0, [t.initialSpacer(e)]), this.dom.appendChild(this.spacer.dom), this.spacer.dom.style.cssText += "visibility: hidden; pointer-events: none");
	}
	update(e) {
		let t = this.markers;
		if (this.markers = Cc(this.config.markers(e.view)), this.spacer && this.config.updateSpacer) {
	...
	update(e, t, n, r) {
		this.height != t && (this.height = t, this.dom.style.height = t + "px"), this.above != n && (this.dom.style.marginTop = (this.above = n) ? n + "px" : ""), Oc(this.markers, r) || this.setMarkers(e, r);
	}
	setMarkers(e, t) {
...
var kc = /* @__PURE__ */ E.define(), Ac = /* @__PURE__ */ E.define(), jc = /* @__PURE__ */ E.define({ combine(e) {
	return rt(e, {
		formatNumber: String,
		domEventHandlers: {}
...
var Pc = /* @__PURE__ */ vc.compute([jc], (e) => ({
	...
	lineMarker(e, t, n) {
		return n.some((e) => e.toDOM) ? null : new Mc(Nc(e, e.state.doc.lineAt(t.from).number));
	},
	widgetMarker: (e, t, n) => {
		for (let r of e.state.facet(Ac)) {
			let i = r(e, t, n);
			if (i) return i;
		}
		return null;
	...
	initialSpacer(e) {
		return new Mc(Nc(e, Ic(e.state.doc.lines)));
	},
	updateSpacer(e, t) {
		let n = Nc(t.view, Ic(t.view.state.doc.lines));
...
var Lc = /* @__PURE__ */ new class extends mc {
	constructor() {
		super(...arguments), this.elementClass = "cm-activeLineGutter";
	}
}(), Rc = /* @__PURE__ */ hc.compute(["selection"], (e) => {
	let t = [], n = -1;
	for (let r of e.selection.ranges) {
		let i = e.doc.lineAt(r.head).from;
		i > n && (n = i, t.push(Lc.range(i)));
	}
	return A.of(t);
});
function zc() {
...
var Bc = 1024, Vc = 0, G = class {
	constructor(e, t) {
		this.from = e, this.to = t;
	}
}, K = class {
	constructor(e = {}) {
		this.id = Vc++, this.perNode = !!e.perNode, this.deserialize = e.deserialize || (() => {
...
}, Uc = Object.create(null), q = class e {
	constructor(e, t, n, r = 0) {
...
}, Gc = /* @__PURE__ */ new WeakMap(), Kc = /* @__PURE__ */ new WeakMap(), J;
(function(e) {
...
var Y = class e {
	...
	cursor(e = 0) {
		return new ol(this.topNode, e);
	}
	cursorAt(e, t = 0, n = 0) {
		let r = new ol(Gc.get(this) || this.topNode);
		return r.moveTo(e, t), Gc.set(this, r._tree), r;
	}
	get topNode() {
		return new Qc(this, 0, 0, null);
	}
	resolve(e, t = 0) {
		let n = Xc(Gc.get(this) || this.topNode, e, t, !1);
		return Gc.set(this, n), n;
	}
	resolveInner(e, t = 0) {
		let n = Xc(Kc.get(this) || this.topNode, e, t, !0);
	...
	balance(t = {}) {
		return this.children.length <= 8 ? this : dl(q.none, this.children, this.positions, 0, this.children.length, 0, this.length, (t, n, r) => new e(this.type, t, n, r, this.propValues), t.makeTree || ((t, n, r) => new e(q.none, t, n, r)));
	}
	static build(e) {
		return cl(e);
	}
...
var qc = class e {
	...
	findChild(e, t, n, r, i) {
		...
		for (let s = e; s != t && !(Yc(i, r, a[s + 1], a[s + 2]) && (o = s, n > 0)); s = a[s + 3]);
		return o;
	}
	slice(t, n, r) {
...
function Xc(e, t, n, r) {
	for (; e.from == e.to || (n < 1 ? e.from >= t : e.from > t) || (n > -1 ? e.to <= t : e.to < t);) {
		let t = !r && e instanceof Qc && e.index < 0 ? null : e.parent;
		if (!t) return e;
		e = t;
	}
	let i = r ? 0 : J.IgnoreOverlays;
	if (r) for (let r = e, a = r.parent; a; r = a, a = r.parent) r instanceof Qc && r.index < 0 && a.enter(t, n, i)?.from != r.from && (e = a);
	for (;;) {
		let r = e.enter(t, n, i);
		if (!r) return e;
		e = r;
...
var Zc = class {
	...
	nextChild(t, n, r, i, a = 0) {
		for (let o = this;;) {
			for (let { children: s, positions: c } = o._tree, l = n > 0 ? s.length : -1; t != l; t += n) {
				...
				if (!(!(a & J.EnterBracketed && l instanceof Y && (d = Hc.get(l)) && !d.overlay && d.bracketed && r >= u && r <= u + l.length) && !Yc(i, r, u, u + l.length))) {
					if (l instanceof Jc) {
						if (a & J.ExcludeBuffers) continue;
						let e = l.findChild(0, l.buffer.length, n, r - u, i);
						if (e > -1) return new nl(new tl(o, l, t, u), null, e);
					} else if (a & J.IncludeAnonymous || !l.type.isAnonymous || sl(l)) {
						let s;
						if (!(a & J.IgnoreMounts) && (s = Hc.get(l)) && !s.overlay) return new e(s.tree, u, t, o);
						let c = new e(l, u, t, o);
	...
	enter(t, n, r = 0) {
		let i;
		if (!(r & J.IgnoreOverlays) && (i = Hc.get(this._tree)) && i.overlay) {
...
function rl(e) {
	...
	let r = n instanceof Qc && n.index < 0 ? null : n.parent, i = e.slice();
	return r ? i[t] = r : i.splice(t, 1), new il(i, n);
}
var il = class {
	constructor(e, t) {
	...
	get next() {
		return rl(this.heads);
	}
};
function al(e, t, n) {
	let r = e.resolveInner(t, n), i = null;
	for (let e = r instanceof Qc ? r : r.context.parent; e; e = e.parent) if (e.index < 0) {
		let a = e.parent;
		(i ||= [r]).push(a.resolve(t, n)), e = a;
	} else {
		let a = Hc.get(e.tree);
		if (a && a.overlay && a.overlay[0].from <= t && a.overlay[a.overlay.length - 1].to >= t) {
			let o = new Qc(a.tree, a.overlay[0].from + e.from, -1, e);
			(i ||= [r]).push(Xc(o, t, n, !1));
		}
	}
	return i ? rl(i) : r;
...
var ol = class {
	...
	constructor(e, t = 0) {
		if (this.buffer = null, this.stack = [], this.index = 0, this.bufferNode = null, this.mode = t & ~J.EnterBracketed, e instanceof Qc) this.yieldNode(e);
		else {
	...
	yield(e) {
		return e ? e instanceof Qc ? (this.buffer = null, this.yieldNode(e)) : (this.buffer = e.context, this.yieldBuf(e.index, e.type)) : !1;
	}
	toString() {
	...
	atLastNode(e) {
		...
		for (; n; {index: t, _parent: n} = n) if (t > -1) for (let r = t + e, i = e < 0 ? -1 : n._tree.children.length; r != i; r += e) {
			...
			if (this.mode & J.IncludeAnonymous || e instanceof Jc || !e.type.isAnonymous || sl(e)) return !1;
		}
		return !0;
	}
	move(e, t) {
	...
	get node() {
		...
		for (let e = n; e < this.stack.length; e++) t = new nl(this.buffer, t, this.stack[e]);
		return this.bufferNode = new nl(this.buffer, t, this.index);
	}
	get tree() {
...
function sl(e) {
	return e.children.some((e) => e instanceof Jc || !e.type.isAnonymous || sl(e));
}
function cl(e) {
	let { buffer: t, nodeSet: n, maxBufferLength: r = Bc, reused: i = [], minRepeatType: a = n.types.length } = e, o = Array.isArray(t) ? new qc(t, t.length) : t, s = n.types, c = 0, l = 0;
	function u(e, t, _, v, y, ee) {
		...
		if (S - x <= r && (oe = h(o.pos - t, y))) {
			...
			ae = new Jc(t, S - oe.start, n), C = oe.start - e;
		} else {
			let e = o.pos - te;
			o.next();
			...
			if (i >= 0 && s > 0 && s < t.length && p(t, n, x, s, x, c, i, ne, re), t.reverse(), n.reverse(), i > -1 && s > 0) {
				let e = f(ie, re);
				ae = dl(ie, t, n, 0, t.length, 0, S - x, e, e);
...
function dl(e, t, n, r, i, a, o, s, c) {
	let l = 0;
	for (let n = r; n < i; n++) l += ul(e, t[n]);
	let u = Math.ceil(l * 1.5 / 8), d = [], f = [];
	function p(t, n, r, i, o) {
		for (let s = r; s < i;) {
			let r = s, l = n[s], m = ul(e, t[s]);
			for (s++; s < i; s++) {
				let n = ul(e, t[s]);
				if (m + n >= u) break;
				m += n;
			...
			if (s == r + 1) {
				...
				d.push(dl(e, t, n, r, s, l, i, null, c));
			}
			f.push(l + o - a);
		}
	}
...
var fl = class {
	...
	set(e, t) {
		e instanceof nl ? this.setBuffer(e.context.buffer, e.index, t) : e instanceof Qc && this.map.set(e.tree, t);
	}
	get(e) {
		return e instanceof nl ? this.getBuffer(e.context.buffer, e.index) : e instanceof Qc ? this.map.get(e.tree) : void 0;
	}
	cursorSet(e, t) {
	...
	startParse(e, t, n) {
		return typeof e == "string" && (e = new hl(e)), n = n ? n.length ? n.map((e) => new G(e.from, e.to)) : [new G(0, 0)] : [new G(0, e.length)], this.createParse(e, t || [], n);
	}
	parse(e, t, n) {
...
function gl(e) {
	return (t, n, r, i) => new xl(t, e, n, r, i);
}
var _l = class {
	constructor(e, t, n, r, i, a) {
...
var yl = class {
	...
	advance() {
		...
		if (this.innerDone == this.inner.length) {
			let e = this.baseTree;
			return this.stoppedAt != null && (e = new Y(e.type, e.children, e.positions, e.length, e.propValues.concat([[bl, this.stoppedAt]]))), e;
		}
		let e = this.inner[this.innerDone], t = e.parse.advance();
		if (t) {
			this.innerDone++;
			let n = Object.assign(Object.create(null), e.target.props);
			n[K.mounted.id] = new Hc(t, e.overlay, e.parser, e.bracketed), e.target.props = n;
		}
		return null;
	}
	get parsedPos() {
	...
	startInner() {
		let e = new El(this.fragments), t = null, n = null, r = new ol(new Qc(this.baseTree, this.ranges[0].from, 0, null), J.IncludeAnonymous | J.IgnoreMounts);
		scan: for (let i, a;;) {
			let o = !0, s;
			if (this.stoppedAt != null && r.from >= this.stoppedAt) o = !1;
				...
				o = !1;
			} else if (n && (a = Sl(n.ranges, r.from, r.to))) o = a != 2;
			else if (!r.type.isAnonymous && (i = this.nest(r, this.input)) && (r.from < r.to || !i.overlay)) {
				r.tree || (wl(r), t && t.depth++, n && n.depth++);
				let a = e.findMounts(r.from, i.parser);
				if (typeof i.overlay == "function") t = new yl(i.parser, i.overlay, a, this.inner.length, r.from, !!i.bracketed, r.tree, t);
				else {
					let e = Dl(this.ranges, i.overlay || (r.from < r.to ? [new G(r.from, r.to)] : []));
					e.length && vl(e), (e.length || !i.overlay) && this.inner.push(new _l(i.parser, e.length ? i.parser.startParse(this.input, kl(a, e), e) : i.parser.startParse(""), i.overlay ? i.overlay.map((e) => new G(e.from - r.from, e.to - r.from)) : null, !!i.bracketed, r.tree, e.length ? e[0].from : r.from)), i.overlay ? e.length && (n = {
						ranges: e,
						depth: 0,
						prev: n
					}) : o = !1;
			...
			if (o && r.firstChild()) t && t.depth++, n && n.depth++;
				...
				if (t && !--t.depth) {
					let e = Dl(this.ranges, t.ranges);
					e.length && (vl(e), this.inner.splice(t.index, 0, new _l(t.parser, t.parser.startParse(this.input, kl(t.mounts, e), e), t.ranges.map((e) => new G(e.from - t.start, e.to - t.start)), t.bracketed, t.target, e[0].from))), t = t.prev;
				}
				n && !--n.depth && (n = n.prev);
			}
		}
...
var Tl = class {
	...
	constructor(e) {
		if (this.fragments = e, this.curTo = 0, this.fragI = 0, e.length) {
			...
			this.curTo = t.tree.prop(bl) ?? t.to, this.inner = new Tl(t.tree, -t.offset);
	...
	nextFrag() {
		if (this.fragI++, this.fragI == this.fragments.length) this.curFrag = this.inner = null;
			...
			this.curTo = e.tree.prop(bl) ?? e.to, this.inner = new Tl(e.tree, -e.offset);
		}
	}
	findMounts(e, t) {
		let n = [];
...
function kl(e, t) {
	...
	for (let { pos: r, mount: i, frag: a } of e) {
		...
		if (i.overlay) {
			let o = Ol(t, i.overlay.map((e) => new G(e.from + r, e.to + r)), s, c);
			for (let t = 0, r = s;; t++) {
				let s = t == o.length, l = s ? c : o[t].from;
				if (l > r && n.push(new pl(r, l, i.tree, -e, a.from >= r || a.openStart, a.to <= l || a.openEnd)), s) break;
				r = o[t].to;
			}
		} else n.push(new pl(s, c, i.tree, -e, a.from >= e || a.openStart, a.to <= o || a.openEnd));
	}
	return n;
}
//#endregion
...
var Al = 0, jl = class e {
	constructor(e, t, n, r) {
		this.name = e, this.set = t, this.base = n, this.modified = r, this.id = Al++;
	}
	toString() {
		let { name: e } = this;
	...
	static defineModifier(e) {
		let t = new Nl(e);
		return (e) => e.modified.indexOf(t) > -1 ? e : Nl.get(e.base || e, e.modified.concat(t).sort((e, t) => e.id - t.id));
	}
}, Ml = 0, Nl = class e {
	constructor(e) {
	...
	static get(t, n) {
		if (!n.length) return t;
		let r = n[0].instances.find((e) => e.base == t && Pl(n, e.modified));
		if (r) return r;
		let i = [], a = new jl(t.name, i, t, n);
...
function Il(e) {
	...
	for (let n in e) {
		...
		for (let e of n.split(" ")) if (e) {
			...
			t[s] = new Rl(r, i, o > 0 ? n.slice(0, o) : null).sort(t[s]);
		}
	}
	return Ll.add(t);
}
var Ll = new K({ combine(e, t) {
	let n, r, i;
	for (; e || t;) {
		if (!e || t && e.depth >= t.depth ? (i = t, t = t.next) : (i = e, e = e.next), n && n.mode == i.mode && !i.context && !n.context) continue;
		let a = new Rl(i.tags, i.mode, i.context);
		n ? n.next = a : r = a, n = a;
	}
	return r;
} }), Rl = class {
...
function Vl(e, t, n, r = 0, i = e.length) {
	let a = new Hl(r, Array.isArray(t) ? t : [t], n);
...
var Hl = class {
	...
	highlightRange(e, t, n, r, i) {
		...
		let c = r, l = Ul(e) || Rl.empty, u = Bl(i, l.tags);
...
function Ul(e) {
	let t = e.type.prop(Ll);
	for (; t && t.context && !e.matchContext(t.context);) t = t.next;
	return t || null;
}
var X = jl.define, Wl = X(), Gl = X(), Kl = X(Gl), ql = X(Gl), Jl = X(), Yl = X(Jl), Xl = X(Jl), Zl = X(), Ql = X(Zl), $l = X(), eu = X(), tu = X(), nu = X(tu), ru = X(), Z = {
	comment: Wl,
	lineComment: X(Wl),
	blockComment: X(Wl),
	docComment: X(Wl),
	...
	operatorKeyword: X($l),
	controlKeyword: X($l),
	definitionKeyword: X($l),
	moduleKeyword: X($l),
	operator: eu,
	derefOperator: X(eu),
	arithmeticOperator: X(eu),
	logicOperator: X(eu),
	bitwiseOperator: X(eu),
	compareOperator: X(eu),
	updateOperator: X(eu),
	definitionOperator: X(eu),
	typeOperator: X(eu),
	controlOperator: X(eu),
	punctuation: tu,
	separator: X(tu),
	bracket: nu,
	angleBracket: X(nu),
	...
	documentMeta: X(ru),
	annotation: X(ru),
	processingInstruction: X(ru),
	definition: jl.defineModifier("definition"),
	constant: jl.defineModifier("constant"),
	function: jl.defineModifier("function"),
	standard: jl.defineModifier("standard"),
	local: jl.defineModifier("local"),
	special: jl.defineModifier("special")
};
for (let e in Z) {
	let t = Z[e];
	t instanceof jl && (t.name = e);
}
zl([
	{
		tag: Z.link,
...
var iu = /* @__PURE__ */ new K();
function au(e) {
	return E.define({ combine: e ? (t) => t.concat(e) : void 0 });
}
var ou = /* @__PURE__ */ new K(), Q = class {
	constructor(e, t, n = [], r = "") {
		this.data = e, this.name = r, k.prototype.hasOwnProperty("tree") || Object.defineProperty(k.prototype, "tree", { get() {
			return lu(this);
		} }), this.parser = t, this.extension = [yu.of(this), k.languageData.of((e, t, n) => {
			let r = su(e, t, n), i = r.type.prop(iu);
			if (!i) return [];
			let a = e.facet(i), o = r.type.prop(ou);
			if (o) {
	...
	isActiveAt(e, t, n = -1) {
		return su(e, t, n).type.prop(iu) == this.data;
	}
	findRegions(e) {
		let t = e.facet(yu);
...
function su(e, t, n) {
	let r = e.facet(yu), i = lu(e).topNode;
	if (!r || r.allowsNesting) for (let e = i; e; e = e.enter(t, n, J.ExcludeBuffers | J.EnterBracketed)) e.type.isTop && (i = e);
	return i;
}
var cu = class e extends Q {
	constructor(e, t, n) {
		super(e, t, [], n), this.parser = t;
	}
	static define(t) {
		let n = au(t.languageData);
		return new e(n, t.parser.configure({ props: [iu.add((e) => e.isTop ? n : void 0)] }), t.name);
	}
	configure(t, n) {
...
var du = class {
	...
	startParse() {
		return this.parser.startParse(new du(this.state.doc), this.fragments);
	}
	work(e, t) {
		return t != null && t >= this.state.doc.length && (t = void 0), this.tree != Y.empty && this.isDone(t ?? this.state.doc.length) ? (this.takeTree(), !0) : this.withContext(() => {
			...
			for (this.parse ||= this.startParse(), t != null && (this.parse.stoppedAt == null || this.parse.stoppedAt > t) && t < this.state.doc.length && this.parse.stopAt(t);;) {
				...
				if (n) if (this.fragments = this.withoutTempSkipped(pl.addTree(n, this.fragments, this.parse.stoppedAt != null)), this.treeLen = this.parse.stoppedAt ?? this.state.doc.length, this.tree = n, this.parse = null, this.treeLen < (t ?? this.state.doc.length)) this.parse = this.startParse();
				else return !0;
				if (e()) return !1;
			}
		});
	...
	withoutTempSkipped(e) {
		for (let t; t = this.tempSkipped.pop();) e = mu(e, t.from, t.to);
		return e;
	}
	changes(t, n) {
		...
		if (this.takeTree(), !t.empty) {
			...
			if (t.iterChangedRanges((t, n, r, i) => e.push({
				...
				fromB: r,
				toB: i
			})), r = pl.applyChanges(r, e), i = Y.empty, a = 0, o = {
	...
	updateViewport(e) {
		...
		for (let t = 0; t < this.skipped.length; t++) {
			...
			n < e.to && r > e.from && (this.fragments = mu(this.fragments, n, r), this.skipped.splice(t--, 1));
		}
...
var hu = class e {
	...
	static init(t) {
		let n = Math.min(3e3, t.doc.length), r = pu.create(t.facet(yu).parser, t, {
			from: 0,
			to: n
		});
...
Q.state = /* @__PURE__ */ Ce.define({
	...
	update(e, t) {
		...
		return t.startState.facet(yu) == t.state.facet(yu) ? e.apply(t) : hu.init(t.state);
	}
});
var gu = (e) => {
...
typeof requestIdleCallback < "u" && (gu = (e) => {
	let t = -1, n = setTimeout(() => {
		t = requestIdleCallback(e, { timeout: 400 });
	}, 100);
	return () => t < 0 ? clearTimeout(n) : cancelIdleCallback(t);
});
var _u = typeof navigator < "u" && navigator.scheduling?.isInputPending ? () => navigator.scheduling.isInputPending() : null, vu = /* @__PURE__ */ z.fromClass(class {
	constructor(e) {
	...
	work(e) {
		...
		let a = Date.now() + Math.min(this.chunkBudget, 100, e && !_u ? Math.max(25, e.timeRemaining() - 5) : 1e9), o = i.context.treeLen < r && n.doc.length > r + 1e3, s = i.context.work(() => _u && _u() || Date.now() > a, r + (o ? 0 : 1e5));
		this.chunkBudget -= Date.now() - t, (s || this.chunkBudget <= 0) && (i.context.takeTree(), this.view.dispatch({ effects: Q.setState.of(new hu(i.context)) })), this.chunkBudget > 0 && !(s && !o) && this.scheduleWork(), this.checkAsyncSchedule(i.context);
	}
...
function Eu(e, t) {
	e instanceof k && (e = new Du(e));
	for (let n of e.state.facet(Su)) {
		let r = n(e, t);
		if (r !== void 0) return r;
	}
	let n = lu(e.state);
	return n.length >= t ? ku(e, n, t) : null;
}
var Du = class {
	constructor(e, t = {}) {
...
function Mu(e) {
	let t = e.type.prop(Ou);
	if (t) return t;
	let n = e.firstChild, r;
	if (n && (r = n.type.prop(K.closedBy))) {
		let t = e.lastChild, n = t && r.indexOf(t.name) > -1;
		return (e) => Ru(e, !0, 1, void 0, n && !ju(e) ? t.from : void 0);
	}
	return e.parent == null ? Nu : null;
}
function Nu() {
	return 0;
}
var Pu = class e extends Du {
	constructor(e, t, n) {
...
function Lu({ closing: e, align: t = !0, units: n = 1 }) {
	return (r) => Ru(r, t, n, e);
}
function Ru(e, t, n, r, i) {
	let a = e.textAfter, o = a.match(/^\s*/)[0].length, s = r && a.slice(o, o + r.length) == r || i == e.pos + o, c = t ? Iu(e) : null;
	return c ? s ? e.column(c.from) : e.column(c.to) : e.baseIndent + (s ? 0 : e.unit * n);
}
var zu = (e) => e.baseIndent;
function Bu({ except: e, units: t = 1 } = {}) {
	return (n) => {
...
function Hu() {
	return k.transactionFilter.of((e) => {
		...
		for (let { head: e } of o.selection.ranges) {
			...
			let n = Eu(o, t.from);
			if (n == null) continue;
			let r = /^\s*/.exec(t.text)[0], i = Tu(o, n);
			r != i && c.push({
				from: t.from,
				to: t.from + r.length,
				insert: i
...
var Uu = /* @__PURE__ */ E.define(), Wu = /* @__PURE__ */ new K();
function Gu(e) {
...
function Ku(e, t, n) {
	...
	for (let o = i; o; o = o.next) {
		...
		if (a && i.from < t) break;
		let s = i.type.prop(Wu);
		if (s && (i.to < r.length - 50 || r.length == e.doc.length || !qu(i))) {
			let r = s(i, e);
...
var Xu = /* @__PURE__ */ D.define({ map: Yu }), Zu = /* @__PURE__ */ D.define({ map: Yu });
function Qu(e) {
	let t = [];
...
var $u = /* @__PURE__ */ Ce.define({
	...
	update(e, t) {
		t.isUserEvent("delete") && t.changes.iterChangedRanges((t, n) => e = ed(e, t, n)), e = e.map(t.changes);
		for (let n of t.effects) if (n.is(Xu) && !nd(e, n.value.from, n.value.to)) {
			let { preparePlaceholder: r } = t.state.facet(ld), i = r ? F.replace({ widget: new pd(r(t.state, n.value)) }) : fd;
			e = e.update({ add: [i.range(n.value.from, n.value.to)] });
		} else n.is(Zu) && (e = e.update({
			filter: (e, t) => n.value.from != e || n.value.to != t,
			filterFrom: n.value.from,
			filterTo: n.value.to
		}));
		return t.selection && (e = ed(e, t.selection.main.head)), e;
	},
...
function td(e, t, n) {
	var r;
	let i = null;
	return (r = e.field($u, !1)) == null || r.between(t, n, (e, t) => {
		(!i || i.from > e) && (i = {
			from: e,
			to: t
		});
...
function rd(e, t) {
	return e.field($u, !1) ? t : t.concat(D.appendConfig.of(ud()));
}
var id = (e) => {
	for (let t of Qu(e)) {
		let n = Ju(e.state, t.from, t.to);
		if (n) return e.dispatch({ effects: rd(e.state, [Xu.of(n), od(e, n)]) }), !0;
	}
	return !1;
}, ad = (e) => {
	...
	let t = [];
	for (let n of Qu(e)) {
		let r = td(e.state, n.from, n.to);
		r && t.push(Zu.of(r), od(e, r, !1));
	}
...
var sd = [
	...
	},
	{
		...
		run: (e) => {
			...
			for (let r = 0; r < t.doc.length;) {
				...
				a && n.push(Xu.of(a)), r = (a ? e.lineBlockAt(a.to) : i).to + 1;
			}
			return n.length && e.dispatch({ effects: rd(e.state, n) }), !!n.length;
		}
	},
	{
		key: "Ctrl-Alt-]",
	...
	placeholderText: "…"
}, ld = /* @__PURE__ */ E.define({ combine(e) {
	return rt(e, cd);
} });
function ud(e) {
	let t = [$u, _d];
	return e && t.push(ld.of(e)), t;
}
function dd(e, t) {
	let { state: n } = e, r = n.facet(ld), i = (t) => {
		let n = e.lineBlockAt(e.posAtDOM(t.target)), r = td(e.state, n.from, n.to);
		r && e.dispatch({ effects: Zu.of(r) }), t.preventDefault();
	};
...
var fd = /* @__PURE__ */ F.replace({ widget: /* @__PURE__ */ new class extends en {
	toDOM(e) {
		return dd(e, null);
	}
}() }), pd = class extends en {
...
function gd(e = {}) {
	let t = {
		...md,
		...e
	}, n = new hd(t, !0), r = new hd(t, !1), i = z.fromClass(class {
		constructor(e) {
			this.from = e.viewport.from, this.markers = this.buildMarkers(e);
		}
		update(e) {
			(e.docChanged || e.viewportChanged || e.startState.facet(yu) != e.state.facet(yu) || e.startState.field($u, !1) != e.state.field($u, !1) || lu(e.startState) != lu(e.state) || t.foldingChanged(e)) && (this.markers = this.buildMarkers(e.view));
		}
		buildMarkers(e) {
			let t = new ut();
			for (let i of e.viewportLineBlocks) {
				let a = td(e.state, i.from, i.to) ? r : Ju(e.state, i.from, i.to) ? n : null;
		...
		yc({
			...
			domEventHandlers: {
				...
				click: (e, t, n) => {
					...
					let r = td(e.state, t.from, t.to);
					if (r) return e.dispatch({ effects: Zu.of(r) }), !0;
					let i = Ju(e.state, t.from, t.to);
					return i ? (e.dispatch({ effects: Xu.of(i) }), !0) : !1;
				}
			}
		}),
		ud()
...
var _d = /* @__PURE__ */ W.baseTheme({
	...
	constructor(e, t) {
		...
		this.scope = a instanceof Q ? (e) => e.prop(iu) == a.data : a ? (e) => e == a : void 0, this.style = zl(e.map((e) => ({
			tag: e.tag,
...
}, yd = /* @__PURE__ */ E.define(), bd = /* @__PURE__ */ E.define({ combine(e) {
	return e.length ? [e[0]] : null;
} });
function xd(e) {
	let t = e.facet(yd);
...
function Sd(e, t) {
	let n = [wd], r;
	return e instanceof vd && (e.module && n.push(W.styleModule.of(e.module)), r = e.themeType), t?.fallback ? n.push(bd.of(e)) : r ? n.push(yd.computeN([W.darkTheme], (t) => t.facet(W.darkTheme) == (r == "dark") ? [e] : [])) : n.push(yd.of(e)), n;
}
var Cd = class {
	constructor(e) {
		this.markCache = Object.create(null), this.tree = lu(e.state), this.decorations = this.buildDeco(e, xd(e.state)), this.decoratedTo = e.viewport.to;
	}
	update(e) {
		let t = lu(e.state), n = xd(e.state), r = n != xd(e.startState), { viewport: i } = e.view, a = e.changes.mapPos(this.decoratedTo, 1);
	...
	buildDeco(e, t) {
		...
		let n = new ut();
		for (let { from: r, to: i } of e.visibleRanges) Vl(this.tree, t, (e, t, r) => {
			n.add(e, t, this.markCache[r] || (this.markCache[r] = F.mark({ class: r })));
		}, r, i);
		return n.finish();
	}
}, wd = /* @__PURE__ */ Ee.high(/* @__PURE__ */ z.fromClass(Cd, { decorations: (e) => e.decorations })), Td = /* @__PURE__ */ vd.define([
	{
		tag: Z.meta,
		color: "#404740"
	},
...
}), Dd = 1e4, Od = "()[]{}", kd = /* @__PURE__ */ E.define({ combine(e) {
	return rt(e, {
		afterCursor: !0,
		brackets: Od,
		maxScanDistance: Dd,
...
} }), Ad = /* @__PURE__ */ F.mark({ class: "cm-matchingBracket" }), jd = /* @__PURE__ */ F.mark({ class: "cm-nonmatchingBracket" });
function Md(e) {
	let t = [], n = e.matched ? Ad : jd;
...
function Nd(e) {
	...
	for (let r of e.selection.ranges) {
		if (!r.empty) continue;
		let i = zd(e, r.head, -1, n) || r.head > 0 && zd(e, r.head - 1, 1, n) || n.afterCursor && (zd(e, r.head, 1, n) || r.head < e.doc.length && zd(e, r.head + 1, -1, n));
		i && (t = t.concat(n.renderMatch(i, e)));
	}
	return F.set(t, !0);
}
var Pd = [/* @__PURE__ */ z.fromClass(class {
	constructor(e) {
		this.paused = !1, this.decorations = Nd(e.state);
	}
	update(e) {
		(e.docChanged || e.selectionSet || this.paused) && (e.view.composing ? (this.decorations = this.decorations.map(e.changes), this.paused = !0) : (this.decorations = Nd(e.state), this.paused = !1));
	}
}, { decorations: (e) => e.decorations }), Ed];
function Fd(e = {}) {
	return [kd.of(e), Pd];
}
var Id = /* @__PURE__ */ new K();
function Ld(e, t, n) {
...
function Rd(e) {
	let t = e.type.prop(Id);
	return t ? t(e.node) : e;
}
function zd(e, t, n, r = {}) {
	let i = r.maxScanDistance || Dd, a = r.brackets || Od, o = lu(e), s = o.resolveInner(t, n);
	for (let r = s; r; r = r.parent) {
		let i = Ld(r.type, n, a);
		if (i && r.from < r.to) {
			let o = Rd(r);
			if (o && (n > 0 ? t >= o.from && t < o.to : t > o.from && t <= o.to)) return Bd(e, t, n, r, o, i, a);
		}
	}
	return Vd(e, t, n, o, s.type, i, a);
}
function Bd(e, t, n, r, i, a, o) {
	...
	if (u && (n < 0 ? u.childBefore(r.from) : u.childAfter(r.to))) do
		if (n < 0 ? u.to <= r.from : u.from >= r.to) {
			...
			} else if (Ld(u.type, n, o)) l++;
			else if (Ld(u.type, -n, o)) {
				if (l == 0) {
					let e = Rd(u);
					return {
						start: c,
...
var Ud = class {
	...
	indentation() {
		return this.overrideIndent ?? Hd(this.string, null, this.tabSize);
	}
	match(e, t, n) {
		if (typeof e == "string") {
...
function Wd(e) {
	return {
		...
		copyState: e.copyState || Gd,
		indent: e.indent || (() => null),
		languageData: e.languageData || {},
		tokenTable: e.tokenTable || $d,
...
var Kd = /* @__PURE__ */ new WeakMap(), qd = class e extends Q {
	constructor(e) {
		let t = au(e.languageData), n = Wd(e), r, i = new class extends ml {
			createParse(e, t, n) {
				return new Zd(r, e, t, n);
			}
		}();
		super(t, i, [], e.name), this.topNode = uf(t, this), r = this, this.streamParser = n, this.stateAfter = new K({ perNode: !0 }), this.tokenTable = e.tokenTable ? new of(n.tokenTable) : sf;
	}
	static define(t) {
		return new e(t);
	}
	getIndent(e) {
		...
		n && (t = Kd.get(e.state), t != null && t < e.pos - 1e4 && (t = void 0));
		let r = Jd(this, e.node.tree, e.node.from, e.node.from, t ?? e.pos), i, a;
		...
		for (; i < e.pos;) {
			...
			if (t.length) {
				let i = n ? n(t.from) : -1, o = new Ud(t.text, e.state.tabSize, e.unit, i < 0 ? void 0 : i);
				for (; o.pos < r - t.from;) Qd(this.streamParser.token, o, a);
			} else this.streamParser.blankLine(a, e.unit);
			if (r == e.pos) break;
			i = t.to + 1;
		}
		let o = e.lineAt(e.pos);
		return n && t == null && Kd.set(e.state, o.from), this.streamParser.indent(a, /^\s*(.*)/.exec(o.text)[1], e);
	}
	get allowsNesting() {
		return !1;
	}
...
function Jd(e, t, n, r, i) {
	...
	for (let a = t.children.length - 1; a >= 0; a--) {
		let o = t.children[a], s = n + t.positions[a], c = o instanceof Y && s < i && Jd(e, o, s, r, i);
		if (c) return c;
	}
	return null;
}
...
function Xd(e, t, n, r, i) {
	for (let i of t) {
		let t = i.from + (i.openStart ? 25 : 0), a = i.to - (i.openEnd ? 25 : 0), o = t <= n && a > n && Jd(e, i.tree, 0 - i.offset, n, a), s;
		if (o && o.pos <= r && (s = Yd(e, i.tree, n + i.offset, o.pos + i.offset, !1))) return {
			state: o.state,
			tree: s
		};
	}
	return {
		state: e.streamParser.startState(i ? wu(i) : 4),
		tree: Y.empty
	};
}
var Zd = class {
	constructor(e, t, n, r) {
		...
		let i = pu.get(), a = r[0].from, { state: o, tree: s } = Xd(e, n, a, this.to, i?.state);
		...
		i && this.parsedPos < i.viewport.from - 1e5 && r.some((e) => e.from <= i.viewport.from && e.to >= i.viewport.from) && (this.state = this.lang.streamParser.startState(wu(i.state)), i.skipUntilInView(this.parsedPos, i.viewport.from), this.parsedPos = i.viewport.from), this.moveRangeIndex();
	}
	advance() {
		let e = pu.get(), t = this.stoppedAt == null ? this.to : Math.min(this.to, this.stoppedAt), n = Math.min(t, this.chunkStart + 512);
	...
	parseLine(e) {
		let { line: t, end: n } = this.nextLine(), r = 0, { streamParser: i } = this.lang, a = new Ud(t, e ? e.state.tabSize : 4, e ? wu(e.state) : 2);
		if (a.eol()) i.blankLine(this.state, a.indentUnit);
		else for (; !a.eol();) {
			let e = Qd(i.token, a, this.state);
...
var $d = /* @__PURE__ */ Object.create(null), ef = [q.none], tf = /* @__PURE__ */ new Wc(ef), nf = [], rf = /* @__PURE__ */ Object.create(null), af = /* @__PURE__ */ Object.create(null);
for (let [e, t] of [
...
]) af[e] = /* @__PURE__ */ lf($d, t);
var of = class {
	constructor(e) {
		this.extra = e, this.table = Object.assign(Object.create(null), af);
	}
	resolve(e) {
		return e ? this.table[e] || (this.table[e] = lf(this.extra, e)) : 0;
	}
}, sf = /* @__PURE__ */ new of($d);
function cf(e, t) {
...
function lf(e, t) {
	...
	for (let r of t.split(" ")) {
		...
		for (let n of r.split(".")) {
			let r = e[n] || Z[n];
			r ? typeof r == "function" ? t.length ? t = t.map(r) : cf(n, `Modifier ${n} used at start of tag`) : t.length ? cf(n, `Tag ${n} used as modifier`) : t = Array.isArray(r) ? r : [r] : cf(n, `Unknown highlighting tag ${n}`);
		}
		for (let e of t) n.push(e);
	}
	if (!n.length) return 0;
	let r = t.replace(/ /g, "_"), i = r + " " + n.map((e) => e.id), a = rf[i];
	if (a) return a.id;
	let o = rf[i] = q.define({
		id: ef.length,
		name: r,
	...
	return ef.push(o), o.id;
}
function uf(e, t) {
	let n = q.define({
		id: ef.length,
		name: "Document",
		props: [iu.add(() => e), Ou.add(() => (e) => t.getIndent(e))],
		top: !0
	});
	return ef.push(n), n;
}
...
var df = class e {
	...
	static start(t, n, r = 0) {
		...
		return new e(t, [], n, r, r, 0, [], 0, i ? new ff(i, i.start) : null, 0, null);
	}
	get context() {
	...
	updateContext(e) {
		if (e != this.curContext.context) {
			let t = new ff(this.curContext.tracker, e);
...
var gf = class {
	...
	constructor(e, t) {
		this.input = e, this.ranges = t, this.chunk = "", this.chunkOff = 0, this.chunk2 = "", this.chunk2Pos = 0, this.next = -1, this.token = _f, this.rangeIndex = 0, this.pos = this.chunkPos = t[0].from, this.range = t[0], this.end = t[t.length - 1].to, this.readNext();
	}
	resolveOffset(e, t) {
	...
	reset(e, t) {
		if (t ? (this.token = t, t.start = e, t.lookAhead = e + 1, t.value = t.extended = -1) : this.token = _f, this.pos != e) {
	...
	token(e, t) {
		let { parser: n } = t.p;
		Sf(this.data, e, t, this.id, n.data, n.tokenPrecTable);
	}
};
yf.prototype.contextual = yf.prototype.fallback = yf.prototype.extend = !1;
var bf = class {
	constructor(e, t, n) {
		this.precTable = t, this.elseToken = n, this.data = typeof e == "string" ? hf(e) : e;
	}
	token(e, t) {
		let n = e.pos, r = 0;
		for (;;) {
			let n = e.next < 0, i = e.resolveOffset(1, 1);
			if (Sf(this.data, e, t, 0, this.data, this.precTable), e.token.value > -1) break;
...
bf.prototype.contextual = yf.prototype.fallback = yf.prototype.extend = !1;
var xf = class {
	constructor(e, t = {}) {
...
function Sf(e, t, n, r, i, a) {
	...
	scan: for (; (s & e[o]) != 0;) {
		...
		for (let r = o + 3; r < n; r += 2) if ((e[r + 1] & s) > 0) {
			let n = e[r];
			if (c.allows(n) && (t.token.value == -1 || t.token.value == n || wf(n, t.token.value, i, a))) {
				t.acceptToken(n);
				break;
			}
		}
...
function wf(e, t, n, r) {
	let i = Cf(n, r, t);
	return i < 0 || Cf(n, r, e) < i;
}
var $ = typeof process < "u" && process.env && /\bparse\b/.test(process.env.LOG), Tf = null;
function Ef(e, t, n) {
...
var Df = class {
	...
	nextFragment() {
		...
		if (e) {
			for (this.safeFrom = e.openStart ? Ef(e.tree, e.from + e.offset, 1) - e.offset : e.from, this.safeTo = e.openEnd ? Ef(e.tree, e.to + e.offset, -1) - e.offset : e.to; this.trees.length;) this.trees.pop(), this.start.pop(), this.index.pop();
	...
	constructor(e, t) {
		this.stream = t, this.tokens = [], this.mainToken = null, this.actions = [], this.tokens = e.tokenizers.map((e) => new gf());
	}
	getActions(e) {
		...
		return s && e.setLookAhead(s), !n && e.pos == this.stream.end && (n = new gf(), n.value = e.p.parser.eofTerm, n.start = n.end = e.pos, t = this.addActions(e, n.value, n.end, t)), this.mainToken = n, this.actions;
	}
	getMainToken(e) {
		if (this.mainToken) return this.mainToken;
		let t = new gf(), { pos: n, p: r } = e;
	...
	addActions(e, t, n, r) {
		...
		for (let e = 0; e < 2; e++) for (let s = a.stateSlot(i, e ? 2 : 1);; s += 3) {
			if (o[s] == 65535) if (o[s + 1] == 1) s = Ff(o, s + 2);
			else {
				r == 0 && o[s + 1] == 2 && (r = this.putAction(Ff(o, s + 2), t, n, r));
				break;
			}
			o[s] == t && (r = this.putAction(Ff(o, s + 1), t, n, r));
		}
		return r;
	}
}, kf = class {
	constructor(e, t, n, r) {
		this.parser = e, this.input = t, this.ranges = r, this.recovering = 0, this.nextStackID = 9812, this.minStackPos = 0, this.reused = [], this.stoppedAt = null, this.lastBigReductionStart = -1, this.lastBigReductionSize = 0, this.bigReductionCount = 0, this.stream = new vf(t, r), this.tokens = new Of(e, this.stream), this.topTerm = e.top[1];
		let { from: i } = r[0];
		this.stacks = [df.start(this, e.top[0], i)], this.fragments = n.length && this.stream.end - i > e.bufferLength * 4 ? new Df(n, e.nodeSet) : null;
	}
	get parsedPos() {
	...
	runRecovery(e, t, n) {
		...
		for (let a = 0; a < e.length; a++) {
			...
			this.stream.end > o.pos ? (c == o.pos && (c++, s = 0), o.recoverByDelete(s, c), $ && console.log(l + this.stackID(o) + ` (via recover-delete ${this.parser.getName(s)})`), Af(o, n)) : (!r || r.score < u.score) && (r = u);
		}
		return r;
	}
	stackToTree(e) {
	...
	stackID(e) {
		let t = (Tf ||= /* @__PURE__ */ new WeakMap()).get(e);
		return t || Tf.set(e, t = String.fromCodePoint(this.nextStackID++)), t + e;
	}
};
function Af(e, t) {
...
var jf = class {
	...
	constructor(e) {
		this.start = e.start, this.shift = e.shift || Mf, this.reduce = e.reduce || Mf, this.reuse = e.reuse || Mf, this.hash = e.hash || (() => 0), this.strict = e.strict !== !1;
	}
}, Pf = class e extends ml {
	constructor(e) {
		...
		this.nodeSet = new Wc(t.map((t, i) => q.define({
		...
		}))), e.propSources && (this.nodeSet = this.nodeSet.extend(...e.propSources)), this.strict = !1, this.bufferLength = Bc;
		let a = hf(e.tokenData);
		this.context = e.context, this.specializerSpecs = e.specialized || [], this.specialized = new Uint16Array(this.specializerSpecs.length);
		for (let e = 0; e < this.specializerSpecs.length; e++) this.specialized[e] = this.specializerSpecs[e].term;
		this.specializers = this.specializerSpecs.map(Lf), this.states = hf(e.states, Uint32Array), this.data = hf(e.stateData), this.goto = hf(e.goto), this.maxTerm = e.maxTerm, this.tokenizers = e.tokenizers.map((e) => typeof e == "number" ? new yf(a, e) : e), this.topRules = e.topRules, this.dialects = e.dialects || {}, this.dynamicPrecedences = e.dynamicPrecedences || null, this.tokenPrecTable = e.tokenPrec, this.termNames = e.termNames || null, this.maxNode = this.nodeSet.types.length - 1, this.dialect = this.parseDialect(), this.top = this.topRules[Object.keys(this.topRules)[0]];
	}
	createParse(e, t, n) {
		let r = new kf(this, e, t, n);
	...
	hasAction(e, t) {
		...
		for (let r = 0; r < 2; r++) for (let i = this.stateSlot(e, r ? 2 : 1), a;; i += 3) {
			if ((a = n[i]) == 65535) if (n[i + 1] == 1) a = n[i = Ff(n, i + 2)];
			else if (n[i + 1] == 2) return Ff(n, i + 2);
			else break;
			if (a == t || a == 0) return Ff(n, i + 1);
		}
		return 0;
	}
	stateSlot(e, t) {
	...
	allActions(e, t) {
		...
		for (let n = this.stateSlot(e, 1); r == null; n += 3) {
			if (this.data[n] == 65535) if (this.data[n + 1] == 1) n = Ff(this.data, n + 2);
			else break;
			r = t(Ff(this.data, n + 1));
		}
		return r;
	}
	nextStates(e) {
	...
	configure(t) {
		...
		return t.tokenizers && (n.tokenizers = this.tokenizers.map((e) => {
			...
			return n.specializers[r] = Lf(a), a;
...
//#endregion
export { z as $, Ou as A, Ee as At, Il as B, rt as Bt, gd as C, ce as Ct, Uu as D, k as Dt, Wu as E, T as Et, zd as F, Ce as Ft, q as G, J as H, S as Ht, ou as I, f as It, Y as J, fl as K, Sd as L, O as Lt, Tu as M, ut as Mt, Cu as N, it as Nt, wu as O, E as Ot, iu as P, D as Pt, W as Q, lu as R, re as Rt, id as S, se as St, sd as T, Oe as Tt, K as U, ie as Ut, Z as V, xt as Vt, Wc as W, F as X, gl as Y, I as Z, Td as _, lc as _t, vd as a, Zo as at, uu as b, It as bt, Q as c, Cs as ct, pu as d, $s as dt, en as et, qd as f, Mo as ft, Bu as g, Fo as gt, Id as h, js as ht, bf as i, os as it, Hu as j, A as jt, Eu as k, C as kt, xu as l, zc as lt, Fd as m, R as mt, xf as n, Ps as nt, Du as o, ic as ot, Ud as p, Fc as pt, ml as q, Pf as r, Xo as rt, cu as s, tc as st, Nf as t, ec as tt, bu as u, gs as ut, au as v, cc as vt, Gu as w, Qe as wt, zu as x, Ve as xt, Lu as y, Ws as yt, jl as z, ae as zt };

//# sourceMappingURL=dist-CXEBfo4y.js.map