...
var n = {
	...
	token: function(e, n) {
		...
		if (r == "@") {
			...
			return e.eatWhile(function(e) {
				return e != " " && (s += e, !0);
			}), n.langs.push(s), e.next(), t(n, " "), "string.special";
		}
		if (r == "^") {
			e.next(), t(n, "^");
			var c = "";
			return e.eatWhile(function(e) {
				return e != ">" && (c += e, !0);
			}), n.types.push(c), e.next(), t(n, ">"), "variable";
		}
		r == " " && t(n, r), r == "." && t(n, r);
	}
};
...
//# sourceMappingURL=ntriples-By9Rwqa4.js.map