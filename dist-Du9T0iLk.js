import { A as e, B as t, E as n, V as r, g as i, n as a, r as o, s, u as c, w as l } from "./dist-C56v8Vz7.js";
import { r as u } from "./dist-BKR2rOQp.js";
...
var _ = /* @__PURE__ */ new a((e, t) => {
	if (e.next == 40) {
		let t = e.peek(-1);
		(h(t) || g(t) || t == 95 || t == 45) && e.acceptToken(p, 1);
	}
}), v = /* @__PURE__ */ new a((e) => {
	if (m.indexOf(e.peek(-1)) > -1) {
		let { next: t } = e;
		(h(t) || t == 95 || t == 35 || t == 46 || t == 91 || t == 58 || t == 45) && e.acceptToken(d);
	}
}), y = /* @__PURE__ */ new a((e) => {
	if (m.indexOf(e.peek(-1)) < 0) {
		let { next: t } = e;
		if (t == 37 && (e.advance(), e.acceptToken(f)), h(t)) {
			do
				e.advance();
			while (h(e.next));
			e.acceptToken(f);
	...
	PseudoClassName: /* @__PURE__ */ r.constant(r.className),
	IdName: r.labelName,
	...
	"AtKeyword Interpolation": /* @__PURE__ */ r.special(r.variableName),
	...
	Escape: /* @__PURE__ */ r.special(r.string),
	": ...": r.punctuation,
	...
	name: "less",
	parser: /* @__PURE__ */ C.configure({ props: [/* @__PURE__ */ e.add({ Declaration: /* @__PURE__ */ i() }), /* @__PURE__ */ n.add({ Block: l })] }),
	languageData: {
		commentTokens: {
			block: {
				open: "/*",
...
}), T = /* @__PURE__ */ u((e) => e.name == "VariableName" || e.name == "AtKeyword");
function E() {
	return new c(w, w.data.of({ autocomplete: T }));
}
//#endregion
export { E as less };

//# sourceMappingURL=dist-Du9T0iLk.js.map