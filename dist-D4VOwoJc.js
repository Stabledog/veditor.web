import { A as e, B as t, E as n, H as r, K as i, R as a, V as o, g as s, i as c, n as l, r as ee, s as u, t as d, u as f, w as te, x as p, y as m } from "./dist-CVKUUr4R.js";
import { a as h, c as g, s as _ } from "./dist-DnNU6R8z.js";
//#region node_modules/@lezer/go/dist/index.js
var v = 177, y = 179, b = 184, x = 12, S = 13, C = 17, w = 20, T = 25, E = 53, D = 95, O = 142, k = 144, A = 145, j = 148, M = 10, N = 13, P = 32, F = 9, I = 47, L = 41, R = 125, z = new l((e, t) => {
	for (let n = 0, r = e.next; (t.context && (r < 0 || r == M || r == N || r == I && e.peek(n + 1) == I) || r == L || r == R) && e.acceptToken(v), r == P || r == F;) r = e.peek(++n);
}, { contextual: !0 }), B = /* @__PURE__ */ new Set([
	D,
	b,
	w,
	x,
	...
	tokenizers: [
		...
		1,
		2,
		new c("j~RQYZXz{^~^O$|~~aP!P!Qd~iO$}~~", 25, 181)
	],
	...
	/*@__PURE__*/ g("func ${name}(${params}) ${type} {\n	${}\n}", {
		label: "func",
		detail: "declaration",
		type: "keyword"
	}),
	/*@__PURE__*/ g("func (${receiver}) ${name}(${params}) ${type} {\n	${}\n}", {
		label: "func",
		detail: "method declaration",
		type: "keyword"
	}),
	/*@__PURE__*/ g("var ${name} = ${value}", {
		label: "var",
		detail: "declaration",
		type: "keyword"
	}),
	/*@__PURE__*/ g("type ${name} ${type}", {
		label: "type",
		detail: "declaration",
		type: "keyword"
	}),
	/*@__PURE__*/ g("const ${name} = ${value}", {
		label: "const",
		detail: "declaration",
		type: "keyword"
	}),
	...
	/*@__PURE__*/ g("for ${init}; ${test}; ${update} {\n	${}\n}", {
		label: "for",
		detail: "loop",
		type: "keyword"
	}),
	/*@__PURE__*/ g("for ${i} := range ${value} {\n	${}\n}", {
		label: "for",
		detail: "range",
		type: "keyword"
	}),
	...
	/*@__PURE__*/ g("import ${name} \"${module}\"\n${}", {
		label: "import",
		detail: "declaration",
		type: "keyword"
	})
], K = /*@__PURE__*/ new i(), q = /*@__PURE__*/ new Set([
	"SourceFile",
	"Block",
	"FunctionDecl",
	"MethodDecl",
...
function J(e, t) {
	return (n, r) => {
		outer: for (let i = n.node.firstChild, a = 0, o = null;;) {
			...
			t && i.name == t || i.name == "SpecList" ? (a++, o = i, i = i.firstChild) : (i.name == "DefName" && r(i, e), i = i.nextSibling);
		}
		return !0;
	};
}
var Y = {
	FunctionDecl: /*@__PURE__*/ J("function"),
	VarDecl: /*@__PURE__*/ J("var", "VarSpec"),
	ConstDecl: /*@__PURE__*/ J("constant", "ConstSpec"),
	TypeDecl: /*@__PURE__*/ J("type", "TypeSpec"),
	ImportDecl: /*@__PURE__*/ J("constant", "ImportSpec"),
	Parameter: /*@__PURE__*/ J("var"),
	__proto__: null
};
function X(e, t) {
	let n = K.get(t);
	...
	return t.cursor(r.IncludeAnonymous).iterate((t) => {
		if (a) a = !1;
			...
			let e = Y[t.name];
			if (e && e(t, o) || q.has(t.name)) return !1;
		} else if (t.to - t.from > 8192) {
			for (let n of X(e, t.node)) i.push(n);
			return !1;
		}
	}), K.set(t, i), i;
}
var Z = /^[\w$\xa1-\uffff][\w$\d\xa1-\uffff]*$/, Q = [
	"String",
	"LineComment",
	"BlockComment",
	"DefName",
	...
	let n = t.name == "VariableName" || t.to - t.from < 20 && Z.test(e.state.sliceDoc(t.from, t.to));
	if (!n && !e.explicit) return null;
	let r = [];
	for (let n = t; n; n = n.parent) q.has(n.name) && (r = r.concat(X(e.state.doc, n)));
	return {
		options: r,
		from: n ? t.from : e.pos,
		validFor: Z
	...
	name: "go",
	parser: /*@__PURE__*/ W.configure({ props: [/*@__PURE__*/ e.add({
		...
		Block: /*@__PURE__*/ m({ closing: "}" }),
		BlockComment: () => null,
		Statement: /*@__PURE__*/ s({ except: /^{/ })
	}), /*@__PURE__*/ n.add({
		"Block SwitchBlock SelectBlock LiteralValue InterfaceType StructType SpecList": te,
		BlockComment(e) {
			return {
				from: e.from + 2,
				to: e.to - 2
...
}), re = /*@__PURE__*/ "interface struct chan map package go return break continue goto fallthrough else defer range true false nil".split(" ").map((e) => ({
	label: e,
	type: "keyword"
}));
function ie() {
	let e = G.concat(re);
	return new f($, [$.data.of({ autocomplete: _(Q, h(e)) }), $.data.of({ autocomplete: ne })]);
}
//#endregion
export { ie as go };

//# sourceMappingURL=dist-D4VOwoJc.js.map