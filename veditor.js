...
}, { decorations: (e) => e.decorations }), $a = "0.12.0";
function eo(e, t) {
	let n = /https?:\/\/[^\s)\]>]+/g, r;
...
function yo(e, t, n, r) {
	...
	return d.push(v.updateListener.of((e) => {
		...
		parent: e
	}), s && (e.classList.add("veditor-vim-normal"), po()), Q.contentDOM.addEventListener("focus", () => {
		Wa(ro) && navigator.clipboard.readText().then((e) => {
