import { A as e, B as t, Dt as n, E as r, Q as i, R as a, V as o, h as s, n as c, r as l, s as u, t as d, u as f } from "./dist-1T0MK0Nn.js";
...
var Z = /* @__PURE__ */ i.inputHandler.of((e, t, r, i, o) => {
	if (e.composing || e.state.readOnly || t != r || i != ">" && i != "/" || !J.isActiveAt(e.state, t, -1)) return !1;
	let s = o(), { state: c } = s, l = c.changeByRange((e) => {
		let { head: t } = e, r = c.doc.sliceString(t - 1, t) == i, o = a(c).resolveInner(t, -1), s;
		if (r && i == ">" && o.name == "EndTag") {
			...
			if (o.from == t - 2 && e.lastChild?.name != "CloseTag" && (s = X(c.doc, e, t))) {
				let e = t + +(c.doc.sliceString(t, t + 1) === ">"), r = `${s}>`;
				return {
					range: n.cursor(t + r.length, -1),
					changes: {
						from: t,
						to: e,
						insert: r
...
//# sourceMappingURL=dist-PRY4xFOJ.js.map