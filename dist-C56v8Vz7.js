...
var pe = class {
	...
	static cursor(e, t = 0, n, r) {
		return me.create(e, e, (t == 0 ? 0 : t < 0 ? 8 : 16) | (n == null ? 7 : Math.min(6, n)) | (r ?? 16777215) << 6);
	}
	static range(e, t, n, r, i) {
		let a = (n ?? 16777215) << 6 | (r == null ? 7 : Math.min(6, r));
		return !i && e != t && (i = t < e ? 1 : -1), t < e ? me.create(t, e, 48 | a) : me.create(e, t, (i ? i < 0 ? 8 : 16 : 0) | a);
	}
...
var ft = class {
	...
	next() {
		for (;;) if (this.chunkIndex == this.layer.chunk.length) {
			...
			if (this.from = e + t.from[this.rangeIndex], this.to = e + t.to[this.rangeIndex], this.value = t.value[this.rangeIndex], this.setRangeIndex(this.rangeIndex + 1), this.minPoint < 0 || this.value.point && this.to - this.from >= this.minPoint) break;
		}
	}
	setRangeIndex(e) {
...
for (var Ct = "ͼ", wt = typeof Symbol > "u" ? "__" + Ct : Symbol.for(Ct), Tt = typeof Symbol > "u" ? "__styleSet" + Math.floor(Math.random() * 1e8) : Symbol("styleSet"), Et = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : {}, Dt = class {
	constructor(e, t) {
		this.rules = [];
		let { finish: n } = t || {};
		function r(e) {
...
var cn = class e extends it {
	...
	static create(t) {
		return new e(t.tagName, t.attributes || Yt);
	}
	static set(e, t = !1) {
		return A.of(e, t);
	}
...
function Zn(e, t, n) {
	if (!e) return [new Wn(0, 0, t == In ? 1 : 0)];
...
function er(e, t, n, r, i) {
	...
	return u && l == c && u.level + (i ? 0 : 1) < s.level ? T.cursor(u.side(!i, n) + e.from, u.forward(i, n) ? 1 : -1, u.level) : T.cursor(l + e.from, s.forward(i, n) ? -1 : 1, s.level);
}
function tr(e, t, n) {
	for (let r = t; r < n; r++) {
...
var _r = /* @__PURE__ */ E.define({ combine: (e) => e.length ? e[0] : !0 }), vr = 0, yr = /* @__PURE__ */ E.define({ combine(e) {
	return e.filter((t, n) => {
...
}, xr = /* @__PURE__ */ E.define(), Sr = /* @__PURE__ */ E.define(), Cr = /* @__PURE__ */ E.define(), wr = /* @__PURE__ */ E.define(), Tr = /* @__PURE__ */ E.define(), Er = /* @__PURE__ */ E.define(), Dr = /* @__PURE__ */ E.define();
function Or(e, t) {
	let n = e.state.facet(Dr);
...
var jr = /* @__PURE__ */ E.define(), Mr = class e {
	constructor(e, t, n, r) {
	...
	constructor(e, t, n) {
		...
		let r = [];
		this.changes.iterChangedRanges((e, t, n, i) => r.push(new Mr(e, t, n, i))), this.changedRanges = r;
	}
	static create(t, n, r) {
		return new e(t, n, r);
	}
	...
	domPosFor(e, t) {
		...
		return new Pn(this.parent.dom, n + (r ? 1 : 0), e == 0 || e == this.length);
	}
	markDirty(e) {
	...
	get root() {
		for (let e = this; e; e = e.parent) if (e instanceof Lr) return e;
		return null;
	}
	static get(e) {
		return e.cmTile;
	...
	sync(e) {
		...
		for (let o of this.children) {
			if (o.sync(e), a += o.length + o.breakAfter, r = n ? n.nextSibling : t.firstChild, i && r != o.dom && (i.written = !0), o.dom.parentNode == t) for (; r && r != o.dom;) r = Ir(r);
			else t.insertBefore(o.dom, r);
			n = o.dom;
		}
		for (r = n ? n.nextSibling : t.firstChild, i && r && (i.written = !0); r;) r = Ir(r);
		this.length = a;
	}
};
function Ir(e) {
...
var Lr = class extends Fr {
	...
	blockTiles(e) {
		for (let t = [], n = this, r = 0, i = 0;;) if (r == n.children.length) {
			...
			let a = n.children[r++];
			if (a instanceof Rr) t.push(r), n = a, r = 0;
			else {
	...
	resolveInline(e, t, n) {
		...
		function s(e, c) {
			for (let l = 0, u = 0; l < e.children.length && u <= c; l++) {
				...
				f >= c && (d.isComposite() ? s(d, c - u) : (!a || a.isHidden && (t > 0 || n && Vr(a, d))) && (f > c || d.flags & 32) ? (a = d, o = c - u) : (u < c || d.flags & 16 && !d.isHidden) && (r = d, i = c - u)), u = f;
			}
		}
		s(this, e);
		let c = (t < 0 ? r : a) || r || a;
	...
	coordsIn(e, t) {
		...
		return n ? n.tile.coordsIn(Math.max(0, n.offset), t) : Br(this);
	}
	domIn(e, t) {
...
var V = class e extends Fr {
	...
	coordsIn(e, t) {
		...
		e > n && (e = n);
		let r = e, i = e, a = 0;
		e == 0 && t < 0 || e == n && t >= 0 ? N.chrome || N.gecko || (e ? (r--, a = 1) : i < n && (i++, a = -1)) : t < 0 ? r-- : i < n && i++;
		let o = Dn(this.dom, r, i).getClientRects();
		if (!o.length) return null;
		let s = o[(a ? a < 0 : t >= 0) ? 0 : o.length - 1];
		return N.safari && !a && s.width == 0 && (s = Array.prototype.find.call(o, (e) => e.width) || s), a ? vn(s, a < 0) : s || null;
	}
	static of(t, n) {
		let r = new e(n || document.createTextNode(t), t);
		return n || (r.flags |= 2), r;
	}
}, Ur = class e extends B {
	constructor(e, t, n, r) {
	...
	addText(e, t, n, r) {
		...
		if (a && a.isText() && !(a.flags & 8) && a.length + e.length < 512) {
			...
			let t = i.children[i.children.length - 1] = new Hr(a.dom, a.text + e);
			t.parent = i;
		} else i.append(r || Hr.of(e, this.cache.find(Hr)?.dom));
		this.pos += e.length, this.afterWidget = null;
	}
	addComposition(e, t) {
		let n = this.curLine;
		n.dom != t.line.dom && (n.setDOM(this.cache.reused.has(t.line) ? ri(t.line.dom) : t.line.dom), this.cache.reused.set(t.line, 2));
		let r = n;
		for (let e = t.marks.length - 1; e >= 0; e--) {
			let n = t.marks[e], i = r.lastChild;
			if (i instanceof V && i.mark.eq(n.mark)) i.dom != n.dom && i.setDOM(ri(n.dom)), r = i;
			else {
		...
		let a = new Hr(e.text, e.text.nodeValue);
	...
	addLineStart(e, t) {
		e ||= ei;
		let n = zr.start(e, t || this.cache.find(zr)?.dom, !!t);
	...
	endLine() {
		if (this.curLine) {
			...
			(!e || !Qr(this.curLine, !1) || e.dom.nodeName != "BR" && e.isWidget() && !(N.ios && Qr(this.curLine, !0))) && this.curLine.append(this.cache.findWidget(ai, 0, 32) || new Ur(ai.toDOM(), 0, ai, 32)), this.curLine = this.afterWidget = null;
		}
	}
	updateBlockWrappers() {
		...
		for (let e = this.blockWrappers; e.value && e.from <= this.pos; e.next()) if (e.to >= this.pos) {
			let t = new Kr(e.from, e.to, e.value, e.rank), n = this.wrappers.length;
			for (; n > 0 && (this.wrappers[n - 1].rank - t.rank || this.wrappers[n - 1].to - t.to) < 0;) n--;
	...
	getBlockPos() {
		...
		for (let t of this.wrappers) {
			let n = e.lastChild;
			if (t.from < this.pos && n instanceof Rr && n.wrapper.eq(t.wrapper)) e = n;
			else {
				let n = Rr.of(t.wrapper, this.cache.find(Rr, (e) => e.wrapper.eq(t.wrapper))?.dom);
				e.append(n), e = n;
			}
		}
		return e;
	...
	getBuffer(e) {
		let t = 2 | (e < 0 ? 16 : 32), n = this.cache.find(Wr, void 0, 1);
		return n && (n.flags = t), n || new Wr(t);
	}
	flushBuffer() {
...
for (let e = 0; e < Yr.length; e++) Yr[e].bucket = e;
var Xr = class {
	constructor(e) {
	...
	findWidget(e, t, n) {
		...
		if (r.length) for (let i = 0, a = 0;; i++) {
			...
			let o = r[i];
			if (!this.reused.has(o) && (a == 0 ? o.widget.compare(e) : o.widget.constructor == e.constructor && e.updateDOM(o.dom, this.view, o.widget))) return r.splice(i, 1), i < this.index[0] && this.index[0]--, o.widget == e && o.length == t && (o.flags & 497) == n ? (this.reused.set(o, 1), o) : (this.reused.set(o, 2), new Ur(o.dom, t, e, o.flags & -498 | n));
		}
	}
	reuse(e) {
	...
	constructor(e, t, n, r, i) {
		this.view = e, this.decorations = r, this.disallowBlockEffectsFor = i, this.openWidget = !1, this.openMarks = 0, this.cache = new Xr(e), this.text = new Jr(e.state.doc), this.builder = new qr(this.cache, new Lr(e, e.contentDOM), A.iter(n)), this.cache.reused.set(t, 2), this.old = new Gr(t), this.reuseWalker = {
			skip: (e, t, n) => {
	...
	preserve(e, t, n) {
		let r = ni(this.old), i = this.openMarks;
		this.old.advance(e, n ? 1 : -1, {
			skip: (e, t, n) => {
				if (e.isWidget()) if (this.openWidget) this.builder.continueWidget(n - t);
				else {
					let a = n > 0 || t < e.length ? Ur.of(e.widget, this.view, n - t, e.flags & 496, this.cache.maybeReuse(e)) : this.cache.reuse(e);
				...
				else if (e instanceof Wr) this.cache.add(e);
	...
	emit(e, t) {
		let n = null, r = this.builder, i = 0, a = A.spans(this.decorations, e, t, {
			point: (e, t, a, o, s, c) => {
				if (a instanceof rn) {
					...
					if (i = o.length, s > o.length) r.continueWidget(t - e);
						...
						let i = a.widget || (a.block ? ii.block : ii.inline), c = $r(a), l = this.cache.findWidget(i, t - e, c) || Ur.of(i, this.view, t - e, c);
	...
	getCompositionContext(e) {
		...
		for (let r = e.parentNode;; r = r.parentNode) {
			...
			e instanceof V ? t.push(e) : e?.isLine() ? n = e : e instanceof Rr || (r.nodeName == "DIV" && !n && r != this.view.contentDOM ? n = new zr(r, ei) : n || t.push(V.of(new tn({
...
ii.inline = /* @__PURE__ */ new ii("span"), ii.block = /* @__PURE__ */ new ii("div");
var ai = /* @__PURE__ */ new class extends en {
	toDOM() {
	...
	update(e) {
		...
		let n = -1;
		this.view.inputState.composing >= 0 && !this.view.observer.editContext && (this.domChanged?.newSel ? n = this.domChanged.newSel.head : !_i(e.changes, this.hasComposition) && !e.selectionSet && (n = e.state.selection.main.head));
		let r = n > -1 ? ui(this.view, e.changes, n) : null;
		if (this.domChanged = null, this.hasComposition) {
			let { from: n, to: r } = this.hasComposition;
			t = new Mr(n, r, e.changes.mapPos(n, -1), e.changes.mapPos(r, 1)).addToSet(t.slice());
		}
		...
		this.updateDeco();
		let o = pi(i, this.decorations, e.changes);
		o.length && (t = Mr.extendWithRanges(t, o));
		let s = hi(a, this.blockWrappers, e.changes);
		return s.length && (t = Mr.extendWithRanges(t, s)), r && !t.some((e) => e.fromA <= r.range.fromA && e.toA >= r.range.toA) && (t = r.range.addToSet(t.slice())), this.tile.flags & 2 && t.length == 0 ? !1 : (this.updateInner(t, r), e.transactions.length && (this.lastUpdate = Date.now()), !0);
	}
	updateInner(e, t) {
		...
		n.ignore(() => {
			if (t || e.length) {
				let n = this.tile, r = new Zr(this.view, n, this.blockWrappers, this.decorations, this.dynamicDecorationMap);
	...
	updateSelection(e = !1, t = !1) {
		...
		if (s.empty ? l = c = this.inlineDOMNearPos(s.anchor, s.assoc || 1) : (l = this.inlineDOMNearPos(s.head, s.head == s.from ? 1 : -1), c = this.inlineDOMNearPos(s.anchor, s.anchor == s.from ? 1 : -1)), N.gecko && s.empty && !this.hasComposition && ci(c)) {
		...
		(o || !u.focusNode || (!pn(c.node, c.offset, u.anchorNode, u.anchorOffset) || !pn(l.node, l.offset, u.focusNode, u.focusOffset)) && !this.suppressWidgetCursorChange(u, s)) && (this.view.observer.ignore(() => {
			N.android && N.chrome && n.contains(u.focusNode) && gi(u.focusNode, n) && (n.blur(), n.focus({ preventScroll: !0 }));
			let e = ln(this.view.root);
			if (e) if (s.empty) {
				if (N.gecko) {
					let e = di(c.node, c.offset);
					if (e && e != 3) {
	...
	coordsAt(e, t) {
		let { tile: n, offset: r } = this.tile.resolveBlock(e, t);
		return n.isWidget() ? n.widget instanceof vi ? null : n.coordsInWidget(r, t, !0) : n.coordsIn(r, t);
	}
	lineAt(e, t) {
	...
	measureVisibleLineHeights(e) {
		let t = [], { from: n, to: r } = e, i = this.view.contentDOM.clientWidth, a = i > Math.max(this.view.scrollDOM.clientWidth, this.minWidth) + 1, o = -1, s = this.view.textDirection == I.LTR, c = 0, l = (e, u, d) => {
			for (let f = 0; f < e.children.length && !(u > r); f++) {
				...
				if (d && !f && (c += m.top - d.top), r instanceof Rr) p > n && l(r, u, m);
	...
	updateDeco() {
		let e = 1, t = this.view.state.facet(Cr).map((t) => (this.dynamicDecorationMap[e++] = typeof t == "function") ? t(this.view) : t), n = !1, r = this.view.state.facet(Tr).map((e, t) => {
		...
		this.blockWrappers = this.view.state.facet(wr).map((e) => typeof e == "function" ? e(this.view) : e);
	}
	scrollIntoView(e) {
		if (e.isSnapshot) {
...
function ui(e, t, n) {
	...
	return {
		range: new Mr(c.mapPos(a), c.mapPos(o), a, o),
		text: i
	};
}
function di(e, t) {
...
function yi(e, t, n = 1) {
	...
	return T.range(o + i.from, s + i.from);
}
...
function Si(e, t, n, r) {
	let i = xi(e, t.head, t.assoc || -1), a = !r || i.type != P.Text || !(e.lineWrapping || i.widgetLineBreaks) ? null : e.coordsAtPos(t.assoc < 0 && t.head > i.from ? t.head - 1 : t.head);
	if (a) {
...
function Di(e, t) {
	...
	for (let r = 0; r < t.ranges.length; r++) {
		...
		if (i.empty) {
			...
			let t = Ei(e, i.from, -1), n = Ei(e, i.to, 1);
			(t != i.from || n != i.to) && (a = T.range(i.from == i.anchor ? t : n, i.from == i.head ? t : n));
		}
...
function Oi(e, t, n) {
	let r = Ei(e.state.facet(Er).map((t) => t(e)), n.from, t.head > n.from ? -1 : 1);
...
function Ai(e, t, n, r) {
	...
	for (;;) {
		if (c < 0) return new ki(0, 1);
		if (c > e.viewState.docHeight) return new ki(e.state.doc.length, -1);
	...
	if (e.viewport.from >= l.to || e.viewport.to <= l.from) {
		...
		if (l.type == P.Text) {
			let t = bi(e, i, l, o, s);
			return new ki(t, t == l.from ? 1 : -1);
		}
	}
	if (l.type != P.Text) return c < (l.top + l.bottom) / 2 ? new ki(l.from, 1) : new ki(l.to, -1);
	let u = e.docView.lineAt(l.from, 2);
	return (!u || u.length != l.length) && (u = e.docView.lineAt(l.from, -2)), new ji(e, o, s, e.textDirectionAt(l.from)).scanTile(u, l.from);
}
var ji = class {
	constructor(e, t, n, r) {
	...
	scan(e, t) {
		let n = 0, r = e.length - 1, i = /* @__PURE__ */ new Set(), a = this.bidiIn(e[0], e[r]), o, s, c = -1, l = 1e9, u;
		search: for (; n < r;) {
			let d = r - n, f = n + r >> 1;
			adjust: if (i.has(f)) {
			...
			if (p) for (let t = 0; t < p.length; t++) {
				...
				if (!(i.width == 0 && p.length > 1)) {
					if (i.bottom < this.y) (!o || o.bottom < i.bottom) && (o = i), d = 1;
					else if (i.top > this.y) (!s || s.top > i.top) && (s = i), d = -1;
					else {
						let e = i.left > this.x ? this.x - i.left : i.right < this.x ? this.x - i.right : 0, t = Math.abs(e);
						t < l && (c = f, l = t, u = i), e && (d = e < 0 == (this.baseDir == I.LTR) ? -1 : 1);
					}
					d == -1 && (!a || this.baseDirAt(e[f], 1)) ? r = f : d == 1 && (!a || this.baseDirAt(e[f + 1], -1)) && (n = f + 1);
				}
			}
		}
		if (!u) {
		...
		if (l) {
			if (o && o.bottom > u.top) return this.y = o.bottom - 1, this.scan(e, t);
			if (s && s.top < u.bottom) return this.y = s.top + 1, this.scan(e, t);
		}
		let d = (a ? this.dirAt(e[c], 1) : this.baseDir) == I.LTR;
		return {
			i: c,
	...
	scanText(e, t) {
		...
		return r.after ? new ki(n[r.i + 1], -1) : new ki(n[r.i], 1);
	}
	scanTile(e, t) {
		if (!e.length) return new ki(t, 1);
		...
		return i.isText() ? this.scanText(i, a) : i.isComposite() ? this.scanTile(i, a) : r.after ? new ki(n[r.i + 1], -1) : new ki(a, 1);
	}
}, Mi = "￿", Ni = class {
	constructor(e, t) {
	...
	readRange(e, t) {
		...
		for (let r = e;;) {
			...
			let o = B.get(a);
			(i && o ? i.breakAfter : (i ? i.breakAfter : hn(r)) || hn(a) && (r.nodeName != "BR" || i?.isWidget()) && this.text.length > e) && !Fi(a, t) && this.lineBreak(), r = a;
		}
	...
	findPointInside(e, t) {
		for (let n of this.points) (e.nodeType == 3 ? n.node == e : e.contains(n.node)) && (n.pos = this.text.length + (Pi(e, n.node, n.offset) ? t : 0));
	}
};
function Pi(e, t, n) {
	for (;;) {
...
var Ii = class {
	...
	constructor(e, t, n, r) {
		...
		if (e.state.readOnly && t > -1) this.newSel = null;
		else if (t > -1 && (this.bounds = Ri(e.docView.tile, t, n, 0))) {
			let t = i || a ? [] : Ui(e), n = new Ni(t, e);
			n.readRange(this.bounds.startDOM, this.bounds.endDOM), this.text = n.text, this.newSel = Wi(t, this.bounds.from);
		} else {
			...
			if ((N.ios || N.chrome) && o.main.empty && n != r && (s.from > 0 || s.to < e.state.doc.length)) {
...
function zi(e, t) {
	...
	if (t.bounds) {
		...
		let l = i.doc.sliceString(e, r, Mi), u, d;
		!a.empty && a.from >= e && a.to <= r && (t.typeOver || l != t.text) && l.slice(0, a.from - e) == t.text.slice(0, a.from - e) && l.slice(a.to - e) == t.text.slice(u = t.text.length - (l.length - (a.to - e))) ? n = {
			from: a.from,
			to: a.to,
			insert: f.of(t.text.slice(a.from - e, u).split(Mi))
		} : (d = Hi(l, t.text, s - e, c)) && (N.chrome && o == 13 && d.toB == d.from + 2 && t.text.slice(d.from, d.toB) == Mi + Mi && d.toB--, n = {
			from: e + d.from,
			to: e + d.toA,
			insert: f.of(t.text.slice(d.from, d.toB).split(Mi))
		});
	} else r && (!e.hasFocus && i.facet(_r) || Gi(r, a)) && (r = null);
	if (!n && !r) return !1;
	...
	if (r && !Gi(r, a)) {
		let t = !1, n = "select";
		return e.inputState.lastSelectionTime > Date.now() - 50 && (e.inputState.lastSelectionOrigin == "select" && (t = !0), n = e.inputState.lastSelectionOrigin, n == "select.pointer" && (r = Di(i.facet(Er).map((t) => t(e)), r))), e.dispatch({
			selection: r,
			scrollIntoView: t,
			userEvent: n
		}), !0;
...
function Vi(e, t, n) {
	...
	if (t.from == t.to && t.from < a.from || t.from > a.to) {
		let n = t.from < a.from ? -1 : 1, r = n < 0 ? a.from : a.to, s = Ei(i.facet(Er).map((t) => t(e)), r, n);
		t.from == s && (o = s);
	}
	if (o > -1) r = {
		changes: t,
		...
		if (i.selection.ranges.length > 1 && (e.inputState.composing >= 0 || e.inputState.compositionPendingChange) && t.to <= a.to + 10 && t.to >= a.to - 10) {
			let c = e.state.sliceDoc(t.from, t.to), l, u = n && li(e, n.main.head);
			if (u) {
...
function Ui(e) {
	...
	return n && (t.push(new Ii(n, r)), (i != n || a != r) && t.push(new Ii(i, a))), t;
}
function Wi(e, t) {
...
var Ki = class {
	...
	keydown(e) {
		...
		if (this.tabFocusMode > 0 && e.keyCode != 27 && Zi.indexOf(e.keyCode) < 0 && (this.tabFocusMode = -1), N.android && N.chrome && !e.synthetic && (e.keyCode == 13 || e.keyCode == 8)) return this.view.observer.delayAndroidKey(e.key, e.keyCode), !0;
		let t;
		return N.ios && !e.synthetic && !e.altKey && !e.metaKey && !e.shiftKey && ((t = Yi.find((t) => t.keyCode == e.keyCode)) && !e.ctrlKey || Xi.indexOf(e.key) > -1 && e.ctrlKey) ? (this.pendingIOSKey = t || e, setTimeout(() => this.flushIOSKey(), 250), !0) : (e.keyCode != 229 && this.view.observer.forceFlush(), !1);
	}
	flushIOSKey(e) {
...
var ta = class {
	constructor(e, t, n, r) {
		this.view = e, this.startEvent = t, this.style = n, this.mustSelect = r, this.scrollSpeed = {
			x: 0,
			y: 0
		}, this.scrolling = -1, this.lastEvent = t, this.scrollParents = Sn(e.contentDOM), this.atoms = e.state.facet(Er).map((t) => t(e));
		let i = e.contentDOM.ownerDocument;
		i.addEventListener("mousemove", this.move = this.move.bind(this)), i.addEventListener("mouseup", this.up = this.up.bind(this)), this.extend = t.shiftKey, this.multiple = e.state.facet(k.allowMultipleSelections) && na(e, t), this.dragging = ia(e, t) && ga(t) == 1 ? null : !1;
	}
	start(e) {
	...
	select(e) {
		let { view: t } = this, n = Di(this.atoms, this.style.get(e, this.extend, this.multiple));
...
var oa = /* @__PURE__ */ Object.create(null), H = /* @__PURE__ */ Object.create(null), sa = N.ie && N.ie_version < 15 || N.ios && N.webkit_version < 604;
function ca(e) {
...
}, oa.keydown = (e, t) => (e.inputState.setSelectionOrigin("select"), t.keyCode == 27 && e.inputState.tabFocusMode != 0 && (e.inputState.tabFocusMode = Date.now() + 2e3), !1), H.touchstart = (e, t) => {
...
function da(e, t, n, r) {
	...
	if (r == 2) return yi(e.state, t, n);
	{
		...
		return o < e.state.doc.length && o == i.to && o++, T.range(a, o);
	}
}
var fa = N.ie && N.ie_version <= 11, pa = null, ma = 0, ha = 0;
function ga(e) {
...
function va(e, t) {
	for (let n = 0; n < e.ranges.length; n++) {
		...
		if (r <= t && i >= t) return T.create(e.ranges.slice(0, n).concat(e.ranges.slice(n + 1)), e.mainIndex == n ? 0 : e.mainIndex - (e.mainIndex > n ? 1 : 0));
	}
	return null;
}
oa.dragstart = (e, t) => {
	...
	if (t.target.draggable) {
		...
		if (r && r.isWidget()) {
			...
			(e >= n.to || t <= n.from) && (n = T.range(e, t));
		}
	}
	let { inputState: r } = e;
	return r.mouseSelection && (r.mouseSelection.dragging = !0), r.draggedContent = n, t.dataTransfer && (t.dataTransfer.setData("Text", la(e.state, ur, e.state.sliceDoc(n.from, n.to))), t.dataTransfer.effectAllowed = "copyMove"), !1;
}, oa.dragend = (e) => (e.inputState.draggedContent = null, !1);
function ya(e, t, n, r) {
	if (n = la(e.state, lr, n), !n) return;
	let i = e.posAtCoords({
		x: t.clientX,
		y: t.clientY
...
function xa(e) {
	...
	return {
		text: la(e, ur, t.join(e.lineBreak)),
		ranges: n,
		linewise: r
	};
}
...
H.focus = (e) => {
	...
	let n;
	if (N.chrome && N.android && (n = Yi.find((e) => e.inputType == t.inputType)) && (e.observer.delayAndroidKey(n.key, n.keyCode), n.key == "Backspace" || n.key == "Delete")) {
...
var ja = class {
	...
	refresh(e, t, n, r, i, a) {
		let o = Oa.indexOf(e) > -1, s = Math.abs(t - this.lineHeight) > .3 || this.lineWrapping != o || Math.abs(n - this.charWidth) > .1;
...
Fa.prototype.size = 1;
var La = /* @__PURE__ */ F.replace({}), Ra = class extends Fa {
	constructor(e, t, n) {
...
var Xa = class {
	...
	draw(e, t) {
		return F.replace({ widget: new Za(this.displaySize * (t ? e.scaleY : e.scaleX), t) }).range(this.from, this.to);
	}
}, Za = class extends en {
	constructor(e, t) {
	...
	constructor(e, t) {
		this.view = e, this.state = t, this.pixelViewport = {
			...
			top: 0,
			bottom: 0
		}, this.inView = !0, this.paddingTop = 0, this.paddingBottom = 0, this.contentDOMWidth = 0, this.contentDOMHeight = 0, this.editorHeight = 0, this.editorWidth = 0, this.scaleX = 1, this.scaleY = 1, this.scrollOffset = 0, this.scrolledToBottom = !1, this.scrollAnchorPos = 0, this.scrollAnchorHeight = -1, this.scaler = io, this.scrollTarget = null, this.printing = !1, this.mustMeasureContent = !0, this.defaultTextDirection = I.LTR, this.visibleRanges = [], this.mustEnforceCursorAssoc = !1, this.heightOracle = new ja(t.facet(Sr).some((e) => typeof e != "function" && e.class == "cm-lineWrapping")), this.stateDeco = ao(t), this.heightMap = Fa.empty().applyChanges(this.stateDeco, f.empty, this.heightOracle.setDoc(t.doc), [new Mr(0, 0, 0, t.doc.length)]);
	...
	update(e, t = null) {
		...
		let r = e.changedRanges, i = Mr.extendWithRanges(r, Ga(n, this.stateDeco, e ? e.changes : ce.empty(this.state.doc.length))), a = this.heightMap.height, o = this.scrolledToBottom ? null : this.scrollAnchorAt(this.scrollOffset);
	...
	measure() {
		...
		if ((this.contentDOMWidth != y || this.editorHeight != e.scrollDOM.clientHeight) && (this.contentDOMWidth = o.width, this.editorHeight = e.scrollDOM.clientHeight, c |= 16), s) {
			...
			for (let n of this.viewports) {
				...
				this.heightMap = (a ? Fa.empty().applyChanges(this.stateDeco, f.empty, this.heightOracle, [new Mr(0, 0, 0, e.state.doc.length)]) : this.heightMap).updateHeight(r, 0, a, new Ma(n.from, i));
			}
			ka && (c |= 2);
		}
	...
	getViewport(e, t) {
		let n = .5 - Math.max(-.5, Math.min(.5, e / 1e3 / 2)), r = this.heightMap, i = this.heightOracle, { visibleTop: a, visibleBottom: o } = this, s = new $a(r.lineAt(a - n * 1e3, U.ByHeight, i, 0, 0).from, r.lineAt(o + (1 - n) * 1e3, U.ByHeight, i, 0, 0).to);
		if (t) {
			let { head: e } = t.range;
			if (e < s.from || e > s.to) {
				let n = Math.min(this.editorHeight, this.pixelViewport.bottom - this.pixelViewport.top), a = r.lineAt(e, U.ByPos, i, 0, 0), o;
				o = t.y == "center" ? (a.top + a.bottom) / 2 - n / 2 : t.y == "start" || t.y == "nearest" && e < s.from ? a.top : a.bottom - n, s = new $a(r.lineAt(o - 1e3 / 2, U.ByHeight, i, 0, 0).from, r.lineAt(o + n + 1e3 / 2, U.ByHeight, i, 0, 0).to);
			}
		}
		return s;
	}
	mapViewport(e, t) {
		...
		return new $a(this.heightMap.lineAt(n, U.ByPos, this.heightOracle, 0, 0).from, this.heightMap.lineAt(r, U.ByPos, this.heightOracle, 0, 0).to);
	}
	...
	updateLineGaps(e) {
		Xa.same(e, this.lineGaps) || (this.lineGaps = e, this.lineGapDeco = F.set(e.map((e) => e.draw(this, this.heightOracle.lineWrapping))));
	}
	...
	lineBlockAt(e) {
		return e >= this.viewport.from && e <= this.viewport.to && this.viewportLines.find((t) => t.from <= e && t.to >= e) || so(this.heightMap.lineAt(e, U.ByPos, this.heightOracle, 0, 0), this.scaler);
	}
	lineBlockAtHeight(e) {
		return e >= this.viewportLines[0].top && e <= this.viewportLines[this.viewportLines.length - 1].bottom && this.viewportLines.find((t) => t.top <= e && t.bottom >= e) || so(this.heightMap.lineAt(this.scaler.fromDOM(e), U.ByHeight, this.heightOracle, 0, 0), this.scaler);
	}
	getScrollOffset() {
...
function ao(e) {
	let t = e.facet(Cr).filter((e) => typeof e != "function"), n = e.facet(Tr).filter((e) => typeof e != "function");
...
var co = /* @__PURE__ */ E.define({ combine: (e) => e.join(" ") }), lo = /* @__PURE__ */ E.define({ combine: (e) => e.indexOf(!0) > -1 }), uo = /* @__PURE__ */ Dt.newName(), fo = /* @__PURE__ */ Dt.newName(), po = /* @__PURE__ */ Dt.newName(), mo = {
	"&light": "." + fo,
	"&dark": "." + po
};
function ho(e, t, n) {
...
var go = /* @__PURE__ */ ho("." + uo, {
...
}, vo = N.ie && N.ie_version <= 11, yo = class {
	constructor(e) {
		...
		}), window.EditContext && N.android && e.constructor.EDIT_CONTEXT !== !1 && !(N.chrome && N.chrome_version < 126) && (this.editContext = new Co(e), e.state.facet(_r) && (e.contentDOM.editContext = this.editContext.editContext)), vo && (this.onCharData = (e) => {
			this.queue.push({
				target: e.target,
				type: "characterData",
	...
	readSelectionRange() {
		...
		if (!t) return !1;
		let n = N.safari && e.root.nodeType == 11 && e.root.activeElement == this.dom && So(this.view, t) || t;
	...
	flush(e = !0) {
		...
		let n = this.view.state, r = zi(this.view, t);
		return this.view.state == n && (t.domChanged || t.newSel && !Gi(this.view.state.selection, t.newSel.main)) && this.view.update([]), r;
	}
	readMutation(e) {
...
var Co = class {
	constructor(e) {
		...
		this.handlers.textupdate = (n) => {
			...
			let l = Hi(e.state.sliceDoc(o, s), n.text, (c ? r.from : r.to) - o, c ? "end" : null);
			if (!l) {
			...
			if ((N.mac || N.android) && u.from == a - 1 && /^\. ?$/.test(n.text) && e.contentDOM.getAttribute("autocorrect") == "off" && (u = {
				...
				Bi(e, u, T.single(this.toEditorPos(n.selectionStart, t), this.toEditorPos(n.selectionEnd, t)));
			}
	...
	constructor(e = {}) {
		...
		let { dispatch: t } = e;
		this.dispatchTransactions = e.dispatchTransactions || t && ((e) => e.forEach((e) => t(e, this))) || ((e) => this.update(e)), this.dispatch = this.dispatch.bind(this), this._root = e.root || kn(e.parent) || document, this.viewState = new Qa(this, e.state || k.create(e)), e.scrollTo && e.scrollTo.is(hr) && (this.viewState.scrollTarget = e.scrollTo.value.clip(this.viewState.state)), this.plugins = this.state.facet(yr).map((e) => new br(e));
		for (let e of this.plugins) e.update(this);
		this.observer = new yo(this), this.inputState = new Ki(this), this.inputState.ensureHandlers(this.plugins), this.docView = new oi(this), this.mountStyles(), this.updateAttrs(), this.updateState = 0, this.requestMeasure(), document.fonts?.ready && document.fonts.ready.then(() => {
	...
	update(t) {
		...
		i = Nr.create(this, a, t), i.flags |= s;
		...
		if (i.startState.facet(co) != i.state.facet(co) && (this.viewState.mustMeasureContent = !0), (n || r || d || this.viewState.mustEnforceCursorAssoc || this.viewState.mustMeasureContent) && this.requestMeasure(), n && this.docViewUpdate(), !i.empty) for (let e of this.state.facet(or)) try {
			e(i);
		} catch (e) {
			R(this.state, e, "update listener");
		}
		(c || u) && Promise.resolve().then(() => {
			c && this.state == c.startState && this.dispatch(c), u && !zi(this, u) && l.force && On(this.contentDOM, l.key, l.keyCode);
		});
	}
	setState(e) {
		...
		try {
			...
			this.viewState = new Qa(this, e), this.plugins = e.facet(yr).map((e) => new br(e)), this.pluginMap.clear();
			for (let e of this.plugins) e.update(this);
			...
			for (let e = 0;; e++) {
				...
				let c = s.map((e) => {
					try {
						...
						return R(this.state, e), To;
					}
				}), l = Nr.create(this, this.state, []), u = !1;
	...
	updateAttrs() {
		let e = Do(this, xr, { class: "cm-editor" + (this.hasFocus ? " cm-focused " : " ") + this.themeClasses }), t = {
			spellcheck: "false",
			autocorrect: "off",
			autocapitalize: "off",
		...
		this.state.readOnly && (t["aria-readonly"] = "true"), Do(this, Sr, t);
	...
	mountStyles() {
		...
		Dt.mount(this.root, this.styleModules.concat(go).reverse(), t ? { nonce: t } : void 0);
	}
	readMeasured() {
	...
	moveByChar(e, t, n) {
		return Oi(this, e, Ci(this, e, t, n));
	}
	moveByGroup(e, t) {
		return Oi(this, e, Ci(this, e, t, (t) => wi(this, e.head, t)));
	}
	visualLineSide(e, t) {
	...
	moveVertically(e, t, n) {
		return Oi(this, e, Ti(this, e, t, n));
	}
	domAtPos(e, t = 1) {
	...
	posAndSideAtCoords(e, t = !0) {
		return this.readMeasured(), Ai(this, e, t);
	}
	coordsAtPos(e, t = 1) {
		this.readMeasured();
		let n = this.docView.coordsAt(e, t);
		if (!n || n.left == n.right) return n;
		let r = this.state.doc.lineAt(e), i = this.bidiSpans(r), a = i[Wn.find(i, e - r.from, -1, t)];
		return vn(n, a.dir == I.LTR == t > 0);
	}
	coordsForChar(e) {
	...
	bidiSpans(e) {
		if (e.length > wo) return Qn(e.length);
		let t = this.textDirectionAt(e.from), n;
		for (let r of this.bidiCache) if (r.from == e.from && r.dir == t && (r.fresh || Gn(r.isolates, n = Or(this, e)))) return r.order;
		n ||= Or(this, e);
		let r = Zn(e.text, t, n);
	...
	static theme(e, t) {
		let n = Dt.newName(), r = [co.of(n), jr.of(ho(`.${n}`, e))];
		return t && t.dark && r.push(lo.of(!0)), r;
	}
	static baseTheme(e) {
		return Ee.lowest(jr.of(ho("." + uo, e, mo)));
	}
...
} }), W.scrollMargins = kr, W.darkTheme = lo, W.cspNonce = /* @__PURE__ */ E.define({ combine: (e) => e.length ? e[0] : "" }), W.contentAttributes = Sr, W.editorAttributes = xr, W.lineWrapping = /* @__PURE__ */ W.contentAttributes.of({ class: "cm-lineWrapping" }), W.announce = /* @__PURE__ */ D.define();
...
var Oo = N.mac ? "mac" : N.windows ? "win" : N.linux ? "linux" : "key";
function ko(e, t) {
...
var jo = /* @__PURE__ */ Ee.default(/* @__PURE__ */ W.domEventHandlers({ keydown(e, t) {
...
function Bo(e, t, n, r) {
	...
	return f && (d(f[o + Ao(i, t, !a)]) ? s = !0 : a && (t.altKey || t.metaKey || t.ctrlKey) && !(N.windows && t.ctrlKey && t.altKey) && !(N.mac && t.altKey && !(t.ctrlKey || t.metaKey)) && (p = At[t.keyCode]) && p != i ? (d(f[o + Ao(p, t, !0)]) || t.shiftKey && (m = jt[t.keyCode]) != i && m != p && d(f[o + Ao(m, t, !1)])) && (s = !0) : a && t.shiftKey && d(f[o + Ao(i, t, !0)]) && (s = !0), !s && d(f._any) && (s = !0)), c && (s = !0), s && l && t.stopPropagation(), zo = null, s;
}
var Vo = class e {
	constructor(e, t, n, r, i) {
...
function Jo(e) {
	return [z.define((t) => new Ko(t, e)), qo.of(e)];
}
...
var $o = /* @__PURE__ */ Jo({
	...
	update(e, t) {
		...
		let n = Qo(e);
		return n && es(e.state, t), e.docChanged || e.selectionSet || n;
	},
	mount(e, t) {
		es(t.state, e);
	},
...
var ts = /* @__PURE__ */ Jo({
	...
	markers(e) {
		...
		if (N.ios && !n.empty && e.state.facet(Yo).iosSelectionHandles) {
	...
	update(e, t) {
		return e.docChanged || e.selectionSet || e.viewportChanged || Qo(e);
	},
	class: "cm-selectionLayer"
}), ns = /* @__PURE__ */ Ee.highest(/* @__PURE__ */ W.theme({
	".cm-line": {
...
})), rs = /* @__PURE__ */ D.define({ map(e, t) {
	return e == null ? null : t.mapPos(e);
} }), is = /* @__PURE__ */ Ce.define({
	create() {
		return null;
	},
	update(e, t) {
		return e != null && (e = t.changes.mapPos(e)), t.effects.reduce((e, t) => t.is(rs) ? t.value : e, e);
	}
}), as = /* @__PURE__ */ z.fromClass(class {
	constructor(e) {
	...
	update(e) {
		var t;
		let n = e.state.field(is);
		n == null ? this.cursor != null && ((t = this.cursor) == null || t.remove(), this.cursor = null) : (this.cursor || (this.cursor = this.view.scrollDOM.appendChild(document.createElement("div")), this.cursor.className = "cm-dropCursor"), (e.startState.field(is) != n || e.docChanged || e.geometryChanged) && this.view.requestMeasure(this.measureReq));
	}
	readPos() {
		let { view: e } = this, t = e.state.field(is), n = t != null && e.coordsAtPos(t);
		if (!n) return null;
	...
	setDropPos(e) {
		this.view.state.field(is) != e && this.view.dispatch({ effects: rs.of(e) });
	}
}, { eventObservers: {
	dragover(e) {
...
var ls = class {
	...
	createDeco(e) {
		...
		for (let { from: t, to: r } of cs(e, this.maxLength)) ss(e.state.doc, this.regexp, t, r, (t, r) => this.addMatch(r, e, t, n));
		return t.finish();
	}
	updateDeco(e, t) {
		let n = 1e9, r = -1;
	...
	updateRange(e, t, n, r) {
		for (let i of e.visibleRanges) {
			...
			if (o >= a) {
				...
				else ss(e.state.doc, this.regexp, s, c, (t, n) => this.addMatch(n, e, t, d));
				t = t.update({
					filterFrom: s,
					filterTo: c,
					filter: (e, t) => e < s || t > c,
...
}, us = /x/.unicode == null ? "g" : "gu", ds = /* @__PURE__ */ RegExp("[\0-\b\n--­؜​‎‏\u2028\u2029‭‮⁦⁧⁩﻿￹-￼]", us), fs = {
	0: "null",
	7: "bell",
	8: "backspace",
	10: "newline",
...
function ms() {
	if (ps == null && typeof document < "u" && document.body) {
		let e = document.body.style;
		ps = (e.tabSize ?? e.MozTabSize) != null;
	}
	return ps || !1;
}
var hs = /* @__PURE__ */ E.define({ combine(e) {
	...
	return (t.replaceTabs = !ms()) && (t.specialChars = RegExp("	|" + t.specialChars.source, us)), t.addSpecialChars && (t.specialChars = RegExp(t.specialChars.source + "|" + t.addSpecialChars.source, us)), t;
} });
function gs(e = {}) {
	return [hs.of(e), vs()];
}
var _s = null;
function vs() {
	return _s ||= z.fromClass(class {
		constructor(e) {
			this.view = e, this.decorations = F.none, this.decorationCache = Object.create(null), this.decorator = this.makeDecorator(e.state.facet(hs)), this.decorations = this.decorator.createDeco(e);
		}
		makeDecorator(e) {
			return new ls({
				...
				decoration: (t, n, r) => {
					...
					if (a == 9) {
						...
						return F.replace({ widget: new Ss((t - a % t) * this.view.defaultCharacterWidth / this.view.scaleX) });
					}
					return this.decorationCache[a] || (this.decorationCache[a] = F.replace({ widget: new xs(e, a) }));
				},
		...
		update(e) {
			...
			e.startState.facet(hs) == t ? this.decorations = this.decorator.updateDeco(e, this.decorations) : (this.decorator = this.makeDecorator(t), this.decorations = this.decorator.createDeco(e.view));
		}
	}, { decorations: (e) => e.decorations });
}
var ys = "•";
function bs(e) {
	return e >= 32 ? ys : e == 10 ? "␤" : String.fromCharCode(9216 + e);
}
var xs = class extends en {
	constructor(e, t) {
	...
	toDOM(e) {
		let t = bs(this.code), n = e.state.phrase("Control character") + " " + (fs[this.code] || "0x" + this.code.toString(16)), r = this.options.render && this.options.render(this.code, n, t);
		if (r) return r;
...
var ws = /* @__PURE__ */ F.line({ class: "cm-activeLine" }), Ts = /* @__PURE__ */ z.fromClass(class {
	constructor(e) {
	...
	getDeco(e) {
		...
		for (let r of e.state.selection.ranges) {
			...
			i.from > t && (n.push(ws.range(i.from)), t = i.from);
		}
		return F.set(n);
	}
}, { decorations: (e) => e.decorations }), Es = 2e3;
function Ds(e, t, n) {
	let r = Math.min(t.line, n.line), i = Math.max(t.line, n.line), a = [];
	if (t.off > Es || n.off > Es || t.col < 0 || n.col < 0) {
...
function ks(e, t) {
	let n = e.posAtCoords({
		x: t.clientX,
		y: t.clientY
	}, !1), r = e.state.doc.lineAt(n), i = n - r.from, a = i > Es ? -1 : i == r.length ? Os(e, t.clientX) : xt(r.text, e.state.tabSize, n - r.from);
	return {
		line: r.number,
		col: a,
		off: i
...
function As(e, t) {
	let n = ks(e, t), r = e.state.selection;
	return n ? {
		update(e) {
			if (e.docChanged) {
...
function js(e) {
	...
	return W.mouseSelectionStyle.of((e, n) => t(n) ? As(e, n) : null);
}
var Ms = {
	Alt: [18, (e) => !!e.altKey],
...
function Ps(e = {}) {
	let [t, n] = Ms[e.key || "Alt"], r = z.fromClass(class {
		constructor(e) {
	...
	return [r, W.contentAttributes.of((e) => e.plugin(r)?.isDown ? Ns : null)];
}
var Fs = "-10000px", Is = class {
	constructor(e, t, n, r) {
...
var Rs = /* @__PURE__ */ E.define({ combine: (e) => ({
	position: N.ios ? "absolute" : e.find((e) => e.position)?.position || "fixed",
	parent: e.find((e) => e.parent)?.parent || null,
	tooltipSpace: e.find((e) => e.tooltipSpace)?.tooltipSpace || Ls
}) }), zs = /* @__PURE__ */ new WeakMap(), Bs = /* @__PURE__ */ z.fromClass(class {
	constructor(e) {
		...
		this.position = t.position, this.parent = t.parent, this.classes = e.themeClasses, this.createContainer(), this.measureReq = {
			...
			key: this
		}, this.resizeObserver = typeof ResizeObserver == "function" ? new ResizeObserver(() => this.measureSoon()) : null, this.manager = new Is(e, Ws, (e, t) => this.createTooltip(e, t), (e) => {
	...
	update(e) {
		...
		let n = t || e.geometryChanged, r = e.state.facet(Rs);
	...
	createTooltip(e, t) {
		...
		return n.dom.style.position = this.position, n.dom.style.top = Fs, n.dom.style.left = "0px", this.container.insertBefore(n.dom, r), n.mount && n.mount(this.view), this.resizeObserver && this.resizeObserver.observe(n.dom), n;
	}
	destroy() {
		var e, t, n;
	...
	readMeasure() {
		...
		let r = this.view.scrollDOM.getBoundingClientRect(), i = Ar(this.view);
		return {
			visible: {
				left: r.left + i.left,
				top: r.top + i.top,
	...
	writeMeasure(e) {
		...
		for (let o = 0; o < this.manager.tooltips.length; o++) {
			...
			let f = s.arrow ? c.dom.querySelector(".cm-tooltip-arrow") : null, p = f ? 7 : 0, m = d.right - d.left, h = zs.get(c) ?? d.bottom - d.top, g = c.offset || Us, _ = this.view.textDirection == I.LTR, v = d.width > n.right - n.left ? _ ? n.left : n.right - d.width : _ ? Math.max(n.left, Math.min(u.left - (f ? 14 : 0) + g.x, n.right - m)) : Math.min(Math.max(n.left, u.left - m + (f ? 14 : 0) - g.x), n.right - m), y = this.above[o];
			...
			if (ee < h && c.resize !== !1) {
				...
				zs.set(c, h), l.style.height = (h = ee) / i + "px";
			...
			if (this.position == "absolute" ? (l.style.top = (b - e.parent.top) / i + "px", Vs(l, (v - e.parent.left) / r)) : (l.style.top = b / i + "px", Vs(l, v / r)), f) {
	...
	maybeMeasure() {
		if (this.manager.tooltips.length && (this.view.inView && this.view.requestMeasure(this.measureReq), this.inView != this.view.inView && (this.inView = this.view.inView, !this.inView))) for (let e of this.manager.tooltipViews) e.dom.style.top = Fs;
	}
...
var Hs = /* @__PURE__ */ W.baseTheme({
	...
	x: 0,
	y: 0
}, Ws = /* @__PURE__ */ E.define({ enables: [Bs, Hs] }), Gs = /* @__PURE__ */ E.define({ combine: (e) => e.reduce((e, t) => e.concat(t), []) }), Ks = class e {
	static create(t) {
		return new e(t);
	}
	constructor(e) {
		this.view = e, this.mounted = !1, this.dom = document.createElement("div"), this.dom.classList.add("cm-tooltip-hover"), this.manager = new Is(e, Gs, (e, t) => this.createHostedView(e, t), (e) => e.dom.remove());
	}
	...
	constructor(e, t, n, r, i) {
		this.view = e, this.source = t, this.field = n, this.setHover = r, this.hoverTime = i, this.hoverTimeout = -1, this.restartTimeout = -1, this.pending = null, this.lastMove = {
			x: 0,
			y: 0,
			target: e.dom,
			time: 0
	...
	startHover() {
		...
		if (a?.then) {
			...
			a.then((n) => {
				this.pending == t && (this.pending = null, n && !(Array.isArray(n) && !n.length) && e.dispatch({ effects: this.setHover.of(Array.isArray(n) ? n : [n]) }));
			}, (t) => R(e.state, t, "hover tooltip"));
		} else a && !(Array.isArray(a) && !a.length) && e.dispatch({ effects: this.setHover.of(Array.isArray(a) ? a : [a]) });
	}
	get tooltip() {
		let e = this.view.plugin(Bs), t = e ? e.manager.tooltips.findIndex((e) => e.create == Ks.create) : -1;
	...
	mousemove(e) {
		...
		if (t.length && n && !Xs(n.dom, e) || this.pending) {
...
function Qs(e, t = {}) {
	let n = D.define(), r = Ce.define({
		create() {
			return [];
		},
		update(e, r) {
			if (e.length && (t.hideOnChange && (r.docChanged || r.selection) ? e = [] : t.hideOn && (e = e.filter((e) => !t.hideOn(r, e))), r.docChanged)) {
				let t = [];
				for (let n of e) {
					let e = r.changes.mapPos(n.pos, -1, C.TrackDel);
					if (e != null) {
						let i = Object.assign(Object.create(null), n);
						i.pos = e, i.end != null && (i.end = r.changes.mapPos(i.end)), t.push(i);
					}
				}
				e = t;
			}
			for (let t of r.effects) t.is(n) && (e = t.value), t.is(ec) && (e = []);
			return e;
		},
		provide: (e) => Gs.from(e)
	});
	return {
		...
		extension: [
			r,
			z.define((i) => new Js(i, e, r, n, t.hoverTime || 300)),
			qs
		]
	};
}
...
var ec = /* @__PURE__ */ D.define(), tc = /* @__PURE__ */ E.define({ combine(e) {
	let t, n;
...
function nc(e, t) {
	let n = e.plugin(rc), r = n ? n.specs.indexOf(t) : -1;
	return r > -1 ? n.panels[r] : null;
}
var rc = /* @__PURE__ */ z.fromClass(class {
	constructor(e) {
		this.input = e.state.facet(oc), this.specs = this.input.filter((e) => e), this.panels = this.specs.map((t) => t(e));
		let t = e.state.facet(tc);
		this.top = new ic(e, !0, t.topContainer), this.bottom = new ic(e, !1, t.bottomContainer), this.top.sync(this.panels.filter((e) => e.top)), this.bottom.sync(this.panels.filter((e) => !e.top));
		for (let e of this.panels) e.dom.classList.add("cm-panel"), e.mount && e.mount();
	}
	update(e) {
		let t = e.state.facet(tc);
		this.top.container != t.topContainer && (this.top.sync([]), this.top = new ic(e.view, !0, t.topContainer)), this.bottom.container != t.bottomContainer && (this.bottom.sync([]), this.bottom = new ic(e.view, !1, t.bottomContainer)), this.top.syncClasses(), this.bottom.syncClasses();
		let n = e.state.facet(oc);
		if (n != this.input) {
...
var oc = /* @__PURE__ */ E.define({ enables: rc });
function sc(e, t) {
	let n, r = new Promise((e) => n = e), i = (e) => dc(e, t, n);
	e.state.field(cc, !1) ? e.dispatch({ effects: lc.of(i) }) : e.dispatch({ effects: D.appendConfig.of(cc.init(() => [i])) });
	let a = uc.of(i);
	return {
		close: a,
		result: r.then((t) => ((e.win.queueMicrotask || ((t) => e.win.setTimeout(t, 10)))(() => {
			e.state.field(cc).indexOf(i) > -1 && e.dispatch({ effects: a });
		}), t))
	};
}
var cc = /* @__PURE__ */ Ce.define({
	create() {
		return [];
	},
	update(e, t) {
		for (let n of t.effects) n.is(lc) ? e = [n.value].concat(e) : n.is(uc) && (e = e.filter((e) => e != n.value));
		return e;
	},
	provide: (e) => oc.computeN([e], (t) => t.field(e))
}), lc = /* @__PURE__ */ D.define(), uc = /* @__PURE__ */ D.define();
function dc(e, t, n) {
...
fc.prototype.elementClass = "", fc.prototype.toDOM = void 0, fc.prototype.mapMode = C.TrackBefore, fc.prototype.startSide = fc.prototype.endSide = -1, fc.prototype.point = !0;
var pc = /* @__PURE__ */ E.define(), mc = /* @__PURE__ */ E.define(), hc = {
	class: "",
...
var vc = /* @__PURE__ */ E.define({ combine: (e) => e.some((e) => e) });
function yc(e) {
	let t = [bc];
	return e && e.fixed === !1 && t.push(vc.of(!0)), t;
}
var bc = /* @__PURE__ */ z.fromClass(class {
	constructor(e) {
		this.view = e, this.domAfter = null, this.prevViewport = e.viewport, this.dom = document.createElement("div"), this.dom.className = "cm-gutters cm-gutters-before", this.dom.setAttribute("aria-hidden", "true"), this.dom.style.minHeight = this.view.contentHeight / this.view.scaleY + "px", this.gutters = e.state.facet(gc).map((t) => new wc(e, t)), this.fixed = !e.state.facet(vc);
	...
	update(e) {
		...
		this.view.state.facet(vc) != !this.fixed && (this.fixed = !this.fixed, this.dom.style.position = this.fixed ? "sticky" : "", this.domAfter && (this.domAfter.style.position = this.fixed ? "sticky" : "")), this.prevViewport = e.view.viewport;
	}
	syncGutters(e) {
		let t = this.dom.nextSibling;
		e && (this.dom.remove(), this.domAfter && this.domAfter.remove());
		let n = A.iter(this.view.state.facet(pc), this.view.viewport.from), r = [], i = this.gutters.map((e) => new Cc(e, this.view.viewport, -this.view.documentPadding.top));
	...
	updateGutters(e) {
		let t = e.startState.facet(gc), n = e.state.facet(gc), r = e.docChanged || e.heightChanged || e.viewportChanged || !A.eq(e.startState.facet(pc), e.state.facet(pc), e.view.viewport.from, e.view.viewport.to);
...
var Cc = class {
	...
	line(e, t, n) {
		let r = [];
		Sc(this.cursor, r, t.from), n.length && (r = r.concat(n));
	...
	constructor(e, t) {
		...
		this.markers = xc(t.markers(e)), t.initialSpacer && (this.spacer = new Tc(e, 0, 0, [t.initialSpacer(e)]), this.dom.appendChild(this.spacer.dom), this.spacer.dom.style.cssText += "visibility: hidden; pointer-events: none");
	}
	update(e) {
		let t = this.markers;
	...
	update(e, t, n, r) {
		this.height != t && (this.height = t, this.dom.style.height = t + "px"), this.above != n && (this.dom.style.marginTop = (this.above = n) ? n + "px" : ""), Ec(this.markers, r) || this.setMarkers(e, r);
	}
	setMarkers(e, t) {
...
var Dc = /* @__PURE__ */ E.define(), Oc = /* @__PURE__ */ E.define(), kc = /* @__PURE__ */ E.define({ combine(e) {
	return rt(e, {
		formatNumber: String,
		domEventHandlers: {}
...
function jc(e, t) {
	return e.state.facet(kc).formatNumber(t, e.state);
}
var Mc = /* @__PURE__ */ gc.compute([kc], (e) => ({
	...
	lineMarker(e, t, n) {
		return n.some((e) => e.toDOM) ? null : new Ac(jc(e, e.state.doc.lineAt(t.from).number));
	},
	widgetMarker: (e, t, n) => {
		for (let r of e.state.facet(Oc)) {
			let i = r(e, t, n);
			if (i) return i;
		}
		return null;
	},
	lineMarkerChange: (e) => e.startState.facet(kc) != e.state.facet(kc),
	initialSpacer(e) {
		return new Ac(jc(e, Pc(e.state.doc.lines)));
	},
	updateSpacer(e, t) {
		let n = jc(t.view, Pc(t.view.state.doc.lines));
		return n == e.number ? e : new Ac(n);
	},
	domEventHandlers: e.facet(kc).domEventHandlers,
	side: "before"
}));
function Nc(e = {}) {
	return [
...
var Fc = /* @__PURE__ */ new class extends fc {
	constructor() {
		super(...arguments), this.elementClass = "cm-activeLineGutter";
	}
}(), Ic = /* @__PURE__ */ pc.compute(["selection"], (e) => {
	let t = [], n = -1;
	for (let r of e.selection.ranges) {
		let i = e.doc.lineAt(r.head).from;
		i > n && (n = i, t.push(Fc.range(i)));
	}
	return A.of(t);
});
function Lc() {
...
var Rc = 1024, zc = 0, G = class {
	constructor(e, t) {
		this.from = e, this.to = t;
	}
}, K = class {
	constructor(e = {}) {
		this.id = zc++, this.perNode = !!e.perNode, this.deserialize = e.deserialize || (() => {
...
}, Vc = Object.create(null), q = class e {
	constructor(e, t, n, r = 0) {
		this.name = e, this.props = t, this.id = n, this.flags = r;
	}
	static define(t) {
		let n = t.props && t.props.length ? Object.create(null) : Vc, r = (t.top ? 1 : 0) | (t.skipped ? 2 : 0) | (t.error ? 4 : 0) | (t.name == null ? 8 : 0), i = new e(t.name || "", n, t.id, r);
		if (t.props) {
...
}, Uc = /* @__PURE__ */ new WeakMap(), Wc = /* @__PURE__ */ new WeakMap(), J;
(function(e) {
...
var Y = class e {
	...
	cursorAt(e, t = 0, n = 0) {
		let r = new il(Uc.get(this) || this.topNode);
		return r.moveTo(e, t), Uc.set(this, r._tree), r;
	}
	get topNode() {
		return new Xc(this, 0, 0, null);
	}
	resolve(e, t = 0) {
		let n = Jc(Uc.get(this) || this.topNode, e, t, !1);
		return Uc.set(this, n), n;
	}
	resolveInner(e, t = 0) {
		let n = Jc(Wc.get(this) || this.topNode, e, t, !0);
		return Wc.set(this, n), n;
	}
	resolveStack(e, t = 0) {
		return rl(this, e, t);
	}
	...
	balance(t = {}) {
		return this.children.length <= 8 ? this : ll(q.none, this.children, this.positions, 0, this.children.length, 0, this.length, (t, n, r) => new e(this.type, t, n, r, this.propValues), t.makeTree || ((t, n, r) => new e(q.none, t, n, r)));
	}
	static build(e) {
		return ol(e);
	}
...
var Gc = class e {
	...
	findChild(e, t, n, r, i) {
		...
		for (let s = e; s != t && !(qc(i, r, a[s + 1], a[s + 2]) && (o = s, n > 0)); s = a[s + 3]);
		return o;
	}
	slice(t, n, r) {
...
function Jc(e, t, n, r) {
	for (; e.from == e.to || (n < 1 ? e.from >= t : e.from > t) || (n > -1 ? e.to <= t : e.to < t);) {
		let t = !r && e instanceof Xc && e.index < 0 ? null : e.parent;
		if (!t) return e;
		e = t;
	}
	let i = r ? 0 : J.IgnoreOverlays;
	if (r) for (let r = e, a = r.parent; a; r = a, a = r.parent) r instanceof Xc && r.index < 0 && a.enter(t, n, i)?.from != r.from && (e = a);
	for (;;) {
		let r = e.enter(t, n, i);
		if (!r) return e;
		e = r;
...
var Yc = class {
	...
	getChildren(e, t = null, n = null) {
		return Zc(this, e, t, n);
	}
	resolve(e, t = 0) {
		return Jc(this, e, t, !1);
	}
	resolveInner(e, t = 0) {
		return Jc(this, e, t, !0);
	}
	matchContext(e) {
		return Qc(this.parent, e);
	}
	...
	nextChild(t, n, r, i, a = 0) {
		for (let o = this;;) {
			for (let { children: s, positions: c } = o._tree, l = n > 0 ? s.length : -1; t != l; t += n) {
				...
				if (!(!(a & J.EnterBracketed && l instanceof Y && (d = Bc.get(l)) && !d.overlay && d.bracketed && r >= u && r <= u + l.length) && !qc(i, r, u, u + l.length))) {
					if (l instanceof Kc) {
						if (a & J.ExcludeBuffers) continue;
						let e = l.findChild(0, l.buffer.length, n, r - u, i);
						if (e > -1) return new el(new $c(o, l, t, u), null, e);
					} else if (a & J.IncludeAnonymous || !l.type.isAnonymous || al(l)) {
						let s;
						if (!(a & J.IgnoreMounts) && (s = Bc.get(l)) && !s.overlay) return new e(s.tree, u, t, o);
						let c = new e(l, u, t, o);
	...
	enter(t, n, r = 0) {
		let i;
		if (!(r & J.IgnoreOverlays) && (i = Bc.get(this._tree)) && i.overlay) {
...
function tl(e) {
	...
	let r = n instanceof Xc && n.index < 0 ? null : n.parent, i = e.slice();
	return r ? i[t] = r : i.splice(t, 1), new nl(i, n);
}
var nl = class {
	constructor(e, t) {
	...
	get next() {
		return tl(this.heads);
	}
};
function rl(e, t, n) {
	let r = e.resolveInner(t, n), i = null;
	for (let e = r instanceof Xc ? r : r.context.parent; e; e = e.parent) if (e.index < 0) {
		let a = e.parent;
		(i ||= [r]).push(a.resolve(t, n)), e = a;
	} else {
		let a = Bc.get(e.tree);
		if (a && a.overlay && a.overlay[0].from <= t && a.overlay[a.overlay.length - 1].to >= t) {
			let o = new Xc(a.tree, a.overlay[0].from + e.from, -1, e);
			(i ||= [r]).push(Jc(o, t, n, !1));
		}
	}
	return i ? tl(i) : r;
...
var il = class {
	...
	constructor(e, t = 0) {
		if (this.buffer = null, this.stack = [], this.index = 0, this.bufferNode = null, this.mode = t & ~J.EnterBracketed, e instanceof Xc) this.yieldNode(e);
		else {
	...
	yield(e) {
		return e ? e instanceof Xc ? (this.buffer = null, this.yieldNode(e)) : (this.buffer = e.context, this.yieldBuf(e.index, e.type)) : !1;
	}
	toString() {
	...
	atLastNode(e) {
		...
		for (; n; {index: t, _parent: n} = n) if (t > -1) for (let r = t + e, i = e < 0 ? -1 : n._tree.children.length; r != i; r += e) {
			...
			if (this.mode & J.IncludeAnonymous || e instanceof Kc || !e.type.isAnonymous || al(e)) return !1;
		}
		return !0;
	}
	move(e, t) {
	...
	get node() {
		...
		for (let e = n; e < this.stack.length; e++) t = new el(this.buffer, t, this.stack[e]);
		return this.bufferNode = new el(this.buffer, t, this.index);
	}
	get tree() {
	...
	matchContext(e) {
		if (!this.buffer) return Qc(this.node.parent, e);
		let { buffer: t } = this.buffer, { types: n } = t.set;
		for (let r = e.length - 1, i = this.stack.length - 1; r >= 0; i--) {
			if (i < 0) return Qc(this._tree, e, r);
...
function al(e) {
	return e.children.some((e) => e instanceof Kc || !e.type.isAnonymous || al(e));
}
function ol(e) {
	let { buffer: t, nodeSet: n, maxBufferLength: r = Rc, reused: i = [], minRepeatType: a = n.types.length } = e, o = Array.isArray(t) ? new Gc(t, t.length) : t, s = n.types, c = 0, l = 0;
	function u(e, t, _, v, y, ee) {
		...
		if (S - x <= r && (oe = h(o.pos - t, y))) {
			...
			ae = new Kc(t, S - oe.start, n), C = oe.start - e;
		} else {
			let e = o.pos - te;
			o.next();
			...
			if (i >= 0 && s > 0 && s < t.length && p(t, n, x, s, x, c, i, ne, re), t.reverse(), n.reverse(), i > -1 && s > 0) {
				let e = f(ie, re);
				ae = ll(ie, t, n, 0, t.length, 0, S - x, e, e);
	...
	function d(e, t, i, a) {
		...
		if (c) {
			...
			i.push(new Kc(t, s[2] - r, n)), a.push(r - e);
		}
	}
	function f(e, t) {
		return (n, r, i) => {
...
function cl(e, t) {
	if (!e.isAnonymous || t instanceof Kc || t.type != e) return 1;
	let n = sl.get(t);
	if (n == null) {
		n = 1;
...
function ll(e, t, n, r, i, a, o, s, c) {
	let l = 0;
	for (let n = r; n < i; n++) l += cl(e, t[n]);
	let u = Math.ceil(l * 1.5 / 8), d = [], f = [];
	function p(t, n, r, i, o) {
		for (let s = r; s < i;) {
			let r = s, l = n[s], m = cl(e, t[s]);
			for (s++; s < i; s++) {
				let n = cl(e, t[s]);
				if (m + n >= u) break;
				m += n;
...
var ul = class {
	...
	set(e, t) {
		e instanceof el ? this.setBuffer(e.context.buffer, e.index, t) : e instanceof Xc && this.map.set(e.tree, t);
	}
	get(e) {
		return e instanceof el ? this.getBuffer(e.context.buffer, e.index) : e instanceof Xc ? this.map.get(e.tree) : void 0;
	}
	cursorSet(e, t) {
	...
	constructor(e, t, n, r, i = !1, a = !1) {
		this.from = e, this.to = t, this.tree = n, this.offset = r, this.open = (i ? 1 : 0) | (a ? 2 : 0);
	}
	get openStart() {
	...
	startParse(e, t, n) {
		return typeof e == "string" && (e = new pl(e)), n = n ? n.length ? n.map((e) => new G(e.from, e.to)) : [new G(0, 0)] : [new G(0, e.length)], this.createParse(e, t || [], n);
	}
	parse(e, t, n) {
...
function ml(e) {
	return (t, n, r, i) => new yl(t, e, n, r, i);
}
var hl = class {
	constructor(e, t, n, r, i, a) {
...
var _l = class {
	...
	advance() {
		...
		if (this.innerDone == this.inner.length) {
			let e = this.baseTree;
			return this.stoppedAt != null && (e = new Y(e.type, e.children, e.positions, e.length, e.propValues.concat([[vl, this.stoppedAt]]))), e;
		}
		let e = this.inner[this.innerDone], t = e.parse.advance();
		if (t) {
			this.innerDone++;
			let n = Object.assign(Object.create(null), e.target.props);
			n[K.mounted.id] = new Bc(t, e.overlay, e.parser, e.bracketed), e.target.props = n;
		}
		return null;
	}
	get parsedPos() {
	...
	startInner() {
		let e = new wl(this.fragments), t = null, n = null, r = new il(new Xc(this.baseTree, this.ranges[0].from, 0, null), J.IncludeAnonymous | J.IgnoreMounts);
		scan: for (let i, a;;) {
			let o = !0, s;
			if (this.stoppedAt != null && r.from >= this.stoppedAt) o = !1;
				...
				o = !1;
			} else if (n && (a = bl(n.ranges, r.from, r.to))) o = a != 2;
				...
				if (typeof i.overlay == "function") t = new _l(i.parser, i.overlay, a, this.inner.length, r.from, !!i.bracketed, r.tree, t);
				else {
					let e = Tl(this.ranges, i.overlay || (r.from < r.to ? [new G(r.from, r.to)] : []));
					e.length && gl(e), (e.length || !i.overlay) && this.inner.push(new hl(i.parser, e.length ? i.parser.startParse(this.input, Dl(a, e), e) : i.parser.startParse(""), i.overlay ? i.overlay.map((e) => new G(e.from - r.from, e.to - r.from)) : null, !!i.bracketed, r.tree, e.length ? e[0].from : r.from)), i.overlay ? e.length && (n = {
						ranges: e,
						depth: 0,
						prev: n
					}) : o = !1;
			...
			if (o && r.firstChild()) t && t.depth++, n && n.depth++;
				...
				if (t && !--t.depth) {
					let e = Tl(this.ranges, t.ranges);
					e.length && (gl(e), this.inner.splice(t.index, 0, new hl(t.parser, t.parser.startParse(this.input, Dl(t.mounts, e), e), t.ranges.map((e) => new G(e.from - t.start, e.to - t.start)), t.bracketed, t.target, e[0].from))), t = t.prev;
				}
				n && !--n.depth && (n = n.prev);
			}
		}
...
var Cl = class {
	...
	moveTo(e) {
		...
		for (; !this.done && t.from < n;) t.to >= e && t.enter(n, 1, J.IgnoreOverlays | J.ExcludeBuffers) || t.next(!1) || (this.done = !0);
	}
	hasNode(e) {
	...
	constructor(e) {
		if (this.fragments = e, this.curTo = 0, this.fragI = 0, e.length) {
			...
			this.curTo = t.tree.prop(vl) ?? t.to, this.inner = new Cl(t.tree, -t.offset);
	...
	nextFrag() {
		if (this.fragI++, this.fragI == this.fragments.length) this.curFrag = this.inner = null;
			...
			this.curTo = e.tree.prop(vl) ?? e.to, this.inner = new Cl(e.tree, -e.offset);
		}
	}
	findMounts(e, t) {
		let n = [];
...
function Dl(e, t) {
	...
	for (let { pos: r, mount: i, frag: a } of e) {
		...
		if (i.overlay) {
			let o = El(t, i.overlay.map((e) => new G(e.from + r, e.to + r)), s, c);
			for (let t = 0, r = s;; t++) {
				let s = t == o.length, l = s ? c : o[t].from;
				if (l > r && n.push(new dl(r, l, i.tree, -e, a.from >= r || a.openStart, a.to <= l || a.openEnd)), s) break;
				r = o[t].to;
			}
		} else n.push(new dl(s, c, i.tree, -e, a.from >= e || a.openStart, a.to <= o || a.openEnd));
	}
	return n;
}
//#endregion
...
var Ol = 0, kl = class e {
	constructor(e, t, n, r) {
		this.name = e, this.set = t, this.base = n, this.modified = r, this.id = Ol++;
	}
	toString() {
		let { name: e } = this;
	...
	static defineModifier(e) {
		let t = new jl(e);
		return (e) => e.modified.indexOf(t) > -1 ? e : jl.get(e.base || e, e.modified.concat(t).sort((e, t) => e.id - t.id));
	}
}, Al = 0, jl = class e {
	constructor(e) {
		this.name = e, this.instances = [], this.id = Al++;
	}
	static get(t, n) {
		if (!n.length) return t;
		let r = n[0].instances.find((e) => e.base == t && Ml(n, e.modified));
		if (r) return r;
		let i = [], a = new kl(t.name, i, t, n);
...
function Pl(e) {
	...
	for (let n in e) {
		...
		for (let e of n.split(" ")) if (e) {
			...
			t[s] = new Il(r, i, o > 0 ? n.slice(0, o) : null).sort(t[s]);
		}
	}
	return Fl.add(t);
}
var Fl = new K({ combine(e, t) {
	let n, r, i;
	for (; e || t;) {
		if (!e || t && e.depth >= t.depth ? (i = t, t = t.next) : (i = e, e = e.next), n && n.mode == i.mode && !i.context && !n.context) continue;
		let a = new Il(i.tags, i.mode, i.context);
		n ? n.next = a : r = a, n = a;
	}
	return r;
} }), Il = class {
...
function zl(e, t, n, r = 0, i = e.length) {
	let a = new Bl(r, Array.isArray(t) ? t : [t], n);
...
var Bl = class {
	...
	highlightRange(e, t, n, r, i) {
		...
		let c = r, l = Vl(e) || Il.empty, u = Rl(i, l.tags);
...
function Vl(e) {
	let t = e.type.prop(Fl);
	for (; t && t.context && !e.matchContext(t.context);) t = t.next;
	return t || null;
}
var X = kl.define, Hl = X(), Ul = X(), Wl = X(Ul), Gl = X(Ul), Kl = X(), ql = X(Kl), Jl = X(Kl), Yl = X(), Xl = X(Yl), Zl = X(), Ql = X(), $l = X(), eu = X($l), tu = X(), Z = {
	comment: Hl,
	lineComment: X(Hl),
	blockComment: X(Hl),
	docComment: X(Hl),
	...
	unit: X(Zl),
	modifier: X(Zl),
	operatorKeyword: X(Zl),
	controlKeyword: X(Zl),
	definitionKeyword: X(Zl),
	moduleKeyword: X(Zl),
	operator: Ql,
	derefOperator: X(Ql),
	arithmeticOperator: X(Ql),
	logicOperator: X(Ql),
	bitwiseOperator: X(Ql),
	compareOperator: X(Ql),
	updateOperator: X(Ql),
	definitionOperator: X(Ql),
	typeOperator: X(Ql),
	controlOperator: X(Ql),
	punctuation: $l,
	separator: X($l),
	bracket: eu,
	angleBracket: X(eu),
	...
	documentMeta: X(tu),
	annotation: X(tu),
	processingInstruction: X(tu),
	definition: kl.defineModifier("definition"),
	constant: kl.defineModifier("constant"),
	function: kl.defineModifier("function"),
	standard: kl.defineModifier("standard"),
	local: kl.defineModifier("local"),
	special: kl.defineModifier("special")
};
for (let e in Z) {
	let t = Z[e];
	t instanceof kl && (t.name = e);
}
Ll([
	{
		tag: Z.link,
...
var nu = /* @__PURE__ */ new K();
function ru(e) {
	return E.define({ combine: e ? (t) => t.concat(e) : void 0 });
}
var iu = /* @__PURE__ */ new K(), Q = class {
	constructor(e, t, n = [], r = "") {
		this.data = e, this.name = r, k.prototype.hasOwnProperty("tree") || Object.defineProperty(k.prototype, "tree", { get() {
			return su(this);
		} }), this.parser = t, this.extension = [_u.of(this), k.languageData.of((e, t, n) => {
			let r = au(e, t, n), i = r.type.prop(nu);
			if (!i) return [];
			let a = e.facet(i), o = r.type.prop(iu);
			if (o) {
	...
	isActiveAt(e, t, n = -1) {
		return au(e, t, n).type.prop(nu) == this.data;
	}
	findRegions(e) {
		let t = e.facet(_u);
...
function au(e, t, n) {
	let r = e.facet(_u), i = su(e).topNode;
	if (!r || r.allowsNesting) for (let e = i; e; e = e.enter(t, n, J.ExcludeBuffers | J.EnterBracketed)) e.type.isTop && (i = e);
	return i;
}
var ou = class e extends Q {
	constructor(e, t, n) {
		super(e, t, [], n), this.parser = t;
	}
	static define(t) {
		let n = ru(t.languageData);
		return new e(n, t.parser.configure({ props: [nu.add((e) => e.isTop ? n : void 0)] }), t.name);
	}
	configure(t, n) {
...
var lu = class {
	...
	work(e, t) {
		return t != null && t >= this.state.doc.length && (t = void 0), this.tree != Y.empty && this.isDone(t ?? this.state.doc.length) ? (this.takeTree(), !0) : this.withContext(() => {
			...
			for (this.parse ||= this.startParse(), t != null && (this.parse.stoppedAt == null || this.parse.stoppedAt > t) && t < this.state.doc.length && this.parse.stopAt(t);;) {
				...
				if (n) if (this.fragments = this.withoutTempSkipped(dl.addTree(n, this.fragments, this.parse.stoppedAt != null)), this.treeLen = this.parse.stoppedAt ?? this.state.doc.length, this.tree = n, this.parse = null, this.treeLen < (t ?? this.state.doc.length)) this.parse = this.startParse();
				else return !0;
				if (e()) return !1;
			}
		});
	...
	takeTree() {
		...
		}), this.treeLen = e, this.tree = t, this.fragments = this.withoutTempSkipped(dl.addTree(this.tree, this.fragments, !0)), this.parse = null);
	}
	withContext(e) {
		let t = uu;
		uu = this;
	...
	withoutTempSkipped(e) {
		for (let t; t = this.tempSkipped.pop();) e = fu(e, t.from, t.to);
		return e;
	}
	changes(t, n) {
		...
		if (this.takeTree(), !t.empty) {
			...
			if (t.iterChangedRanges((t, n, r, i) => e.push({
				...
				fromB: r,
				toB: i
			})), r = dl.applyChanges(r, e), i = Y.empty, a = 0, o = {
	...
	updateViewport(e) {
		...
		for (let t = 0; t < this.skipped.length; t++) {
			...
			n < e.to && r > e.from && (this.fragments = fu(this.fragments, n, r), this.skipped.splice(t--, 1));
		}
...
var pu = class e {
	...
	static init(t) {
		let n = Math.min(3e3, t.doc.length), r = du.create(t.facet(_u).parser, t, {
			from: 0,
			to: n
		});
...
Q.state = /* @__PURE__ */ Ce.define({
	...
	update(e, t) {
		...
		return t.startState.facet(_u) == t.state.facet(_u) ? e.apply(t) : pu.init(t.state);
	}
});
var mu = (e) => {
...
typeof requestIdleCallback < "u" && (mu = (e) => {
	let t = -1, n = setTimeout(() => {
		t = requestIdleCallback(e, { timeout: 400 });
	}, 100);
	return () => t < 0 ? clearTimeout(n) : cancelIdleCallback(t);
});
var hu = typeof navigator < "u" && navigator.scheduling?.isInputPending ? () => navigator.scheduling.isInputPending() : null, gu = /* @__PURE__ */ z.fromClass(class {
	constructor(e) {
	...
	work(e) {
		...
		let a = Date.now() + Math.min(this.chunkBudget, 100, e && !hu ? Math.max(25, e.timeRemaining() - 5) : 1e9), o = i.context.treeLen < r && n.doc.length > r + 1e3, s = i.context.work(() => hu && hu() || Date.now() > a, r + (o ? 0 : 1e5));
		this.chunkBudget -= Date.now() - t, (s || this.chunkBudget <= 0) && (i.context.takeTree(), this.view.dispatch({ effects: Q.setState.of(new pu(i.context)) })), this.chunkBudget > 0 && !(s && !o) && this.scheduleWork(), this.checkAsyncSchedule(i.context);
	}
...
}, bu = /* @__PURE__ */ E.define(), xu = /* @__PURE__ */ E.define({ combine: (e) => {
	if (!e.length) return "  ";
	let t = e[0];
...
function Cu(e, t) {
	let n = "", r = e.tabSize, i = e.facet(xu)[0];
	if (i == "	") {
		for (; t >= r;) n += "	", t -= r;
		i = " ";
	}
...
function wu(e, t) {
	e instanceof k && (e = new Tu(e));
	for (let n of e.state.facet(bu)) {
		let r = n(e, t);
...
var Tu = class {
	constructor(e, t = {}) {
		this.state = e, this.options = t, this.unit = Su(e);
	}
	lineAt(e, t = 1) {
...
function Au(e) {
	let t = e.type.prop(Eu);
	if (t) return t;
	let n = e.firstChild, r;
	if (n && (r = n.type.prop(K.closedBy))) {
		let t = e.lastChild, n = t && r.indexOf(t.name) > -1;
		return (e) => Iu(e, !0, 1, void 0, n && !ku(e) ? t.from : void 0);
	}
	return e.parent == null ? ju : null;
}
function ju() {
	return 0;
}
var Mu = class e extends Tu {
	constructor(e, t, n) {
...
function Fu({ closing: e, align: t = !0, units: n = 1 }) {
	return (r) => Iu(r, t, n, e);
}
function Iu(e, t, n, r, i) {
	let a = e.textAfter, o = a.match(/^\s*/)[0].length, s = r && a.slice(o, o + r.length) == r || i == e.pos + o, c = t ? Pu(e) : null;
	return c ? s ? e.column(c.from) : e.column(c.to) : e.baseIndent + (s ? 0 : e.unit * n);
}
var Lu = (e) => e.baseIndent;
...
function Bu() {
	return k.transactionFilter.of((e) => {
		...
		for (let { head: e } of o.selection.ranges) {
			...
			let n = wu(o, t.from);
			if (n == null) continue;
			let r = /^\s*/.exec(t.text)[0], i = Cu(o, n);
			r != i && c.push({
				from: t.from,
				to: t.from + r.length,
				insert: i
...
var Vu = /* @__PURE__ */ E.define(), Hu = /* @__PURE__ */ new K();
function Uu(e) {
...
function Wu(e, t, n) {
	...
	for (let o = i; o; o = o.next) {
		...
		if (s && (i.to < r.length - 50 || r.length == e.doc.length || !Gu(i))) {
			let r = s(i, e);
...
var Ju = /* @__PURE__ */ D.define({ map: qu }), Yu = /* @__PURE__ */ D.define({ map: qu });
function Xu(e) {
	let t = [];
	for (let { head: n } of e.state.selection.ranges) t.some((e) => e.from <= n && e.to >= n) || t.push(e.lineBlockAt(n));
	return t;
}
var Zu = /* @__PURE__ */ Ce.define({
	create() {
		return F.none;
	},
	update(e, t) {
		t.isUserEvent("delete") && t.changes.iterChangedRanges((t, n) => e = Qu(e, t, n)), e = e.map(t.changes);
		for (let n of t.effects) if (n.is(Ju) && !ed(e, n.value.from, n.value.to)) {
			let { preparePlaceholder: r } = t.state.facet(sd), i = r ? F.replace({ widget: new dd(r(t.state, n.value)) }) : ud;
			e = e.update({ add: [i.range(n.value.from, n.value.to)] });
		} else n.is(Yu) && (e = e.update({
			filter: (e, t) => n.value.from != e || n.value.to != t,
			filterFrom: n.value.from,
			filterTo: n.value.to
		}));
		return t.selection && (e = Qu(e, t.selection.main.head)), e;
	},
...
function $u(e, t, n) {
	var r;
	let i = null;
	return (r = e.field(Zu, !1)) == null || r.between(t, n, (e, t) => {
		(!i || i.from > e) && (i = {
			from: e,
			to: t
		});
...
function td(e, t) {
	return e.field(Zu, !1) ? t : t.concat(D.appendConfig.of(cd()));
}
var nd = (e) => {
	for (let t of Xu(e)) {
		let n = Ku(e.state, t.from, t.to);
		if (n) return e.dispatch({ effects: td(e.state, [Ju.of(n), id(e, n)]) }), !0;
	}
	return !1;
}, rd = (e) => {
	if (!e.state.field(Zu, !1)) return !1;
	let t = [];
	for (let n of Xu(e)) {
		let r = $u(e.state, n.from, n.to);
		r && t.push(Yu.of(r), id(e, r, !1));
	}
...
var ad = [
	...
	},
	{
		...
		run: (e) => {
			...
			for (let r = 0; r < t.doc.length;) {
				let i = e.lineBlockAt(r), a = Ku(t, i.from, i.to);
				a && n.push(Ju.of(a)), r = (a ? e.lineBlockAt(a.to) : i).to + 1;
			}
			return n.length && e.dispatch({ effects: td(e.state, n) }), !!n.length;
		}
	},
	{
		key: "Ctrl-Alt-]",
		run: (e) => {
			let t = e.state.field(Zu, !1);
	...
	placeholderText: "…"
}, sd = /* @__PURE__ */ E.define({ combine(e) {
	return rt(e, od);
} });
function cd(e) {
	let t = [Zu, hd];
...
function ld(e, t) {
	let { state: n } = e, r = n.facet(sd), i = (t) => {
		...
		r && e.dispatch({ effects: Yu.of(r) }), t.preventDefault();
	};
...
var ud = /* @__PURE__ */ F.replace({ widget: /* @__PURE__ */ new class extends en {
	toDOM(e) {
		return ld(e, null);
	}
}() }), dd = class extends en {
...
function md(e = {}) {
	let t = {
		...fd,
		...e
	}, n = new pd(t, !0), r = new pd(t, !1), i = z.fromClass(class {
		constructor(e) {
			this.from = e.viewport.from, this.markers = this.buildMarkers(e);
		}
		update(e) {
			(e.docChanged || e.viewportChanged || e.startState.facet(_u) != e.state.facet(_u) || e.startState.field(Zu, !1) != e.state.field(Zu, !1) || su(e.startState) != su(e.state) || t.foldingChanged(e)) && (this.markers = this.buildMarkers(e.view));
		}
		buildMarkers(e) {
			let t = new ut();
			for (let i of e.viewportLineBlocks) {
				let a = $u(e.state, i.from, i.to) ? r : Ku(e.state, i.from, i.to) ? n : null;
		...
		_c({
			...
			domEventHandlers: {
				...
				click: (e, t, n) => {
					...
					if (r) return e.dispatch({ effects: Yu.of(r) }), !0;
					let i = Ku(e.state, t.from, t.to);
					return i ? (e.dispatch({ effects: Ju.of(i) }), !0) : !1;
				}
			}
		}),
		cd()
...
var hd = /* @__PURE__ */ W.baseTheme({
	...
	constructor(e, t) {
		...
		this.scope = a instanceof Q ? (e) => e.prop(nu) == a.data : a ? (e) => e == a : void 0, this.style = Ll(e.map((e) => ({
			tag: e.tag,
...
}, _d = /* @__PURE__ */ E.define(), vd = /* @__PURE__ */ E.define({ combine(e) {
	return e.length ? [e[0]] : null;
} });
function yd(e) {
	let t = e.facet(_d);
	return t.length ? t : e.facet(vd);
}
function bd(e, t) {
	let n = [Sd], r;
	return e instanceof gd && (e.module && n.push(W.styleModule.of(e.module)), r = e.themeType), t?.fallback ? n.push(vd.of(e)) : r ? n.push(_d.computeN([W.darkTheme], (t) => t.facet(W.darkTheme) == (r == "dark") ? [e] : [])) : n.push(_d.of(e)), n;
}
var xd = class {
	constructor(e) {
		this.markCache = Object.create(null), this.tree = su(e.state), this.decorations = this.buildDeco(e, yd(e.state)), this.decoratedTo = e.viewport.to;
	}
	update(e) {
		let t = su(e.state), n = yd(e.state), r = n != yd(e.startState), { viewport: i } = e.view, a = e.changes.mapPos(this.decoratedTo, 1);
...
}, Sd = /* @__PURE__ */ Ee.high(/* @__PURE__ */ z.fromClass(xd, { decorations: (e) => e.decorations })), Cd = /* @__PURE__ */ gd.define([
	{
		tag: Z.meta,
		color: "#404740"
	},
...
]), wd = /* @__PURE__ */ W.baseTheme({
	"&.cm-focused .cm-matchingBracket": { backgroundColor: "#328c8252" },
	"&.cm-focused .cm-nonmatchingBracket": { backgroundColor: "#bb555544" }
}), Td = 1e4, Ed = "()[]{}", Dd = /* @__PURE__ */ E.define({ combine(e) {
	return rt(e, {
		afterCursor: !0,
		brackets: Ed,
		maxScanDistance: Td,
...
} }), Od = /* @__PURE__ */ F.mark({ class: "cm-matchingBracket" }), kd = /* @__PURE__ */ F.mark({ class: "cm-nonmatchingBracket" });
function Ad(e) {
	let t = [], n = e.matched ? Od : kd;
...
function jd(e) {
	...
	for (let r of e.selection.ranges) {
		if (!r.empty) continue;
		let i = Ld(e, r.head, -1, n) || r.head > 0 && Ld(e, r.head - 1, 1, n) || n.afterCursor && (Ld(e, r.head, 1, n) || r.head < e.doc.length && Ld(e, r.head + 1, -1, n));
		i && (t = t.concat(n.renderMatch(i, e)));
	}
	return F.set(t, !0);
}
var Md = [/* @__PURE__ */ z.fromClass(class {
	constructor(e) {
		this.paused = !1, this.decorations = jd(e.state);
	}
	update(e) {
		(e.docChanged || e.selectionSet || this.paused) && (e.view.composing ? (this.decorations = this.decorations.map(e.changes), this.paused = !0) : (this.decorations = jd(e.state), this.paused = !1));
	}
}, { decorations: (e) => e.decorations }), wd];
function Nd(e = {}) {
	return [Dd.of(e), Md];
}
var Pd = /* @__PURE__ */ new K();
function Fd(e, t, n) {
...
function Ld(e, t, n, r = {}) {
	let i = r.maxScanDistance || Td, a = r.brackets || Ed, o = su(e), s = o.resolveInner(t, n);
	for (let r = s; r; r = r.parent) {
		let i = Fd(r.type, n, a);
		if (i && r.from < r.to) {
			let o = Id(r);
			if (o && (n > 0 ? t >= o.from && t < o.to : t > o.from && t <= o.to)) return Rd(e, t, n, r, o, i, a);
		}
	}
	return zd(e, t, n, o, s.type, i, a);
}
function Rd(e, t, n, r, i, a, o) {
	...
	if (u && (n < 0 ? u.childBefore(r.from) : u.childAfter(r.to))) do
		if (n < 0 ? u.to <= r.from : u.from >= r.to) {
			...
			} else if (Fd(u.type, n, o)) l++;
			else if (Fd(u.type, -n, o)) {
				if (l == 0) {
					let e = Id(u);
					return {
						start: c,
...
var Vd = class {
	...
	column() {
		return this.lastColumnPos < this.start && (this.lastColumnValue = Bd(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue), this.lastColumnPos = this.start), this.lastColumnValue;
	}
	indentation() {
		return this.overrideIndent ?? Bd(this.string, null, this.tabSize);
	}
	match(e, t, n) {
		if (typeof e == "string") {
...
function Hd(e) {
	return {
		...
		copyState: e.copyState || Ud,
		indent: e.indent || (() => null),
		languageData: e.languageData || {},
		tokenTable: e.tokenTable || Zd,
...
var Wd = /* @__PURE__ */ new WeakMap(), Gd = class e extends Q {
	constructor(e) {
		let t = ru(e.languageData), n = Hd(e), r, i = new class extends fl {
			createParse(e, t, n) {
				return new Yd(r, e, t, n);
			}
		}();
		super(t, i, [], e.name), this.topNode = cf(t, this), r = this, this.streamParser = n, this.stateAfter = new K({ perNode: !0 }), this.tokenTable = e.tokenTable ? new rf(n.tokenTable) : af;
	}
	static define(t) {
		return new e(t);
	}
	getIndent(e) {
		...
		n && (t = Wd.get(e.state), t != null && t < e.pos - 1e4 && (t = void 0));
		let r = Kd(this, e.node.tree, e.node.from, e.node.from, t ?? e.pos), i, a;
		...
		for (; i < e.pos;) {
			...
			if (t.length) {
				let i = n ? n(t.from) : -1, o = new Vd(t.text, e.state.tabSize, e.unit, i < 0 ? void 0 : i);
				for (; o.pos < r - t.from;) Xd(this.streamParser.token, o, a);
			} else this.streamParser.blankLine(a, e.unit);
			if (r == e.pos) break;
			i = t.to + 1;
		}
		let o = e.lineAt(e.pos);
		return n && t == null && Wd.set(e.state, o.from), this.streamParser.indent(a, /^\s*(.*)/.exec(o.text)[1], e);
	}
	get allowsNesting() {
		return !1;
	}
...
function Kd(e, t, n, r, i) {
	...
	for (let a = t.children.length - 1; a >= 0; a--) {
		let o = t.children[a], s = n + t.positions[a], c = o instanceof Y && s < i && Kd(e, o, s, r, i);
		if (c) return c;
	}
	return null;
}
...
function Jd(e, t, n, r, i) {
	for (let i of t) {
		let t = i.from + (i.openStart ? 25 : 0), a = i.to - (i.openEnd ? 25 : 0), o = t <= n && a > n && Kd(e, i.tree, 0 - i.offset, n, a), s;
		if (o && o.pos <= r && (s = qd(e, i.tree, n + i.offset, o.pos + i.offset, !1))) return {
			state: o.state,
			tree: s
		};
	}
	return {
		state: e.streamParser.startState(i ? Su(i) : 4),
		tree: Y.empty
	};
}
var Yd = class {
	constructor(e, t, n, r) {
		...
		let i = du.get(), a = r[0].from, { state: o, tree: s } = Jd(e, n, a, this.to, i?.state);
		...
		i && this.parsedPos < i.viewport.from - 1e5 && r.some((e) => e.from <= i.viewport.from && e.to >= i.viewport.from) && (this.state = this.lang.streamParser.startState(Su(i.state)), i.skipUntilInView(this.parsedPos, i.viewport.from), this.parsedPos = i.viewport.from), this.moveRangeIndex();
	}
	advance() {
		let e = du.get(), t = this.stoppedAt == null ? this.to : Math.min(this.to, this.stoppedAt), n = Math.min(t, this.chunkStart + 512);
	...
	parseLine(e) {
		let { line: t, end: n } = this.nextLine(), r = 0, { streamParser: i } = this.lang, a = new Vd(t, e ? e.state.tabSize : 4, e ? Su(e.state) : 2);
		if (a.eol()) i.blankLine(this.state, a.indentUnit);
		else for (; !a.eol();) {
			let e = Xd(i.token, a, this.state);
...
var Zd = /* @__PURE__ */ Object.create(null), Qd = [q.none], $d = /* @__PURE__ */ new Hc(Qd), ef = [], tf = /* @__PURE__ */ Object.create(null), nf = /* @__PURE__ */ Object.create(null);
for (let [e, t] of [
...
]) nf[e] = /* @__PURE__ */ sf(Zd, t);
var rf = class {
	constructor(e) {
		this.extra = e, this.table = Object.assign(Object.create(null), nf);
	}
	resolve(e) {
		return e ? this.table[e] || (this.table[e] = sf(this.extra, e)) : 0;
	}
}, af = /* @__PURE__ */ new rf(Zd);
function of(e, t) {
	ef.indexOf(e) > -1 || (ef.push(e), console.warn(t));
}
function sf(e, t) {
	let n = [];
	for (let r of t.split(" ")) {
		...
		for (let n of r.split(".")) {
			let r = e[n] || Z[n];
			r ? typeof r == "function" ? t.length ? t = t.map(r) : of(n, `Modifier ${n} used at start of tag`) : t.length ? of(n, `Tag ${n} used as modifier`) : t = Array.isArray(r) ? r : [r] : of(n, `Unknown highlighting tag ${n}`);
		}
		for (let e of t) n.push(e);
	}
	if (!n.length) return 0;
	let r = t.replace(/ /g, "_"), i = r + " " + n.map((e) => e.id), a = tf[i];
	if (a) return a.id;
	let o = tf[i] = q.define({
		id: Qd.length,
		name: r,
...
function cf(e, t) {
	let n = q.define({
		id: Qd.length,
		name: "Document",
		props: [nu.add(() => e), Eu.add(() => (e) => t.getIndent(e))],
		top: !0
	});
	return Qd.push(n), n;
}
...
var lf = class e {
	...
	static start(t, n, r = 0) {
		...
		return new e(t, [], n, r, r, 0, [], 0, i ? new uf(i, i.start) : null, 0, null);
	}
	get context() {
	...
	reduce(e) {
		...
		if (a && (this.score += a), t == 0) {
			this.pushState(r.getGoto(this.state, n, !0), this.reducePos), n < r.minRepeatTerm && this.storeNode(n, this.reducePos, this.reducePos, i ? 8 : 4, !0), this.reduceContext(n, this.reducePos);
			return;
		}
		let o = this.stack.length - (t - 1) * 3 - (e & 262144 ? 6 : 0), s = o ? this.stack[o - 2] : this.p.ranges[0].from, c = this.reducePos - s;
	...
	storeNode(e, t, n, r = 4, i = !1) {
		if (e == 0 && (!this.stack.length || this.stack[this.stack.length - 1] < this.buffer.length + this.bufferBase)) {
			...
			if (r == 0 && e.parent && (r = e.bufferBase - e.parent.bufferBase, e = e.parent), r > 0 && e.buffer[r - 4] == 0 && e.buffer[r - 1] > -1) {
				if (t == n) return;
				if (e.buffer[r - 2] >= t) {
					e.buffer[r - 2] = n;
					return;
	...
	split() {
		...
		for (; n > 0 && t.buffer[n - 2] > t.reducePos;) n -= 4;
	...
	reduce(e) {
		...
		n == 0 ? (this.stack == this.start.stack && (this.stack = this.stack.slice()), this.stack.push(this.state, 0, 0), this.base += 3) : this.base -= (n - 1) * 3, this.state = this.start.p.parser.getGoto(this.stack[this.base - 3], t, !0);
	}
}, ff = class e {
	constructor(e, t, n) {
...
var mf = class {
	...
	constructor(e, t) {
		this.input = e, this.ranges = t, this.chunk = "", this.chunkOff = 0, this.chunk2 = "", this.chunk2Pos = 0, this.next = -1, this.token = hf, this.rangeIndex = 0, this.pos = this.chunkPos = t[0].from, this.range = t[0], this.end = t[t.length - 1].to, this.readNext();
	}
	resolveOffset(e, t) {
	...
	getChunk() {
		if (this.pos >= this.chunk2Pos && this.pos < this.chunk2Pos + this.chunk2.length) {
			...
			this.chunk = this.pos + e.length > this.range.to ? e.slice(0, this.range.to - this.pos) : e, this.chunkPos = this.pos, this.chunkOff = 0;
		}
	}
	readNext() {
	...
	reset(e, t) {
		if (t ? (this.token = t, t.start = e, t.lookAhead = e + 1, t.value = t.extended = -1) : this.token = hf, this.pos != e) {
	...
	token(e, t) {
		let { parser: n } = t.p;
		bf(this.data, e, t, this.id, n.data, n.tokenPrecTable);
	}
};
_f.prototype.contextual = _f.prototype.fallback = _f.prototype.extend = !1;
var vf = class {
	constructor(e, t, n) {
		this.precTable = t, this.elseToken = n, this.data = typeof e == "string" ? pf(e) : e;
	}
	token(e, t) {
		let n = e.pos, r = 0;
		for (;;) {
...
vf.prototype.contextual = _f.prototype.fallback = _f.prototype.extend = !1;
var yf = class {
	constructor(e, t = {}) {
...
function bf(e, t, n, r, i, a) {
	...
	scan: for (; (s & e[o]) != 0;) {
		...
		for (let r = o + 3; r < n; r += 2) if ((e[r + 1] & s) > 0) {
			let n = e[r];
			if (c.allows(n) && (t.token.value == -1 || t.token.value == n || Sf(n, t.token.value, i, a))) {
				t.acceptToken(n);
				break;
			}
		}
...
function Sf(e, t, n, r) {
	let i = xf(n, r, t);
	return i < 0 || xf(n, r, e) < i;
}
var $ = typeof process < "u" && process.env && /\bparse\b/.test(process.env.LOG), Cf = null;
function wf(e, t, n) {
...
var Tf = class {
	...
	nextFragment() {
		...
		if (e) {
			for (this.safeFrom = e.openStart ? wf(e.tree, e.from + e.offset, 1) - e.offset : e.from, this.safeTo = e.openEnd ? wf(e.tree, e.to + e.offset, -1) - e.offset : e.to; this.trees.length;) this.trees.pop(), this.start.pop(), this.index.pop();
	...
	constructor(e, t) {
		this.stream = t, this.tokens = [], this.mainToken = null, this.actions = [], this.tokens = e.tokenizers.map((e) => new mf());
	}
	getActions(e) {
		...
		return s && e.setLookAhead(s), !n && e.pos == this.stream.end && (n = new mf(), n.value = e.p.parser.eofTerm, n.start = n.end = e.pos, t = this.addActions(e, n.value, n.end, t)), this.mainToken = n, this.actions;
	}
	getMainToken(e) {
		if (this.mainToken) return this.mainToken;
		let t = new mf(), { pos: n, p: r } = e;
	...
	addActions(e, t, n, r) {
		...
		for (let e = 0; e < 2; e++) for (let s = a.stateSlot(i, e ? 2 : 1);; s += 3) {
			if (o[s] == 65535) if (o[s + 1] == 1) s = Nf(o, s + 2);
			else {
				r == 0 && o[s + 1] == 2 && (r = this.putAction(Nf(o, s + 2), t, n, r));
				break;
			}
			o[s] == t && (r = this.putAction(Nf(o, s + 1), t, n, r));
		}
		return r;
	}
}, Df = class {
	constructor(e, t, n, r) {
		this.parser = e, this.input = t, this.ranges = r, this.recovering = 0, this.nextStackID = 9812, this.minStackPos = 0, this.reused = [], this.stoppedAt = null, this.lastBigReductionStart = -1, this.lastBigReductionSize = 0, this.bigReductionCount = 0, this.stream = new gf(t, r), this.tokens = new Ef(e, this.stream), this.topTerm = e.top[1];
		let { from: i } = r[0];
		this.stacks = [lf.start(this, e.top[0], i)], this.fragments = n.length && this.stream.end - i > e.bufferLength * 4 ? new Tf(n, e.nodeSet) : null;
	}
	get parsedPos() {
	...
	runRecovery(e, t, n) {
		...
		for (let a = 0; a < e.length; a++) {
			...
			this.stream.end > o.pos ? (c == o.pos && (c++, s = 0), o.recoverByDelete(s, c), $ && console.log(l + this.stackID(o) + ` (via recover-delete ${this.parser.getName(s)})`), Of(o, n)) : (!r || r.score < u.score) && (r = u);
		}
		return r;
	}
	stackToTree(e) {
	...
	stackID(e) {
		let t = (Cf ||= /* @__PURE__ */ new WeakMap()).get(e);
		return t || Cf.set(e, t = String.fromCodePoint(this.nextStackID++)), t + e;
	}
};
function Of(e, t) {
...
var kf = class {
	...
	constructor(e) {
		this.start = e.start, this.shift = e.shift || Af, this.reduce = e.reduce || Af, this.reuse = e.reuse || Af, this.hash = e.hash || (() => 0), this.strict = e.strict !== !1;
	}
}, Mf = class e extends fl {
	constructor(e) {
		...
		this.nodeSet = new Hc(t.map((t, i) => q.define({
		...
		let a = pf(e.tokenData);
		this.context = e.context, this.specializerSpecs = e.specialized || [], this.specialized = new Uint16Array(this.specializerSpecs.length);
		for (let e = 0; e < this.specializerSpecs.length; e++) this.specialized[e] = this.specializerSpecs[e].term;
		this.specializers = this.specializerSpecs.map(Ff), this.states = pf(e.states, Uint32Array), this.data = pf(e.stateData), this.goto = pf(e.goto), this.maxTerm = e.maxTerm, this.tokenizers = e.tokenizers.map((e) => typeof e == "number" ? new _f(a, e) : e), this.topRules = e.topRules, this.dialects = e.dialects || {}, this.dynamicPrecedences = e.dynamicPrecedences || null, this.tokenPrecTable = e.tokenPrec, this.termNames = e.termNames || null, this.maxNode = this.nodeSet.types.length - 1, this.dialect = this.parseDialect(), this.top = this.topRules[Object.keys(this.topRules)[0]];
	}
	createParse(e, t, n) {
		let r = new Df(this, e, t, n);
	...
	hasAction(e, t) {
		...
		for (let r = 0; r < 2; r++) for (let i = this.stateSlot(e, r ? 2 : 1), a;; i += 3) {
			if ((a = n[i]) == 65535) if (n[i + 1] == 1) a = n[i = Nf(n, i + 2)];
			else if (n[i + 1] == 2) return Nf(n, i + 2);
			else break;
			if (a == t || a == 0) return Nf(n, i + 1);
		}
		return 0;
	}
	stateSlot(e, t) {
	...
	allActions(e, t) {
		...
		for (let n = this.stateSlot(e, 1); r == null; n += 3) {
			if (this.data[n] == 65535) if (this.data[n + 1] == 1) n = Nf(this.data, n + 2);
			else break;
			r = t(Nf(this.data, n + 1));
		}
		return r;
	}
	nextStates(e) {
	...
	configure(t) {
		...
		return t.tokenizers && (n.tokenizers = this.tokenizers.map((e) => {
			...
			return n.specializers[r] = Ff(a), a;
...
//# sourceMappingURL=dist-C56v8Vz7.js.map