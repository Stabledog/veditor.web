	...
	static resolve(t, n, r) {
		...
		for (let e in a) {
			...
			if (t.every((e) => e.type == 0)) {
				if (s[n.id] = c.length << 1 | 1, _e(i, t)) c.push(r.facet(n));
				else {
...
var En = null;
N.safari && N.safari_version >= 26 && (En = !1);
function Dn(e) {
	if (e.setActive) return e.setActive();
	if (En) return e.focus(En);
	let t = wn(e);
	e.focus(En == null ? { get preventScroll() {
		return En = { preventScroll: !0 }, !0;
	} } : void 0), En || (En = !1, Tn(t));
}
var On;
function kn(e, t, n = t) {
	let r = On ||= document.createRange();
...
var Bn = /*@__PURE__*/ zn("88888888888888888888888888888888888666888888787833333333337888888000000000000000000000000008888880000000000000000000000000088888888888888888888888888888888888887866668888088888663380888308888800000000000000000000000800000000000000000000000000000008"), Vn = /*@__PURE__*/ zn("4444448826627288999999999992222222222222222222222222222222222222222222222229999999999999999999994444444444644222822222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222999999949999999229989999223333333333"), Hn = /*@__PURE__*/ Object.create(null), Un = [];
for (let e of [
	"()",
	"[]",
	"{}"
...
function Wn(e) {
	return e <= 247 ? Bn[e] : 1424 <= e && e <= 1524 ? 2 : 1536 <= e && e <= 1785 ? Vn[e - 1536] : 1774 <= e && e <= 2220 ? 4 : 8192 <= e && e <= 8204 ? 256 : 64336 <= e && e <= 65023 ? 4 : 1;
}
var Gn = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac\ufb50-\ufdff]/, Kn = class {
	get dir() {
		return this.level % 2 ? Rn : Ln;
	}
	constructor(e, t, n) {
...
function qn(e, t) {
	...
	for (let n = 0; n < e.length; n++) {
		let r = e[n], i = t[n];
		if (r.from != i.from || r.to != i.to || r.direction != i.direction || !qn(r.inner, i.inner)) return !1;
	}
	return !0;
}
var L = [];
...
function Yn(e, t, n, r, i) {
	...
	for (let o = 0, s = 0, c = 0; o <= r.length; o++) {
		...
		for (let t = l, n, r, o; t < u; t++) if (r = Hn[n = e.charCodeAt(t)]) {
			if (r < 0) {
				for (let e = s - 3; e >= 0; e -= 3) if (Un[e + 1] == -r) {
					let n = Un[e + 2], r = n & 2 ? i : n & 4 ? n & 1 ? a : i : 0;
					r && (L[t] = L[Un[e]] = r), s = e;
					break;
				}
			} else if (Un.length == 189) break;
			else Un[s++] = t, Un[s++] = n, Un[s++] = c;
		} else if ((o = L[t]) == 2 || o == 1) {
			let e = o == i;
			c = +!e;
...
function Zn(e, t, n, r, i, a, o) {
	...
	if (r % 2 == i % 2) for (let c = t, l = 0; c < n;) {
		...
		run: for (;;) if (l < a.length && p == a[l].from) {
			...
			l++, d ? d.push(m) : (m.from > c && o.push(new Kn(c, m.from, f)), Qn(e, m.direction == Ln == !(f % 2) ? r : r + 1, i, m.inner, m.from, m.to, o), c = m.to), p = m.to;
		} else if (p == n || (t ? L[p] != s : L[p] == s)) break;
		else p++;
		d ? Zn(e, c, p, r + 1, i, d, o) : c < p && o.push(new Kn(c, p, f)), c = p;
	}
		...
		run: for (;;) if (l && p == a[l - 1].to) {
			...
			d ? d.push(m) : (m.to < c && o.push(new Kn(m.to, c, f)), Qn(e, m.direction == Ln == !(f % 2) ? r : r + 1, i, m.inner, m.from, m.to, o), c = m.from), p = m.from;
		} else if (p == t || (n ? L[p - 1] != s : L[p - 1] == s)) break;
		else p--;
		d ? Zn(e, p, c, r + 1, i, d, o) : p < c && o.push(new Kn(p, c, f)), c = p;
	}
}
function Qn(e, t, n, r, i, a, o) {
	let s = t % 2 ? 2 : 1;
	Jn(e, i, a, r, s), Yn(e, i, a, r, s), Xn(i, a, r, s), Zn(e, i, a, t, n, r, o);
}
function $n(e, t, n) {
	if (!e) return [new Kn(0, 0, +(t == Rn))];
	if (t == Ln && !n.length && !Gn.test(e)) return er(e.length);
...
function nr(e, t, n, r, i) {
	let a = r.head - e.from, o = Kn.find(t, a, r.bidiLevel ?? -1, r.assoc), s = t[o], c = s.side(i, n);
	if (a == c) {
		let e = o += i ? 1 : -1;
...
function rr(e, t, n) {
	for (let r = t; r < n; r++) {
		let t = Wn(e.charCodeAt(r));
		if (t == 1) return Ln;
		if (t == 2 || t == 4) return Rn;
	}
	return Ln;
}
var ir = /*@__PURE__*/ E.define(), ar = /*@__PURE__*/ E.define(), or = /*@__PURE__*/ E.define(), sr = /*@__PURE__*/ E.define(), cr = /*@__PURE__*/ E.define(), lr = /*@__PURE__*/ E.define(), ur = /*@__PURE__*/ E.define(), dr = /*@__PURE__*/ E.define(), fr = /*@__PURE__*/ E.define(), pr = /*@__PURE__*/ E.define({ combine: (e) => e.some((e) => e) }), mr = /*@__PURE__*/ E.define({ combine: (e) => e.some((e) => e) }), hr = /*@__PURE__*/ E.define(), gr = class e {
...
}, _r = /*@__PURE__*/ D.define({ map: (e, t) => e.map(t) }), vr = /*@__PURE__*/ D.define();
function R(e, t, n) {
	let r = e.facet(sr);
	r.length ? r[0](t) : window.onerror && window.onerror(String(t), n, void 0, void 0, t) || (n ? console.error(n + ":", t) : console.error(t));
}
var yr = /*@__PURE__*/ E.define({ combine: (e) => !e.length || e[0] }), br = 0, xr = /*@__PURE__*/ E.define({ combine(e) {
	return e.filter((t, n) => {
	...
	constructor(e, t, n, r, i) {
		this.id = e, this.create = t, this.domEventHandlers = n, this.domEventObservers = r, this.baseExtensions = i(this), this.extension = this.baseExtensions.concat(xr.of({
			plugin: this,
			arg: void 0
		}));
	}
	of(e) {
		return this.baseExtensions.concat(xr.of({
			plugin: this,
			arg: e
		}));
	}
...
}, Cr = /*@__PURE__*/ E.define(), wr = /*@__PURE__*/ E.define(), Tr = /*@__PURE__*/ E.define(), Er = /*@__PURE__*/ E.define(), Dr = /*@__PURE__*/ E.define(), Or = /*@__PURE__*/ E.define(), kr = /*@__PURE__*/ E.define();
function Ar(e, t) {
	...
	return A.spans(r, t.from, t.to, {
		...
		span(e, n, r, a) {
			...
			for (let e = r.length - 1; e >= 0; e--, a--) {
				...
				if (n ??= rr(t.text, o, s), a > 0 && c.length && (i = c[c.length - 1]).to == o && i.direction == n) i.to = s, c = i.inner;
				else {
					let e = {
						from: o,
						to: s,
...
var jr = /*@__PURE__*/ E.define();
function Mr(e) {
	let t = 0, n = 0, r = 0, i = 0;
	for (let a of e.state.facet(jr)) {
		let o = a(e);
...
var Nr = /*@__PURE__*/ E.define(), Pr = class e {
	constructor(e, t, n, r) {
	...
	constructor(e, t, n) {
		...
		let r = [];
		this.changes.iterChangedRanges((e, t, n, i) => r.push(new Pr(e, t, n, i))), this.changedRanges = r;
	}
	static create(t, n, r) {
		return new e(t, n, r);
	}
	...
	domPosFor(e, t) {
		...
		return new In(this.parent.dom, n + +!!r, e == 0 || e == this.length);
	}
	markDirty(e) {
	...
	sync(e) {
		...
		for (let o of this.children) {
			if (o.sync(e), a += o.length + o.breakAfter, r = n ? n.nextSibling : t.firstChild, i && r != o.dom && (i.written = !0), o.dom.parentNode == t) for (; r && r != o.dom;) r = Rr(r);
			else t.insertBefore(o.dom, r);
			n = o.dom;
		}
		for (r = n ? n.nextSibling : t.firstChild, i && r && (i.written = !0); r;) r = Rr(r);
		this.length = a;
	}
};
function Rr(e) {
...
var zr = class extends Lr {
	...
	blockTiles(e) {
		for (let t = [], n = this, r = 0, i = 0;;) if (r == n.children.length) {
			...
			let a = n.children[r++];
			if (a instanceof Br) t.push(r), n = a, r = 0;
			else {
	...
	resolveInline(e, t, n) {
		...
		function s(e, c) {
			for (let l = 0, u = 0; l < e.children.length && u <= c; l++) {
				...
				f >= c && (d.isComposite() ? s(d, c - u) : (!a || a.isHidden && (t > 0 && !(a.flags & 32) || n && Ur(a, d))) && (f > c || d.flags & 32 && t <= 1) ? (a = d, o = c - u) : (u < c || d.flags & 16 && !d.isHidden && t >= -1) && (r = d, i = c - u)), u = f;
			}
		}
		s(this, e);
		let c = (t < 0 ? r : a) || r || a;
	...
	coordsIn(e, t, n) {
		...
		return r ? r.tile.coordsIn(Math.max(0, r.offset), t, n) : Hr(this);
	}
	domIn(e, t) {
		let n = this.resolveInline(e, t);
		if (n) {
			let { tile: e, offset: r } = n;
			if (this.dom.contains(e.dom)) return e.isText() ? new In(e.dom, Math.min(e.dom.nodeValue.length, r)) : e.domPosFor(r, e.flags & 16 ? 1 : e.flags & 32 ? -1 : t);
			let i = n.tile.parent, a = !1;
			for (let e of i.children) {
				if (a) return new In(e.dom, 0);
				e == n.tile && (a = !0);
			}
		}
		return new In(this.dom, 0);
	}
};
function Hr(e) {
...
var V = class e extends Lr {
	...
	addText(e, t, n, r) {
		...
		if (a && a.isText() && !(a.flags & 8) && a.length + e.length < 512) {
			...
			let t = i.children[i.children.length - 1] = new Wr(a.dom, a.text + e);
			t.parent = i;
		} else i.append(r || Wr.of(e, this.cache.find(Wr)?.dom));
		this.pos += e.length, this.afterWidget = null;
	}
	addComposition(e, t) {
		let n = this.curLine;
		n.dom != t.line.dom && (n.setDOM(this.cache.reused.has(t.line) ? ai(t.line.dom) : t.line.dom), this.cache.reused.set(t.line, 2));
		let r = n;
		for (let e = t.marks.length - 1; e >= 0; e--) {
			let n = t.marks[e], i = r.lastChild;
			if (i instanceof V && i.mark.eq(n.mark)) i.dom != n.dom && i.setDOM(ai(n.dom)), r = i;
			else {
				if (this.cache.reused.get(n)) {
					let e = B.get(n.dom);
					e && e.setDOM(ai(n.dom));
				}
				let e = V.of(n.mark, n.dom);
				r.append(e), r = e;
			}
		...
		let a = new Wr(e.text, e.text.nodeValue);
	...
	addLineStart(e, t) {
		e ||= ni;
		let n = Vr.start(e, t || this.cache.find(Vr)?.dom, !!t);
	...
	ensureMarks(e, t) {
		...
		for (let r = e.length - 1; r >= 0; r--) {
			let i = e[r], a;
			if (t > 0 && (a = n.lastChild) && a instanceof V && a.mark.eq(i)) n = a, t--;
			else {
				let e = V.of(i, this.cache.find(V, (e) => e.mark.eq(i))?.dom);
				n.append(e), n = e, t = 0;
			}
		}
		return n;
	...
	endLine() {
		if (this.curLine) {
			...
			(!e || !ei(this.curLine, !1) || e.dom.nodeName != "BR" && e.isWidget() && !(N.ios && ei(this.curLine, !0))) && this.curLine.append(this.cache.findWidget(si, 0, 32) || new Gr(si.toDOM(), 0, si, 32)), this.curLine = this.afterWidget = null;
		}
	}
	updateBlockWrappers() {
		...
		for (let e = this.blockWrappers; e.value && e.from <= this.pos; e.next()) if (e.to >= this.pos) {
			let t = e.rank * 102 + e.value.rank, n = new Jr(e.from, e.to, e.value, t), r = this.wrappers.length;
	...
	getBlockPos() {
		...
		for (let t of this.wrappers) {
			let n = e.lastChild;
			if (t.from < this.pos && n instanceof Br && n.wrapper.eq(t.wrapper)) e = n;
			else {
				let n = Br.of(t.wrapper, this.cache.find(Br, (e) => e.wrapper.eq(t.wrapper))?.dom);
				e.append(n), e = n;
			}
		}
		return e;
	...
	getBuffer(e) {
		let t = 2 | (e < 0 ? 16 : 32), n = this.cache.find(Kr, void 0, 1);
		return n && (n.flags = t), n || new Kr(t);
	}
	flushBuffer() {
...
for (let e = 0; e < Zr.length; e++) Zr[e].bucket = e;
var Qr = class {
	constructor(e) {
	...
	findWidget(e, t, n) {
		...
		if (r.length) for (let i = 0, a = 0;; i++) {
			...
			let o = r[i];
			if (!this.reused.has(o) && (a == 0 ? o.widget.compare(e) : o.widget.constructor == e.constructor && e.updateDOM(o.dom, this.view, o.widget))) return r.splice(i, 1), i < this.index[0] && this.index[0]--, o.widget == e && o.length == t && (o.flags & 497) == n ? (this.reused.set(o, 1), o) : (this.reused.set(o, 2), new Gr(o.dom, t, e, o.flags & -498 | n));
		}
	}
	reuse(e) {
	...
	constructor(e, t, n, r, i) {
		this.view = e, this.decorations = r, this.disallowBlockEffectsFor = i, this.openWidget = !1, this.openMarks = 0, this.cache = new Qr(e), this.text = new Xr(e.state.doc), this.builder = new Yr(this.cache, new zr(e, e.contentDOM), A.iter(n)), this.cache.reused.set(t, 2), this.old = new qr(t), this.reuseWalker = {
			skip: (e, t, n) => {
	...
	preserve(e, t, n) {
		let r = ii(this.old), i = this.openMarks;
		this.old.advance(e, n ? 1 : -1, {
			skip: (e, t, n) => {
				if (e.isWidget()) {
					if (this.openWidget) this.builder.continueWidget(n - t);
					else {
						let a = n > 0 || t < e.length ? Gr.of(e.widget, this.view, n - t, e.flags & 496, this.cache.maybeReuse(e)) : this.cache.reuse(e);
				...
				else if (e instanceof Kr) this.cache.add(e);
				else if (e instanceof V) this.builder.ensureLine(null), this.builder.addMark(e, r, i), this.cache.reused.set(e, 1), i = r.length;
				else return !1;
				this.openWidget = !1;
			},
			enter: (e) => {
				e.isLine() ? this.builder.addLineStart(e.attrs, this.cache.maybeReuse(e)) : (this.cache.add(e), e instanceof V && r.unshift(e.mark)), this.openWidget = !1;
			},
			leave: (e) => {
				e.isLine() ? r.length &&= i = 0 : e instanceof V && (r.shift(), i = Math.min(i, r.length));
			},
			break: () => {
			...
			point: (e, t, a, o, s, c) => {
				if (a instanceof rn) {
					...
					if (i = o.length, s > o.length) r.continueWidget(t - e);
						...
						let i = a.widget || (a.block ? oi.block : oi.inline), c = ti(a), l = this.cache.findWidget(i, t - e, c) || Gr.of(i, this.view, t - e, c);
	...
	getCompositionContext(e) {
		...
		for (let r = e.parentNode;; r = r.parentNode) {
			...
			e instanceof V ? t.push(e) : e?.isLine() ? n = e : e instanceof Br || (r.nodeName == "DIV" && !n && r != this.view.contentDOM ? n = new Vr(r, ni) : n || t.push(V.of(new tn({
...
oi.inline = /*@__PURE__*/ new oi("span"), oi.block = /*@__PURE__*/ new oi("div");
var si = /*@__PURE__*/ new class extends en {
	toDOM() {
	...
	update(e) {
		...
		let n = -1;
		this.view.inputState.composing >= 0 && !this.view.observer.editContext && (this.domChanged?.newSel ? n = this.domChanged.newSel.head : !yi(e.changes, this.hasComposition) && !e.selectionSet && (n = e.state.selection.main.head));
		let r = n > -1 ? fi(this.view, e.changes, n) : null;
		if (this.domChanged = null, this.hasComposition) {
			let { from: n, to: r } = this.hasComposition;
			t = new Pr(n, r, e.changes.mapPos(n, -1), e.changes.mapPos(r, 1)).addToSet(t.slice());
		}
		...
		o.length && (t = Pr.extendWithRanges(t, o));
		let s = _i(a, this.blockWrappers, e.changes);
		return s.length && (t = Pr.extendWithRanges(t, s)), r && !t.some((e) => e.fromA <= r.range.fromA && e.toA >= r.range.toA) && (t = r.range.addToSet(t.slice())), this.tile.flags & 2 && t.length == 0 ? !1 : (this.updateInner(t, r), e.transactions.length && (this.lastUpdate = Date.now()), !0);
	}
	updateInner(e, t) {
		...
		n.ignore(() => {
			if (t || e.length) {
				let n = this.tile, r = new $r(this.view, n, this.blockWrappers, this.decorations, this.dynamicDecorationMap);
				t && B.get(t.text) && r.cache.reused.set(B.get(t.text), 2), this.tile = r.run(e, t), li(n, r.cache.reused);
			}
	...
	updateEditContextFormatting(e) {
		...
		for (let t of e.transactions) for (let e of t.effects) e.is(vr) && (this.editContextFormatting = e.value);
	}
	updateSelection(e = !1, t = !1) {
		(e || !this.view.observer.selectionRange.focusNode) && this.view.observer.readSelectionRange();
		let { dom: n } = this.tile, r = this.view.root.activeElement, i = r == n, a = !i && !(this.view.state.facet(yr) || n.tabIndex > -1) && dn(n, this.view.observer.selectionRange) && !(r && n.contains(r));
		if (!(i || t || a)) return;
		let o = this.forceSelection;
		this.forceSelection = !1;
		let s = this.view.state.selection.main, c, l;
		if (s.empty ? l = c = this.inlineDOMNearPos(s.anchor, s.assoc || 1) : (l = this.inlineDOMNearPos(s.head, s.head == s.from ? 1 : -1), c = this.inlineDOMNearPos(s.anchor, s.anchor == s.from ? 1 : -1)), N.gecko && s.empty && !this.hasComposition && ui(c)) {
			let e = document.createTextNode("");
			this.view.observer.ignore(() => c.node.insertBefore(e, c.node.childNodes[c.offset] || null)), c = l = new In(e, 0), o = !0;
		}
		...
		(o || !u.focusNode || (!pn(c.node, c.offset, u.anchorNode, u.anchorOffset) || !pn(l.node, l.offset, u.focusNode, u.focusOffset)) && !this.suppressWidgetCursorChange(u, s)) && (this.view.observer.ignore(() => {
			N.android && N.chrome && n.contains(u.focusNode) && vi(u.focusNode, n) && (n.blur(), n.focus({ preventScroll: !0 }));
			...
			if (e) {
				if (s.empty) {
					if (N.gecko) {
						...
						if (e && e != 3) {
							let t = (e == 1 ? Pn : Fn)(c.node, c.offset);
							t && (c = new In(t.node, t.offset));
						}
					}
		...
		}), this.view.observer.setSelectionRange(c, l)), this.impreciseAnchor = c.precise ? null : new In(u.anchorNode, u.anchorOffset), this.impreciseHead = l.precise ? null : new In(u.focusNode, u.focusOffset);
	}
	...
	measureVisibleLineHeights(e) {
		let t = [], { from: n, to: r } = e, i = this.view.contentDOM.clientWidth, a = i > Math.max(this.view.scrollDOM.clientWidth, this.minWidth) + 1, o = -1, s = this.view.textDirection == I.LTR, c = 0, l = (e, u, d) => {
			for (let f = 0; f < e.children.length && !(u > r); f++) {
				...
				if (d && !f && (c += m.top - d.top), r instanceof Br) p > n && l(r, u, m);
	...
	updateDeco() {
		let e = 1, t = this.view.state.facet(Tr).map((t) => (this.dynamicDecorationMap[e++] = typeof t == "function") ? t(this.view) : t), n = !1, r = this.view.state.facet(Dr).map((e, t) => {
		...
		this.blockWrappers = this.view.state.facet(Er).map((e) => typeof e == "function" ? e(this.view) : e);
	}
	scrollIntoView(e) {
		if (e.isSnapshot) {
		...
		for (let t of this.view.state.facet(hr)) try {
		...
		if (xn(this.view.scrollDOM, a, t.head < t.anchor ? -1 : 1, e.x, e.y, Math.max(Math.min(e.xMargin, o), -o), Math.max(Math.min(e.yMargin, s), -s), this.view.textDirection == I.LTR), window.visualViewport && window.innerHeight - window.visualViewport.height > 1 && (n.top > window.visualViewport.offsetTop + window.visualViewport.height || n.bottom < window.visualViewport.offsetTop)) {
			...
			if (e) {
				let t = wn(e.dom);
				e.dom.scrollIntoView({ block: "nearest" }), Tn(t, !1);
			}
		}
	}
	lineHasWidget(e) {
...
function di(e, t) {
	...
	let r = Pn(n.focusNode, n.focusOffset), i = Fn(n.focusNode, n.focusOffset), a = r || i;
...
function fi(e, t, n) {
	...
	return {
		range: new Pr(c.mapPos(a), c.mapPos(o), a, o),
		text: i
	};
}
function pi(e, t) {
...
function wi(e, t, n, r) {
	let i = Ci(e, t.head, t.assoc || -1), a = !r || i.type != P.Text || !(e.lineWrapping || i.widgetLineBreaks) ? null : e.coordsAtPos(t.assoc < 0 && t.head > i.from ? t.head - 1 : t.head);
	if (a) {
...
function ki(e, t) {
	...
	for (let r = 0; r < t.ranges.length; r++) {
		...
		if (i.empty) {
			...
			let t = Oi(e, i.from, -1), n = Oi(e, i.to, 1);
...
function Ai(e, t, n) {
	let r = Oi(e.state.facet(Or).map((t) => t(e)), n.from, t.head > n.from ? -1 : 1);
...
function Mi(e, t, n, r) {
	...
	for (;;) {
		if (c < 0) return new ji(0, 1);
		if (c > e.viewState.docHeight) return new ji(e.state.doc.length, -1);
	...
	if (e.viewport.from >= l.to || e.viewport.to <= l.from) {
		...
		if (l.type == P.Text) {
			let t = Si(e, i, l, o, s);
			return new ji(t, t == l.from ? 1 : -1);
		}
	}
	if (l.type != P.Text) return c < (l.top + l.bottom) / 2 ? new ji(l.from, 1) : new ji(l.to, -1);
	let u = e.docView.lineAt(l.from, 2);
	return (!u || u.length != l.length) && (u = e.docView.lineAt(l.from, -2)), new Ni(e, o, s, e.textDirectionAt(l.from)).scanTile(u, l.from);
}
var Ni = class {
	constructor(e, t, n, r) {
	...
	baseDirAt(e, t) {
		...
		return r[Kn.find(r, e - n.from, -1, t)].level == this.baseDir;
	}
	dirAt(e, t) {
		let { line: n, spans: r } = this.bidiSpansAt(e);
		return r[Kn.find(r, e - n.from, -1, t)].dir;
	}
	bidiIn(e, t) {
	...
	scanText(e, t) {
		...
		return r.after ? new ji(n[r.i + 1], -1) : new ji(n[r.i], 1);
	}
	scanTile(e, t) {
		if (!e.length) return new ji(t, 1);
		...
		return i.isText() ? this.scanText(i, a) : i.isComposite() ? this.scanTile(i, a) : r.after ? new ji(n[r.i + 1], -1) : new ji(a, 1);
	}
}, Pi = "￿", Fi = class {
	constructor(e, t) {
	...
	readRange(e, t) {
		...
		for (let r = e;;) {
			...
			let o = B.get(a);
			(i && o ? i.breakAfter : (i ? i.breakAfter : hn(r)) || hn(a) && (r.nodeName != "BR" || i?.isWidget()) && this.text.length > e) && !Li(a, t) && this.lineBreak(), r = a;
		}
	...
	findPointInside(e, t) {
		for (let n of this.points) (e.nodeType == 3 ? n.node == e : e.contains(n.node)) && (n.pos = this.text.length + (Ii(e, n.node, n.offset) ? t : 0));
	}
};
function Ii(e, t, n) {
	for (;;) {
...
var Ri = class {
	...
	constructor(e, t, n, r) {
		...
		else if (t > -1 && (this.bounds = Bi(e.docView.tile, t, n, 0))) {
			let t = i || a ? [] : Gi(e), n = new Fi(t, e);
			n.readRange(this.bounds.startDOM, this.bounds.endDOM), this.text = n.text, this.newSel = Ki(t, this.bounds.from);
		} else {
...
function Vi(e, t) {
	...
	if (t.bounds) {
		...
		let l = i.doc.sliceString(e, r, Pi), u, d;
		!a.empty && a.from >= e && a.to <= r && (t.typeOver || l != t.text) && l.slice(0, a.from - e) == t.text.slice(0, a.from - e) && l.slice(a.to - e) == t.text.slice(u = t.text.length - (l.length - (a.to - e))) ? n = {
			from: a.from,
			to: a.to,
			insert: f.of(t.text.slice(a.from - e, u).split(Pi))
		} : (d = Wi(l, t.text, s - e, c)) && (N.chrome && o == 13 && d.toB == d.from + 2 && t.text.slice(d.from, d.toB) == "￿￿" && d.toB--, n = {
			from: e + d.from,
			to: e + d.toA,
			insert: f.of(t.text.slice(d.from, d.toB).split(Pi))
		});
	} else r && (!e.hasFocus && i.facet(yr) || qi(r, a)) && (r = null);
	if (!n && !r) return !1;
	...
	if (r && !qi(r, a)) {
		let t = !1, n = "select";
		return e.inputState.lastSelectionTime > Date.now() - 50 && (e.inputState.lastSelectionOrigin == "select" && (t = !0), n = e.inputState.lastSelectionOrigin, n == "select.pointer" && (r = ki(i.facet(Or).map((t) => t(e)), r))), e.dispatch({
			selection: r,
			scrollIntoView: t,
			userEvent: n
		}), !0;
...
function Hi(e, t, n, r = -1) {
	...
	if (N.android && (t.to == i.to && (t.from == i.from || t.from == i.from - 1 && e.state.sliceDoc(t.from, i.from) == " ") && t.insert.length == 1 && t.insert.lines == 2 && An(e.contentDOM, "Enter", 13) || (t.from == i.from - 1 && t.to == i.to && t.insert.length == 0 || r == 8 && t.insert.length < t.to - t.from && t.to > i.head) && An(e.contentDOM, "Backspace", 8) || t.from == i.from && t.to == i.to + 1 && t.insert.length == 0 && An(e.contentDOM, "Delete", 46))) return !0;
	let a = t.insert.toString();
	e.inputState.composing >= 0 && e.inputState.composing++;
	let o, s = () => o ||= Ui(e, t, n);
	return e.state.facet(lr).some((n) => n(e, t.from, t.to, a, s)) || e.dispatch(s()), !0;
}
function Ui(e, t, n) {
	let r, i = e.state, a = i.selection.main, o = -1;
	if (t.from == t.to && t.from < a.from || t.from > a.to) {
		let n = t.from < a.from ? -1 : 1, r = n < 0 ? a.from : a.to, s = Oi(i.facet(Or).map((t) => t(e)), r, n);
		t.from == s && (o = s);
	}
	if (o > -1) r = {
		changes: t,
...
function Gi(e) {
	...
	return n && (t.push(new Ri(n, r)), (i != n || a != r) && t.push(new Ri(i, a))), t;
}
function Ki(e, t) {
...
var Ji = class {
	...
	ensureHandlers(e) {
		let t = Zi(e), n = this.handlers, r = this.view.contentDOM;
	...
	keydown(e) {
		...
		if (this.tabFocusMode > 0 && e.keyCode != 27 && ea.indexOf(e.keyCode) < 0 && (this.tabFocusMode = -1), N.android && N.chrome && !e.synthetic && (e.keyCode == 13 || e.keyCode == 8)) return this.view.observer.delayAndroidKey(e.key, e.keyCode), !0;
		if (N.ios && !e.synthetic && !e.altKey && !e.metaKey && (Qi.some((t) => t.keyCode == e.keyCode) && !e.ctrlKey || $i.indexOf(e.key) > -1 && e.ctrlKey)) {
			let t = {
				ctrlKey: e.ctrlKey,
				altKey: e.altKey,
				metaKey: e.metaKey,
			...
			return t.shiftKey && N.ios && !/^(off|none)$/.test(this.view.contentDOM.autocapitalize) && Yi(this.view.win) && (t.shiftKey = !1), this.pendingIOSKey = {
				key: e.key,
				keyCode: e.keyCode,
				mods: t
	...
	flushIOSKey(e) {
		...
		return !t || t.key == "Enter" && e && e.from < e.to && /^\S+$/.test(e.insert.toString()) ? !1 : (this.pendingIOSKey = void 0, An(this.view.contentDOM, t.key, t.keyCode, t.mods));
	}
...
function Zi(e) {
	...
	for (let t of e) {
		...
		if (r) for (let e in r) {
			let i = r[e];
			i && n(e).handlers.push(Xi(t.value, i));
		}
		if (i) for (let e in i) {
			let r = i[e];
			r && n(e).observers.push(Xi(t.value, r));
		}
	}
	for (let e in la) n(e).handlers.push(la[e]);
	for (let e in H) n(e).observers.push(H[e]);
	return t;
}
var Qi = [
	{
...
var ia = class {
	constructor(e, t, n, r) {
		this.view = e, this.startEvent = t, this.style = n, this.mustSelect = r, this.scrollSpeed = {
			x: 0,
			y: 0
		}, this.scrolling = -1, this.lastEvent = t, this.scrollParents = Sn(e.contentDOM), this.atoms = e.state.facet(Or).map((t) => t(e));
		let i = e.contentDOM.ownerDocument;
		i.addEventListener("mousemove", this.move = this.move.bind(this)), i.addEventListener("mouseup", this.up = this.up.bind(this)), this.extend = t.shiftKey, this.multiple = e.state.facet(k.allowMultipleSelections) && aa(e, t), this.dragging = sa(e, t) && ya(t) == 1 ? null : !1;
	}
	start(e) {
	...
	move(e) {
		...
		let s = Mr(this.view);
		e.clientX - s.left <= r + ta ? t = -na(r - e.clientX) : e.clientX + s.right >= a - ta && (t = na(e.clientX - a)), e.clientY - s.top <= i + ta ? n = -na(i - e.clientY) : e.clientY + s.bottom >= o - ta && (n = na(e.clientY - o)), this.setScrollSpeed(t, n);
	}
	up(e) {
	...
	select(e) {
		let { view: t } = this, n = ki(this.atoms, this.style.get(e, this.extend, this.multiple));
...
var la = /*@__PURE__*/ Object.create(null), H = /*@__PURE__*/ Object.create(null), ua = N.ie && N.ie_version < 15 || N.ios && N.webkit_version < 604;
function da(e) {
...
function pa(e, t) {
	...
	if (Ta != null && n.selection.ranges.every((e) => e.empty) && Ta == a.toString()) {
		let e = -1;
		r = n.changeByRange((r) => {
...
H.scroll = (e) => {
...
}, H.wheel = H.mousewheel = (e) => {
	e.inputState.lastWheelEvent = Date.now();
}, la.keydown = (e, t) => (e.inputState.setSelectionOrigin("select"), t.keyCode == 27 && e.inputState.tabFocusMode != 0 && (e.inputState.tabFocusMode = Date.now() + 2e3), !1), H.touchstart = (e, t) => {
	...
	let n = null;
	for (let r of e.state.facet(or)) if (n = r(e, t), n) break;
	if (!n && t.button == 0 && (n = ba(e, t)), n) {
		let r = !e.hasFocus;
		e.inputState.startMouseSelection(new ia(e, t, n, r)), r && e.observer.ignore(() => {
			Dn(e.contentDOM);
...
var ha = N.ie && N.ie_version <= 11, ga = null, _a = 0, va = 0;
function ya(e) {
	if (!ha) return e.detail;
	let t = ga, n = va;
	return ga = e, va = Date.now(), _a = !t || n > Date.now() - 400 && Math.abs(t.clientX - e.clientX) < 2 && Math.abs(t.clientY - e.clientY) < 2 ? (_a + 1) % 3 : 1;
}
function ba(e, t) {
	let n = e.posAndSideAtCoords({
		x: t.clientX,
		y: t.clientY
	}, !1), r = ya(t), i = e.state.selection;
	return {
		update(e) {
		...
		get(t, a, o) {
			let s = e.posAndSideAtCoords({
				x: t.clientX,
				y: t.clientY
			}, !1), c, l = ma(e, s.pos, s.assoc, r);
			if (n.pos != s.pos && !a) {
				let t = ma(e, n.pos, n.assoc, r), i = Math.min(t.from, l.from), a = Math.max(t.to, l.to);
				l = i < l.from ? T.range(i, a, l.assoc) : T.range(a, i, l.assoc);
			}
			return a ? i.replaceRange(i.main.extend(l.from, l.to, l.assoc)) : o && r == 1 && i.ranges.length > 1 && (c = xa(i, s.pos)) ? c : o ? i.addRange(l) : T.create([l]);
		}
	};
}
function xa(e, t) {
...
la.dragstart = (e, t) => {
	...
	let { inputState: r } = e;
	return r.mouseSelection && (r.mouseSelection.dragging = !0), r.draggedContent = n, t.dataTransfer && (t.dataTransfer.setData("Text", fa(e.state, fr, e.state.sliceDoc(n.from, n.to))), t.dataTransfer.effectAllowed = "copyMove"), !1;
}, la.dragend = (e) => (e.inputState.draggedContent = null, !1);
function Sa(e, t, n, r) {
	if (n = fa(e.state, dr, n), !n) return;
	let i = e.posAtCoords({
		x: t.clientX,
		y: t.clientY
	}, !1), { draggedContent: a } = e.inputState, o = r && a && oa(e, t) ? {
		from: a.from,
		to: a.to
	} : null, s = {
		from: i,
...
la.drop = (e, t) => {
	...
	if (n && n.length) {
		let r = Array(n.length), i = 0, a = () => {
			++i == n.length && Sa(e, t, r.filter((e) => e != null).join(e.state.lineBreak), !1);
		};
	...
	}
	{
		...
		if (n) return Sa(e, t, n, !0), !0;
	}
	return !1;
}, la.paste = (e, t) => {
	if (e.state.readOnly) return !0;
	e.observer.flush();
	let n = ua ? null : t.clipboardData;
	return n ? (pa(e, n.getData("text/plain") || n.getData("text/uri-list")), !0) : (da(e), !1);
};
function Ca(e, t) {
...
function wa(e) {
	...
	return {
		text: fa(e, fr, t.join(e.lineBreak)),
		ranges: n,
		linewise: r
	};
}
...
la.copy = la.cut = (e, t) => {
	...
	if (!n && !i) return !1;
	Ta = i ? n : null, t.type == "cut" && !e.state.readOnly && e.dispatch({
		changes: r,
		scrollIntoView: !0,
		userEvent: "delete.cut"
	});
	let a = ua ? null : t.clipboardData;
	return a ? (a.clearData(), a.setData("text/plain", n), !0) : (Ca(e, n), !1);
};
var Ea = /*@__PURE__*/ Ve.define();
function Da(e, t) {
	let n = [];
	for (let r of e.facet(ur)) {
		let i = r(e, t);
		i && n.push(i);
	}
...
H.focus = (e) => {
	e.inputState.lastFocusTime = Date.now(), !e.scrollDOM.scrollTop && (e.inputState.lastScrollTop || e.inputState.lastScrollLeft) && (e.scrollDOM.scrollTop = e.inputState.lastScrollTop, e.scrollDOM.scrollLeft = e.inputState.lastScrollLeft), Oa(e);
}, H.blur = (e) => {
	e.observer.clearSelectionRange(), Oa(e);
}, H.compositionstart = H.compositionupdate = (e) => {
	...
	let n;
	if (N.chrome && N.android && (n = Qi.find((e) => e.inputType == t.inputType)) && (e.observer.delayAndroidKey(n.key, n.keyCode), n.key == "Backspace" || n.key == "Delete")) {
		let t = window.visualViewport?.height || 0;
		setTimeout(() => {
			(window.visualViewport?.height || 0) > t + 10 && e.hasFocus && (e.contentDOM.blur(), e.focus());
		}, 100);
	}
	return N.ios && t.inputType == "deleteContentForward" && e.observer.flushSoon(), N.safari && t.inputType == "insertText" && e.inputState.composing >= 0 && setTimeout(() => H.compositionend(e, t), 20), !1;
};
var ka = /*@__PURE__*/ new Set();
function Aa(e) {
	ka.has(e) || (ka.add(e), e.addEventListener("copy", () => {}), e.addEventListener("cut", () => {}));
}
var ja = [
	"pre-wrap",
	"normal",
...
var Pa = class {
	...
	refresh(e, t, n, r, i, a) {
		let o = ja.indexOf(e) > -1, s = Math.abs(t - this.lineHeight) > .3 || this.lineWrapping != o;
	...
	setHeight(e) {
		this.height != e && (Math.abs(this.height - e) > La && (Ma = !0), this.height = e);
	}
	replace(t, n, r) {
		return e.of(r);
	}
	...
	applyChanges(e, t, n, r) {
		...
		for (let o = r.length - 1; o >= 0; o--) {
			...
			l += d.from - s, s = d.from;
			let p = qa.build(n.setDoc(a), e, l, u);
			i = za(i, i.replace(s, c, p));
		}
	...
	static of(t) {
		...
		let o = 0;
		return t[n - 1] == null ? (o = 1, n--) : t[n] ?? (o = 1, r++), new Wa(e.of(t.slice(0, n)), o, e.of(t.slice(r)));
	}
};
function za(e, t) {
	return e == t ? e : (e.constructor != t.constructor && (Ma = !0), t);
}
Ra.prototype.size = 1;
var Ba = /*@__PURE__*/ F.replace({}), Va = class extends Ra {
	constructor(e, t, n) {
		super(e, t), this.deco = n, this.spaceAbove = 0;
	}
	mainBlock(e, t) {
		return new Ia(t, this.length, e + this.spaceAbove, this.height - this.spaceAbove, this.deco || 0);
	}
	blockAt(e, t, n, r) {
		return this.spaceAbove && e < n + this.spaceAbove ? new Ia(r, 0, n, this.spaceAbove, Ba) : this.mainBlock(n, r);
	}
	lineAt(e, t, n, r, i) {
	...
	mainBlock(e, t) {
		return new Ia(t, this.length, e + this.spaceAbove, this.height - this.spaceAbove, this.breaks);
	}
	replace(t, n, r) {
		let i = r[0];
		return r.length == 1 && (i instanceof e || i instanceof Ua && i.flags & 4) && Math.abs(this.length - i.length) < 10 ? (i instanceof Ua ? i = new e(i.length, this.height, this.spaceAbove) : i.height = this.height, this.outdated || (i.outdated = !1), i) : Ra.of(r);
	}
	updateHeight(e, t = 0, n = !1, r) {
	...
	lineAt(e, t, n, r, i) {
		...
		return new Ia(c.from, c.length, Math.max(r, Math.min(d, r + this.height - l)), l, 0);
	}
	forEachLine(e, t, n, r, i, a) {
		...
		for (let l = e, u = r; l <= t;) {
			...
			let r = s + c * t.length;
			a(new Ia(t.from, t.length, u, r, 0)), u += r, l = t.to + 1;
		}
	}
	replace(t, n, r) {
		let i = this.length - n;
	...
	updateHeight(t, n = 0, r = !1, i) {
		...
		if (i && i.from <= n + this.length && i.more) {
			...
			for (i.from > n && r.push(new e(i.from - n - 1).updateHeight(t, n)); o <= a && i.more;) {
				...
				n < 0 && (a = -n, n = i.heights[i.index++]), s == -1 ? s = n : Math.abs(n - s) >= La && (s = -2);
				let c = new Ha(e, n, a);
				c.outdated = !1, r.push(c), o += e + 1;
			}
			o <= a && r.push(null, new e(a - o).updateHeight(t, o));
			let c = Ra.of(r);
			return (s < 0 || Math.abs(c.height - this.height) >= La || Math.abs(s - this.heightMetrics(t, n).perLine) >= La) && (Ma = !0), za(this, c);
		}
	...
	replace(e, t, n) {
		...
		if (e > 0 && Ga(i, a - 1), t < this.length) {
			let e = i.length;
			this.decomposeRight(t, i), Ga(i, e);
		}
		return Ra.of(i);
	}
	decomposeLeft(e, t) {
	...
	balanced(e, t) {
		return e.size > 2 * t.size || t.size > 2 * e.size ? Ra.of(this.break ? [
			e,
			null,
			t
		] : [e, t]) : (this.left = za(this.left, e), this.right = za(this.right, t), this.setHeight(e.height + t.height), this.outdated = e.outdated || t.outdated, this.size = e.size + t.size, this.length = e.length + this.break + t.length, this);
	}
	updateHeight(e, t = 0, n = !1, r) {
...
function Ga(e, t) {
	let n, r;
	e[t] == null && (n = e[t - 1]) instanceof Ua && (r = e[t + 1]) instanceof Ua && e.splice(t - 1, 3, new Ua(n.length + 1 + r.length));
}
var Ka = 5, qa = class e {
	constructor(e, t) {
	...
	span(e, t) {
		if (this.lineStart > -1) {
			...
			n instanceof Ha ? n.length += e - this.pos : (e > this.pos || !this.isCovered) && this.nodes.push(new Ha(e - this.pos, -1, 0)), this.writtenTo = e, t > e && (this.nodes.push(null), this.writtenTo++, this.lineStart = -1);
		}
		this.pos = t;
	}
	point(e, t, n) {
		if (e < t || n.heightRelevant) {
			...
			let a = t - e;
			n.block ? this.addBlock(new Va(a, r, n)) : (a || i || r >= Ka) && this.addLineDeco(r, i, a);
	...
	enterLine() {
		...
		this.lineStart = e, this.lineEnd = t, this.writtenTo < e && ((this.writtenTo < e - 1 || this.nodes[this.nodes.length - 1] == null) && this.nodes.push(this.blankContent(this.writtenTo, e - 1)), this.nodes.push(null)), this.pos > e && this.nodes.push(new Ha(this.pos - e, -1, 0)), this.writtenTo = this.pos;
	}
	blankContent(e, t) {
		let n = new Ua(t - e);
	...
	finish(e) {
		...
		this.lineStart > -1 && !(t instanceof Ha) && !this.isCovered ? this.nodes.push(new Ha(0, -1, 0)) : (this.writtenTo < this.pos || t == null) && this.nodes.push(this.blankContent(this.writtenTo, this.pos));
		let n = e;
		for (let e of this.nodes) e instanceof Ha && e.updateHeight(this.oracle, n), n += e ? e.length : 1;
		return this.nodes;
	}
...
var $a = class {
	...
	draw(e, t) {
		return F.replace({ widget: new eo(this.displaySize * (t ? e.scaleY : e.scaleX), t) }).range(this.from, this.to);
	}
}, eo = class extends en {
	constructor(e, t) {
	...
	constructor(e, t) {
		this.view = e, this.state = t, this.pixelViewport = {
			...
			top: 0,
			bottom: 0
		}, this.inView = !0, this.paddingTop = 0, this.paddingBottom = 0, this.contentDOMWidth = 0, this.contentDOMHeight = 0, this.editorHeight = 0, this.editorWidth = 0, this.scaleX = 1, this.scaleY = 1, this.scrollOffset = 0, this.scrolledToBottom = !1, this.scrollAnchorPos = 0, this.scrollAnchorHeight = -1, this.scaler = so, this.scrollTarget = null, this.printing = !1, this.mustMeasureContent = !0, this.defaultTextDirection = I.LTR, this.visibleRanges = [], this.mustEnforceCursorAssoc = !1;
		let n = t.facet(wr).some((e) => typeof e != "function" && e.class == "cm-lineWrapping");
		this.heightOracle = new Pa(n), this.stateDeco = co(t), this.heightMap = Ra.empty().applyChanges(this.stateDeco, f.empty, this.heightOracle.setDoc(t.doc), [new Pr(0, 0, 0, t.doc.length)]);
	...
	updateScaler() {
		let e = this.scaler;
		return this.scaler = this.heightMap.height <= 7e6 ? so : new lo(this.heightOracle, this.heightMap, this.viewports), e.eq(this.scaler) ? 0 : 2;
	}
	updateViewportLines() {
		this.viewportLines = [], this.heightMap.forEachLine(this.viewport.from, this.viewport.to, this.heightOracle.setDoc(this.state.doc), 0, 0, (e) => {
			this.viewportLines.push(uo(e, this.scaler));
		});
	}
	update(e, t = null) {
		this.state = e.state;
		...
		let r = e.changedRanges, i = Pr.extendWithRanges(r, Ja(n, this.stateDeco, e ? e.changes : ce.empty(this.state.doc.length))), a = this.heightMap.height, o = this.scrolledToBottom ? null : this.scrollAnchorAt(this.scrollOffset);
		Na(), this.heightMap = this.heightMap.applyChanges(this.stateDeco, e.startState.doc, this.heightOracle.setDoc(this.state.doc), i), (this.heightMap.height != a || Ma) && (e.flags |= 2), o ? (this.scrollAnchorPos = e.changes.mapPos(o.from, -1), this.scrollAnchorHeight = o.top) : (this.scrollAnchorPos = -1, this.scrollAnchorHeight = a);
	...
	measure() {
		...
		this.scrollOffset != m && (this.scrollAnchorHeight = -1, this.scrollOffset = m), this.scrolledToBottom = Nn(this.scrollParent || e.win);
		let h = (this.printing ? Qa : Xa)(t, this.paddingTop), g = h.top - this.pixelViewport.top, _ = h.bottom - this.pixelViewport.bottom;
		...
		if (v != this.inView && (this.inView = v, v && (s = !0)), !this.inView && !this.scrollTarget && !Za(e.dom)) return 0;
		let y = o.width;
		if ((this.contentDOMWidth != y || this.editorHeight != e.scrollDOM.clientHeight) && (this.contentDOMWidth = o.width, this.editorHeight = e.scrollDOM.clientHeight, c |= 16), s) {
			...
			g > 0 && _ > 0 ? l = Math.max(g, _) : g < 0 && _ < 0 && (l = Math.min(g, _)), Na();
			for (let n of this.viewports) {
				let i = n.from == this.viewport.from ? t : e.docView.measureVisibleLineHeights(n);
				this.heightMap = (a ? Ra.empty().applyChanges(this.stateDeco, f.empty, this.heightOracle, [new Pr(0, 0, 0, e.state.doc.length)]) : this.heightMap).updateHeight(r, 0, a, new Fa(n.from, i));
			}
			Ma && (c |= 2);
		}
	...
	getViewport(e, t) {
		let n = .5 - Math.max(-.5, Math.min(.5, e / 1e3 / 2)), r = this.heightMap, i = this.heightOracle, { visibleTop: a, visibleBottom: o } = this, s = new no(r.lineAt(a - n * 1e3, U.ByHeight, i, 0, 0).from, r.lineAt(o + (1 - n) * 1e3, U.ByHeight, i, 0, 0).to);
		if (t) {
			let { head: e } = t.range;
			if (e < s.from || e > s.to) {
				let n = Math.min(this.editorHeight, this.pixelViewport.bottom - this.pixelViewport.top), a = r.lineAt(e, U.ByPos, i, 0, 0), o;
				o = t.y == "center" ? (a.top + a.bottom) / 2 - n / 2 : t.y == "start" || t.y == "nearest" && e < s.from ? a.top : a.bottom - n, s = new no(r.lineAt(o - 500, U.ByHeight, i, 0, 0).from, r.lineAt(o + n + 500, U.ByHeight, i, 0, 0).to);
			}
		}
		return s;
	}
	mapViewport(e, t) {
		...
		return new no(this.heightMap.lineAt(n, U.ByPos, this.heightOracle, 0, 0).from, this.heightMap.lineAt(r, U.ByPos, this.heightOracle, 0, 0).to);
	}
	...
	mapLineGaps(e, t) {
		...
		let n = [];
		for (let r of e) t.touchesRange(r.from, r.to) || n.push(new $a(t.mapPos(r.from), t.mapPos(r.to), r.size, r.displaySize));
		return n;
	}
	ensureLineGaps(e, t) {
		...
		let o = [], s = (r, a, c, l) => {
			...
			if (!f) {
				...
				f = new $a(r, a, e, n || e < 2e6 ? e : 2e6);
			}
			o.push(f);
		}, c = (t) => {
			if (t.length < a || t.type != P.Text) return;
			let i = ro(t.from, t.to, this.stateDeco);
			if (i.total < a) return;
			...
			if (n) {
				...
				if (o != null) {
					let r = ao(i, o), s = ((this.visibleBottom - this.visibleTop) / 2 + e) / t.height;
					n = r - s, a = r + s;
	...
	updateLineGaps(e) {
		$a.same(e, this.lineGaps) || (this.lineGaps = e, this.lineGapDeco = F.set(e.map((e) => e.draw(this, this.heightOracle.lineWrapping))));
	}
	...
	lineBlockAt(e) {
		return e >= this.viewport.from && e <= this.viewport.to && this.viewportLines.find((t) => t.from <= e && t.to >= e) || uo(this.heightMap.lineAt(e, U.ByPos, this.heightOracle, 0, 0), this.scaler);
	}
	lineBlockAtHeight(e) {
		return e >= this.viewportLines[0].top && e <= this.viewportLines[this.viewportLines.length - 1].bottom && this.viewportLines.find((t) => t.top <= e && t.bottom >= e) || uo(this.heightMap.lineAt(this.scaler.fromDOM(e), U.ByHeight, this.heightOracle, 0, 0), this.scaler);
	}
	getScrollOffset() {
	...
	elementAtHeight(e) {
		return uo(this.heightMap.blockAt(this.scaler.fromDOM(e), this.heightOracle, 0, 0), this.scaler);
	}
	get docHeight() {
...
function io({ total: e, ranges: t }, n) {
...
function co(e) {
	let t = e.facet(Tr).filter((e) => typeof e != "function"), n = e.facet(Dr).filter((e) => typeof e != "function");
...
function uo(e, t) {
	...
	return new Ia(e.from, e.length, n, r - n, Array.isArray(e._content) ? e._content.map((e) => uo(e, t)) : e._content);
}
var fo = /*@__PURE__*/ E.define({ combine: (e) => e.join(" ") }), po = /*@__PURE__*/ E.define({ combine: (e) => e.indexOf(!0) > -1 }), mo = /*@__PURE__*/ Dt.newName(), ho = /*@__PURE__*/ Dt.newName(), go = /*@__PURE__*/ Dt.newName(), _o = {
	"&light": "." + ho,
	"&dark": "." + go
};
function vo(e, t, n) {
...
var yo = /*@__PURE__*/ vo("." + mo, {
...
}, xo = N.ie && N.ie_version <= 11, So = class {
	constructor(e) {
		...
		}), window.EditContext && N.android && e.constructor.EDIT_CONTEXT !== !1 && !(N.chrome && N.chrome_version < 126) && (this.editContext = new Eo(e), e.state.facet(yr) && (e.contentDOM.editContext = this.editContext.editContext)), xo && (this.onCharData = (e) => {
			this.queue.push({
				target: e.target,
				type: "characterData",
	...
	onSelectionChange(e) {
		...
		if (n.state.facet(yr) ? n.root.activeElement != this.dom : !dn(this.dom, r)) return;
	...
	readSelectionRange() {
		...
		if (!t) return !1;
		let n = N.safari && e.root.nodeType == 11 && e.root.activeElement == this.dom && To(this.view, t) || t;
		if (!n || this.selectionRange.eq(n)) return !1;
		let r = dn(this.dom, n);
		return r && !this.selectionChanged && e.inputState.lastFocusTime > Date.now() - 200 && e.inputState.lastTouchTime < Date.now() - 300 && Mn(this.dom, n) ? (this.view.inputState.lastFocusTime = 0, e.docView.updateSelection(), !1) : (this.selectionRange.setRange(n), r && (this.selectionChanged = !0), !0);
	}
	...
	start() {
		this.active ||= (this.observer.observe(this.dom, bo), xo && this.dom.addEventListener("DOMCharacterDataModified", this.onCharData), !0);
	}
	stop() {
	...
	delayAndroidKey(e, t) {
		if (!this.delayedAndroidKey) {
			let e = () => {
				...
				e && (this.clearDelayedAndroidKey(), this.view.inputState.lastKeyCode = e.keyCode, this.view.inputState.lastKeyTime = Date.now(), !this.flush() && e.force && An(this.dom, e.key, e.keyCode));
			};
	...
	flush(e = !0) {
		...
		let n = this.view.state, r = Vi(this.view, t);
		return this.view.state == n && (t.domChanged || t.newSel && !qi(this.view.state.selection, t.newSel.main)) && this.view.update([]), r;
	}
	readMutation(e) {
		let t = this.view.docView.tile.nearest(e.target);
		if (!t || t.isWidget()) return null;
		if (t.markDirty(e.type == "attributes"), e.type == "childList") {
			let n = Co(t, e.previousSibling || e.target.previousSibling, -1), r = Co(t, e.nextSibling || e.target.nextSibling, 1);
			return {
...
var Eo = class {
	constructor(e) {
		...
		this.handlers.textupdate = (n) => {
			...
			let l = Wi(e.state.sliceDoc(o, s), n.text, (c ? r.from : r.to) - o, c ? "end" : null);
			if (!l) {
			...
			if ((N.mac || N.android) && u.from == a - 1 && /^\. ?$/.test(n.text) && e.contentDOM.getAttribute("autocorrect") == "off" && (u = {
				...
				Hi(e, u, T.single(this.toEditorPos(n.selectionStart, t), this.toEditorPos(n.selectionEnd, t)));
			}
			...
			e.dispatch({ effects: vr.of(F.set(n)) });
	...
	constructor(e = {}) {
		...
		let { dispatch: t } = e;
		this.dispatchTransactions = e.dispatchTransactions || t && ((e) => e.forEach((e) => t(e, this))) || ((e) => this.update(e)), this.dispatch = this.dispatch.bind(this), this._root = e.root || jn(e.parent) || document, this.viewState = new to(this, e.state || k.create(e)), e.scrollTo && e.scrollTo.is(_r) && (this.viewState.scrollTarget = e.scrollTo.value.clip(this.viewState.state)), this.plugins = this.state.facet(xr).map((e) => new Sr(e));
		for (let e of this.plugins) e.update(this);
		this.observer = new So(this), this.inputState = new Ji(this), this.inputState.ensureHandlers(this.plugins), this.docView = new ci(this), this.mountStyles(), this.updateAttrs(), this.updateState = 0, this.requestMeasure(), document.fonts?.ready && document.fonts.ready.then(() => {
	...
	update(t) {
		...
		t.some((e) => e.annotation(Ea)) ? (this.inputState.notifiedFocused = o, s = 1) : o != this.inputState.notifiedFocused && (this.inputState.notifiedFocused = o, c = Da(a, o), c || (s = 1));
		...
		i = Fr.create(this, a, t), i.flags |= s;
		...
		try {
			...
			for (let n of t) {
				if (d &&= d.map(n.changes), n.scrollIntoView) {
					...
					d = new gr(t.empty ? t : T.cursor(t.head, t.head > t.anchor ? -1 : 1), "nearest", "nearest", i, r);
				}
				for (let e of n.effects) e.is(_r) && (d = e.value.clip(this.state));
			}
			this.viewState.update(i, d), this.bidiCache = ko.update(this.bidiCache, i.changes), i.empty || (this.updatePlugins(i), this.inputState.update(i)), n = this.docView.update(i), this.state.facet(Nr) != this.styleModules && this.mountStyles(), r = this.updateAttrs(), this.showAnnouncements(t), this.docView.updateSelection(n, t.some((e) => e.isUserEvent("select.pointer")));
		} finally {
			this.updateState = 0;
		}
		if (i.startState.facet(fo) != i.state.facet(fo) && (this.viewState.mustMeasureContent = !0), (n || r || d || this.viewState.mustEnforceCursorAssoc || this.viewState.mustMeasureContent) && this.requestMeasure(), n && this.docViewUpdate(), !i.empty) for (let e of this.state.facet(cr)) try {
			e(i);
		} catch (e) {
			R(this.state, e, "update listener");
		}
		(c || u) && Promise.resolve().then(() => {
			c && this.state == c.startState && this.dispatch(c), u && !Vi(this, u) && l.force && An(this.contentDOM, l.key, l.keyCode);
		});
	}
	setState(e) {
		...
		try {
			...
			this.viewState = new to(this, e), this.plugins = e.facet(xr).map((e) => new Sr(e)), this.pluginMap.clear();
			for (let e of this.plugins) e.update(this);
	...
	updatePlugins(e) {
		let t = e.startState.facet(xr), n = e.state.facet(xr);
		if (t != n) {
			let r = [];
			for (let i of n) {
				let n = t.indexOf(i);
				if (n < 0) r.push(new Sr(i));
				else {
	...
	measure(e = !0) {
		...
		try {
			for (let e = 0;; e++) {
				if (a < 0) {
					if (Nn(n || this.win)) i = -1, a = this.viewState.heightMap.height;
					else {
				...
				let c = s.map((e) => {
					try {
						...
						return R(this.state, e), Oo;
					}
				}), l = Fr.create(this, this.state, []), u = !1;
				...
				for (let e = 0; e < s.length; e++) if (c[e] != Oo) try {
					let t = s[e];
	...
	get themeClasses() {
		return mo + " " + (this.state.facet(po) ? go : ho) + " " + this.state.facet(fo);
	}
	updateAttrs() {
		let e = Ao(this, Cr, { class: "cm-editor" + (this.hasFocus ? " cm-focused " : " ") + this.themeClasses }), t = {
			spellcheck: "false",
			autocorrect: "off",
			autocapitalize: "off",
			writingsuggestions: "false",
			translate: "no",
			contenteditable: this.state.facet(yr) ? "true" : "false",
			class: "cm-content",
			style: `${N.tabSize}: ${this.state.tabSize}`,
			role: "textbox",
			"aria-multiline": "true"
		};
		this.state.readOnly && (t["aria-readonly"] = "true"), Ao(this, wr, t);
	...
	mountStyles() {
		...
		Dt.mount(this.root, this.styleModules.concat(yo).reverse(), t ? { nonce: t } : void 0);
	}
	readMeasured() {
	...
	moveByChar(e, t, n) {
		return Ai(this, e, Ti(this, e, t, n));
	}
	moveByGroup(e, t) {
		return Ai(this, e, Ti(this, e, t, (t) => Ei(this, e.head, t)));
	}
	visualLineSide(e, t) {
	...
	moveVertically(e, t, n) {
		return Ai(this, e, Di(this, e, t, n));
	}
	domAtPos(e, t = 1) {
	...
	posAndSideAtCoords(e, t = !0) {
		return this.readMeasured(), Mi(this, e, t);
	}
	coordsAtPos(e, t = 1) {
		this.readMeasured();
		let n = this.state.doc.lineAt(e), r = this.bidiSpans(n), i = r[Kn.find(r, e - n.from, -1, t)];
	...
	bidiSpans(e) {
		if (e.length > Do) return er(e.length);
		let t = this.textDirectionAt(e.from), n;
		for (let r of this.bidiCache) if (r.from == e.from && r.dir == t && (r.fresh || qn(r.isolates, n = Ar(this, e)))) return r.order;
		n ||= Ar(this, e);
		let r = $n(e.text, t, n);
		return this.bidiCache.push(new ko(e.from, e.to, t, n, !0, r)), r;
	}
	get hasFocus() {
	...
	static scrollIntoView(e, t = {}) {
		return _r.of(new gr(typeof e == "number" ? T.cursor(e) : e, t.y ?? "nearest", t.x ?? "nearest", t.yMargin ?? 5, t.xMargin ?? 5));
	}
	scrollSnapshot() {
		let { scrollTop: e, scrollLeft: t } = this.scrollDOM, n = this.viewState.scrollAnchorAt(e);
		return _r.of(new gr(T.cursor(n.from), "start", "start", n.top - e, t, !0));
	}
	setTabFocusMode(e) {
	...
	static theme(e, t) {
		let n = Dt.newName(), r = [fo.of(n), Nr.of(vo(`.${n}`, e))];
		return t && t.dark && r.push(po.of(!0)), r;
	}
	static baseTheme(e) {
		return Ee.lowest(Nr.of(vo("." + mo, e, _o)));
	}
...
W.styleModule = Nr, W.inputHandler = lr, W.clipboardInputFilter = dr, W.clipboardOutputFilter = fr, W.scrollHandler = hr, W.focusChangeEffect = ur, W.perLineTextDirection = pr, W.exceptionSink = sr, W.updateListener = cr, W.editable = yr, W.mouseSelectionStyle = or, W.dragMovesSelection = ar, W.clickAddsSelectionRange = ir, W.decorations = Tr, W.blockWrappers = Er, W.outerDecorations = Dr, W.atomicRanges = Or, W.bidiIsolatedRanges = kr, W.cursorScrollMargin = /*@__PURE__*/ E.define({ combine: (e) => {
	let t = 5, n = 5;
...
} }), W.scrollMargins = jr, W.darkTheme = po, W.cspNonce = /*@__PURE__*/ E.define({ combine: (e) => e.length ? e[0] : "" }), W.contentAttributes = wr, W.editorAttributes = Cr, W.lineWrapping = /*@__PURE__*/ W.contentAttributes.of({ class: "cm-lineWrapping" }), W.announce = /*@__PURE__*/ D.define();
var Do = 4096, Oo = {}, ko = class e {
	constructor(e, t, n, r, i, a) {
...
var jo = N.mac ? "mac" : N.windows ? "win" : N.linux ? "linux" : "key";
function Mo(e, t) {
...
var Po = /*@__PURE__*/ Ee.default(/*@__PURE__*/ W.domEventHandlers({ keydown(e, t) {
	return Uo(Lo(t.state), e, t, "editor");
} })), Fo = /*@__PURE__*/ E.define({ enables: Po }), Io = /*@__PURE__*/ new WeakMap();
function Lo(e) {
	let t = e.facet(Fo), n = Io.get(t);
	return n || Io.set(t, n = Vo(t.reduce((e, t) => e.concat(t), []))), n;
}
function Ro(e, t, n) {
	return Uo(Lo(e.state), t, e, n);
}
var zo = null, Bo = 4e3;
function Vo(e, t = jo) {
	let n = Object.create(null), r = Object.create(null), i = (e, t) => {
		...
		let c = n[e] || (n[e] = Object.create(null)), l = r.split(/ (?!$)/).map((e) => Mo(e, t));
	...
	for (let r of e) {
		...
		if (r.any) for (let t of e) {
			...
			let { any: i } = r;
			for (let t in e) e[t].run.push((e) => i(e, Ho));
		}
		let i = r[t] || r.key;
...
function Uo(e, t, n, r) {
	...
	zo && zo.view == n && zo.scope == r && (o = zo.prefix + " ", ea.indexOf(t.keyCode) < 0 && (c = !0, zo = null));
	...
	return f && (d(f[o + No(i, t, !a)]) ? s = !0 : a && (t.altKey || t.metaKey || t.ctrlKey) && !(N.windows && t.ctrlKey && t.altKey) && !(N.mac && t.altKey && !(t.ctrlKey || t.metaKey)) && (p = At[t.keyCode]) && p != i ? (d(f[o + No(p, t, !0)]) || t.shiftKey && (m = jt[t.keyCode]) != i && m != p && d(f[o + No(m, t, !1)])) && (s = !0) : a && t.shiftKey && d(f[o + No(i, t, !0)]) && (s = !0), !s && d(f._any) && (s = !0)), c && (s = !0), s && l && t.stopPropagation(), Ho = null, s;
}
var Wo = class e {
	constructor(e, t, n, r, i) {
...
function Go(e) {
	...
	return {
		left: (e.textDirection == I.LTR ? t.left : t.right - e.scrollDOM.clientWidth * e.scaleX) - e.scrollDOM.scrollLeft * e.scaleX,
...
function qo(e, t, n) {
	...
	let r = Math.max(n.from, e.viewport.from), i = Math.min(n.to, e.viewport.to), a = e.textDirection == I.LTR, o = e.contentDOM, s = o.getBoundingClientRect(), c = Go(e), l = o.querySelector(".cm-line"), u = l && window.getComputedStyle(l), d = s.left + (u ? parseInt(u.paddingLeft) + Math.min(0, parseInt(u.textIndent)) : 0), f = s.right - (u ? parseInt(u.paddingRight) : 0), p = Ci(e, r, 1), m = Ci(e, i, -1), h = p.type == P.Text ? p : null, g = m.type == P.Text ? m : null;
	if (h && (e.lineWrapping || p.widgetLineBreaks) && (h = Ko(e, r, 1, h)), g && (e.lineWrapping || m.widgetLineBreaks) && (g = Ko(e, i, -1, g)), h && g && h.from == g.from && h.to == g.to) return v(y(n.from, n.to, h));
	{
		let t = h ? y(n.from, null, h) : ee(p, !1), r = g ? y(null, n.to, g) : ee(m, !0), i = [];
		return (h || p).to < (g || m).from - (h && g ? 1 : 0) || p.widgetLineBreaks > 1 && t.bottom + e.defaultLineHeight / 2 < r.top ? i.push(_(d, t.bottom, f, r.top)) : t.bottom < r.top && e.elementAtHeight((t.bottom + r.top) / 2).type == P.Text && (t.bottom = r.top = (t.bottom + r.top) / 2), v(t).concat(i).concat(v(r));
	}
	function _(e, n, r, i) {
		return new Wo(t, e - c.left, n - c.top, Math.max(0, r - e), i - n);
	}
	...
	function y(t, n, r) {
		...
		function c(t, n, c, l, u) {
			...
			!p || !m || (i = Math.min(p.top, m.top, i), o = Math.max(p.bottom, m.bottom, o), u == I.LTR ? s.push(a && n ? d : p.left, a && l ? f : m.right) : s.push(!a && l ? d : m.left, !a && n ? f : p.right));
		}
...
var Yo = class {
	...
	update(e) {
		e.startState.facet(Xo) != e.state.facet(Xo) && this.setOrder(e.state), (this.layer.update(e, this.dom) || e.geometryChanged) && (this.scale(), e.view.requestMeasure(this.measureReq));
	}
	docViewUpdate(e) {
		this.layer.updateOnDocViewUpdate !== !1 && e.requestMeasure(this.measureReq);
	}
	setOrder(e) {
		let t = 0, n = e.facet(Xo);
	...
	draw(e) {
		if (e.length != this.drawn.length || e.some((e, t) => !Jo(e, this.drawn[t]))) {
			...
			this.drawn = e, N.webkit && (this.dom.style.display = this.dom.firstChild ? "" : "none");
		}
	}
	destroy() {
		this.layer.destroy && this.layer.destroy(this.dom, this.view), this.dom.remove();
	}
}, Xo = /*@__PURE__*/ E.define();
function Zo(e) {
	return [z.define((t) => new Yo(t, e)), Xo.of(e)];
}
var Qo = /*@__PURE__*/ E.define({ combine(e) {
	return rt(e, {
...
function rs(e, t) {
	t.style.animationDuration = e.facet(Qo).cursorBlinkRate + "ms";
}
var is = /*@__PURE__*/ Zo({
	above: !1,
	markers(e) {
		let t = [], { main: n, ranges: r } = e.state.selection;
		for (let n of r) if (!n.empty) for (let r of Wo.forRange(e, "cm-selectionBackground", n)) t.push(r);
		if (N.ios && !n.empty && e.state.facet(Qo).iosSelectionHandles) {
			for (let r of Wo.forRange(e, "cm-selectionHandle cm-selectionHandle-start", T.cursor(n.from, 1))) t.push(r);
			for (let r of Wo.forRange(e, "cm-selectionHandle cm-selectionHandle-end", T.cursor(n.to, 1))) t.push(r);
		}
		return t;
	},
	update(e, t) {
		return e.docChanged || e.selectionSet || e.viewportChanged || ts(e);
	},
	class: "cm-selectionLayer"
}), as = N.gecko && N.gecko_version == 153 ? "#ffffff01" : "transparent", os = /*@__PURE__*/ Ee.highest(/*@__PURE__*/ W.theme({
	".cm-line": {
...
})), ss = /*@__PURE__*/ D.define({ map(e, t) {
	return e == null ? null : t.mapPos(e);
} }), cs = /*@__PURE__*/ Ce.define({
	create() {
		return null;
	},
	update(e, t) {
...
var ps = class {
	...
	createDeco(e) {
		let t = new ut(), n = t.add.bind(t);
		for (let { from: t, to: r } of fs(e, this.maxLength)) ds(e.state.doc, this.regexp, t, r, (t, r) => this.addMatch(r, e, t, n));
		return t.finish();
	}
	updateDeco(e, t) {
		let n = 1e9, r = -1;
	...
	updateRange(e, t, n, r) {
		for (let i of e.visibleRanges) {
			...
			if (o >= a) {
				...
				else ds(e.state.doc, this.regexp, s, c, (t, n) => this.addMatch(n, e, t, d));
				t = t.update({
					filterFrom: s,
					filterTo: c,
					filter: (e, t) => e < s || t > c,
...
}, ms = /x/.unicode == null ? "g" : "gu", hs = /*@__PURE__*/ RegExp("[\0-\b\n--­؜​‎‏\u2028\u2029‭‮⁦⁧⁩﻿￹-￼]", ms), gs = {
	0: "null",
	7: "bell",
	8: "backspace",
	10: "newline",
...
function vs() {
	if (_s == null && typeof document < "u" && document.body) {
		...
		_s = (e.tabSize ?? e.MozTabSize) != null;
	}
	return _s || !1;
}
var ys = /*@__PURE__*/ E.define({ combine(e) {
	...
	return (t.replaceTabs = !vs()) && (t.specialChars = RegExp("	|" + t.specialChars.source, ms)), t.addSpecialChars && (t.specialChars = RegExp(t.specialChars.source + "|" + t.addSpecialChars.source, ms)), t;
} });
function bs(e = {}) {
	return [ys.of(e), Ss()];
}
var xs = null;
function Ss() {
	return xs ||= z.fromClass(class {
		constructor(e) {
			this.view = e, this.decorations = F.none, this.decorationCache = Object.create(null), this.decorator = this.makeDecorator(e.state.facet(ys)), this.decorations = this.decorator.createDeco(e);
		}
		makeDecorator(e) {
			return new ps({
				regexp: e.specialChars,
				decoration: (t, n, r) => {
					let { doc: i } = n.state, a = re(t[0], 0);
					if (a == 9) {
						let e = i.lineAt(r), t = n.state.tabSize, a = xt(e.text, t, r - e.from);
						return F.replace({ widget: new Es((t - a % t) * this.view.defaultCharacterWidth / this.view.scaleX) });
					}
					return this.decorationCache[a] || (this.decorationCache[a] = F.replace({ widget: new Ts(e, a) }));
				},
		...
		update(e) {
			...
			e.startState.facet(ys) == t ? this.decorations = this.decorator.updateDeco(e, this.decorations) : (this.decorator = this.makeDecorator(t), this.decorations = this.decorator.createDeco(e.view));
		}
	}, { decorations: (e) => e.decorations });
}
var Cs = "•";
function ws(e) {
	return e >= 32 ? Cs : e == 10 ? "␤" : String.fromCharCode(9216 + e);
}
var Ts = class extends en {
	constructor(e, t) {
	...
	toDOM(e) {
		let t = ws(this.code), n = e.state.phrase("Control character") + " " + (gs[this.code] || "0x" + this.code.toString(16)), r = this.options.render && this.options.render(this.code, n, t);
		if (r) return r;
...
var Os = /*@__PURE__*/ F.line({ class: "cm-activeLine" }), ks = /*@__PURE__*/ z.fromClass(class {
	constructor(e) {
	...
	getDeco(e) {
		...
		for (let r of e.state.selection.ranges) {
			...
			i.from > t && (n.push(Os.range(i.from)), t = i.from);
		}
		return F.set(n);
	}
}, { decorations: (e) => e.decorations }), As = 2e3;
function js(e, t, n) {
	let r = Math.min(t.line, n.line), i = Math.max(t.line, n.line), a = [];
	if (t.off > As || n.off > As || t.col < 0 || n.col < 0) {
		...
		for (let t = r; t <= i; t++) {
			let n = e.doc.line(t), r = St(n.text, o, e.tabSize, !0);
			if (r < 0) a.push(T.cursor(n.to));
			else {
				let t = St(n.text, s, e.tabSize);
...
function Ns(e, t) {
	let n = e.posAtCoords({
		x: t.clientX,
		y: t.clientY
	}, !1), r = e.state.doc.lineAt(n), i = n - r.from, a = i > As ? -1 : i == r.length ? Ms(e, t.clientX) : xt(r.text, e.state.tabSize, n - r.from);
	return {
		line: r.number,
		col: a,
		off: i
...
function Ps(e, t) {
	let n = Ns(e, t), r = e.state.selection;
	return n ? {
		update(e) {
			if (e.docChanged) {
...
function Fs(e) {
	...
	return W.mouseSelectionStyle.of((e, n) => t(n) ? Ps(e, n) : null);
}
var Is = {
	Alt: [18, (e) => !!e.altKey],
...
function Rs(e = {}) {
	let [t, n] = Is[e.key || "Alt"], r = z.fromClass(class {
		constructor(e) {
	...
	return [r, W.contentAttributes.of((e) => e.plugin(r)?.isDown ? Ls : null)];
}
var zs = "-10000px", Bs = class {
	constructor(e, t, n, r) {
...
var Hs = /*@__PURE__*/ E.define({ combine: (e) => ({
	...
	constructor(e) {
		...
		this.position = t.position, this.parent = t.parent, this.classes = e.themeClasses, this.createContainer(), this.measureReq = {
			...
			key: this
		}, this.resizeObserver = typeof ResizeObserver == "function" ? new ResizeObserver(() => this.measureSoon()) : null, this.manager = new Bs(e, Js, (e, t) => this.createTooltip(e, t), (e) => {
	...
	update(e) {
		...
		let n = t || e.geometryChanged, r = e.state.facet(Hs);
	...
	createTooltip(e, t) {
		...
		return n.dom.style.position = this.position, n.dom.style.top = zs, n.dom.style.left = "0px", this.container.insertBefore(n.dom, r), n.mount && n.mount(this.view), this.resizeObserver && this.resizeObserver.observe(n.dom), n;
	}
	destroy() {
		var e, t, n;
	...
	readMeasure() {
		...
		let r = this.view.scrollDOM.getBoundingClientRect(), i = Mr(this.view);
		return {
			visible: {
				left: r.left + i.left,
				top: r.top + i.top,
	...
	writeMeasure(e) {
		...
		for (let o = 0; o < this.manager.tooltips.length; o++) {
			...
			let f = s.arrow ? c.dom.querySelector(".cm-tooltip-arrow") : null, p = f ? 7 : 0, m = d.right - d.left, h = Us.get(c) ?? d.bottom - d.top, g = c.offset || qs, _ = this.view.textDirection == I.LTR, v = d.width > n.right - n.left ? _ ? n.left : n.right - d.width : _ ? Math.max(n.left, Math.min(u.left - (f ? 14 : 0) + g.x, n.right - m)) : Math.min(Math.max(n.left, u.left - m + (f ? 14 : 0) - g.x), n.right - m), y = this.above[o];
			...
			if (ee < h && c.resize !== !1) {
				...
				Us.set(c, h), l.style.height = (h = ee) / i + "px";
			...
			if (this.position == "absolute" ? (l.style.top = (b - e.parent.top) / i + "px", Gs(l, (v - e.parent.left) / r)) : (l.style.top = b / i + "px", Gs(l, v / r)), f) {
	...
	maybeMeasure() {
		if (this.manager.tooltips.length && (this.view.inView && this.view.requestMeasure(this.measureReq), this.inView != this.view.inView && (this.inView = this.view.inView, !this.inView))) for (let e of this.manager.tooltipViews) e.dom.style.top = zs;
	}
...
var Ks = /*@__PURE__*/ W.baseTheme({
	...
	x: 0,
	y: 0
}, Js = /*@__PURE__*/ E.define({ enables: [Ws, Ks] }), Ys = /*@__PURE__*/ E.define({ combine: (e) => e.reduce((e, t) => e.concat(t), []) }), Xs = class e {
	static create(t) {
		return new e(t);
	}
	constructor(e) {
		this.view = e, this.mounted = !1, this.dom = document.createElement("div"), this.dom.classList.add("cm-tooltip-hover"), this.manager = new Bs(e, Ys, (e, t) => this.createHostedView(e, t), (e) => e.dom.remove());
	}
	...
	startHover() {
		...
		if (n.isWidget()) r = n.posAtStart;
			...
			let a = e.bidiSpans(e.state.doc.lineAt(r)).find((e) => e.from <= r && e.to >= r), o = a && a.dir == I.RTL ? -1 : 1;
			i = t.x < n.left ? -o : o;
		}
	...
	activateHover(e, t, n, r) {
		...
		if (i && "then" in i) {
			...
			}, (t) => R(e.state, t, "hover tooltip"));
		} else a(i);
	}
	get tooltip() {
		let e = this.view.plugin(Ws), t = e ? e.manager.tooltips.findIndex((e) => e.create == Xs.create) : -1;
	...
	mousemove(e) {
		...
		if (t.length && !this.locked.has(t) && n && !tc(n.dom, e) || this.pending) {
			let { pos: n } = t[0] || this.pending, r = t[0]?.end ?? n;
			(n == r ? this.view.posAtCoords(this.lastMove) != n : !nc(this.view, n, r, e.clientX, e.clientY)) && (this.view.dispatch({ effects: this.setHover.of([]) }), this.pending = null);
		}
	}
	mouseleave(e) {
...
function tc(e, t) {
	...
	return t.clientX >= n - ec && t.clientX <= r + ec && t.clientY >= i - ec && t.clientY <= a + ec;
}
...
function rc(e, t = {}) {
	let n = D.define(), r = /* @__PURE__ */ new WeakMap(), i = Ce.define({
		create() {
			return [];
		},
		update(e, a) {
			...
			for (let t of a.effects) t.is(n) && (e = t.value, o = void 0), (t.is(oc) && !t.value || t.value == i) && (e = []);
			return e.length && o && r.set(e, o), e;
		},
		provide: (e) => Ys.from(e)
	}), a = z.define((a) => new $s(a, e, i, r, n, t.hoverTime || 300));
	return {
		active: i,
		extension: [
			i,
...
var oc = /*@__PURE__*/ D.define(), sc = /*@__PURE__*/ E.define({ combine(e) {
	let t, n;
...
function cc(e, t) {
	let n = e.plugin(lc), r = n ? n.specs.indexOf(t) : -1;
	return r > -1 ? n.panels[r] : null;
}
var lc = /*@__PURE__*/ z.fromClass(class {
	constructor(e) {
		this.input = e.state.facet(fc), this.specs = this.input.filter((e) => e), this.panels = this.specs.map((t) => t(e));
		let t = e.state.facet(sc);
		this.top = new uc(e, !0, t.topContainer), this.bottom = new uc(e, !1, t.bottomContainer), this.top.sync(this.panels.filter((e) => e.top)), this.bottom.sync(this.panels.filter((e) => !e.top));
		for (let e of this.panels) e.dom.classList.add("cm-panel"), e.mount && e.mount();
	}
	update(e) {
		let t = e.state.facet(sc);
		this.top.container != t.topContainer && (this.top.sync([]), this.top = new uc(e.view, !0, t.topContainer)), this.bottom.container != t.bottomContainer && (this.bottom.sync([]), this.bottom = new uc(e.view, !1, t.bottomContainer)), this.top.syncClasses(), this.bottom.syncClasses();
		let n = e.state.facet(fc);
		if (n != this.input) {
...
var fc = /*@__PURE__*/ E.define({ enables: lc });
function pc(e, t) {
	let n, r = new Promise((e) => n = e), i = (e) => _c(e, t, n);
	e.state.field(mc, !1) ? e.dispatch({ effects: hc.of(i) }) : e.dispatch({ effects: D.appendConfig.of(mc.init(() => [i])) });
	let a = gc.of(i);
	return {
		close: a,
		result: r.then((t) => ((e.win.queueMicrotask || ((t) => e.win.setTimeout(t, 10)))(() => {
			e.state.field(mc).indexOf(i) > -1 && e.dispatch({ effects: a });
		}), t))
	};
}
var mc = /*@__PURE__*/ Ce.define({
	create() {
		return [];
	},
	update(e, t) {
		for (let n of t.effects) n.is(hc) ? e = [n.value].concat(e) : n.is(gc) && (e = e.filter((e) => e != n.value));
		return e;
	},
	provide: (e) => fc.computeN([e], (t) => t.field(e))
}), hc = /*@__PURE__*/ D.define(), gc = /*@__PURE__*/ D.define();
function _c(e, t, n) {
...
vc.prototype.elementClass = "", vc.prototype.toDOM = void 0, vc.prototype.mapMode = C.TrackBefore, vc.prototype.startSide = vc.prototype.endSide = -1, vc.prototype.point = !0;
var yc = /*@__PURE__*/ E.define(), bc = /*@__PURE__*/ E.define(), xc = {
	class: "",
...
var Ec = /*@__PURE__*/ z.fromClass(class {
	constructor(e) {
		this.view = e, this.domAfter = null, this.prevViewport = e.viewport, this.dom = document.createElement("div"), this.dom.className = "cm-gutters cm-gutters-before", this.dom.setAttribute("aria-hidden", "true"), this.dom.style.minHeight = this.view.contentHeight / this.view.scaleY + "px", this.gutters = e.state.facet(Sc).map((t) => new Ac(e, t)), this.fixed = !e.state.facet(wc);
	...
	syncGutters(e) {
		...
		let n = A.iter(this.view.state.facet(yc), this.view.viewport.from), r = [], i = this.gutters.map((e) => new kc(e, this.view.viewport, -this.view.documentPadding.top));
	...
	updateGutters(e) {
		let t = e.startState.facet(Sc), n = e.state.facet(Sc), r = e.docChanged || e.heightChanged || e.viewportChanged || !A.eq(e.startState.facet(yc), e.state.facet(yc), e.view.viewport.from, e.view.viewport.to);
		if (t == n) for (let t of this.gutters) t.update(e) && (r = !0);
			...
			for (let r of n) {
				let n = t.indexOf(r);
				n < 0 ? i.push(new Ac(this.view, r)) : (this.gutters[n].update(e), i.push(this.gutters[n]));
			}
...
var kc = class {
	...
	constructor(e, t) {
		...
		this.markers = Dc(t.markers(e)), t.initialSpacer && (this.spacer = new jc(e, 0, 0, [t.initialSpacer(e)]), this.dom.appendChild(this.spacer.dom), this.spacer.dom.style.cssText += "visibility: hidden; pointer-events: none");
	}
	update(e) {
		let t = this.markers;
		if (this.markers = Dc(this.config.markers(e.view)), this.spacer && this.config.updateSpacer) {
	...
	update(e, t, n, r) {
		this.height != t && (this.height = t, this.dom.style.height = t + "px"), this.above != n && (this.dom.style.marginTop = (this.above = n) ? n + "px" : ""), Mc(this.markers, r) || this.setMarkers(e, r);
	}
	setMarkers(e, t) {
...
var Nc = /*@__PURE__*/ E.define(), Pc = /*@__PURE__*/ E.define(), Fc = /*@__PURE__*/ E.define({ combine(e) {
	return rt(e, {
		formatNumber: String,
		domEventHandlers: {}
...
var Rc = /*@__PURE__*/ Sc.compute([Fc], (e) => ({
	class: "cm-lineNumbers",
	renderEmptyElements: !1,
	markers(e) {
		return e.state.facet(Nc);
	},
	lineMarker(e, t, n) {
		return n.some((e) => e.toDOM) ? null : new Ic(Lc(e, e.state.doc.lineAt(t.from).number));
	},
	widgetMarker: (e, t, n) => {
		for (let r of e.state.facet(Pc)) {
			let i = r(e, t, n);
			if (i) return i;
		}
		return null;
	...
	initialSpacer(e) {
		return new Ic(Lc(e, Bc(e.state.doc.lines)));
	},
	updateSpacer(e, t) {
		let n = Lc(t.view, Bc(t.view.state.doc.lines));
		return n == e.number ? e : new Ic(n);
	},
...
var Vc = /*@__PURE__*/ new class extends vc {
	constructor() {
		super(...arguments), this.elementClass = "cm-activeLineGutter";
	}
}(), Hc = /*@__PURE__*/ yc.compute(["selection"], (e) => {
	let t = [], n = -1;
...
var Gc = /*@__PURE__*/ F.mark({ class: "cm-highlightTab" }), Kc = /*@__PURE__*/ F.mark({ class: "cm-highlightSpace" }), qc = /*@__PURE__*/ Wc(/*@__PURE__*/ new ps({
	regexp: /\t| /g,
	decoration: (e) => e[0] == "	" ? Gc : Kc,
	boundary: /\S/
}));
function Jc() {
	return qc;
...
var Yc = 1024, Xc = 0, G = class {
	constructor(e, t) {
		this.from = e, this.to = t;
	}
}, K = class {
	constructor(e = {}) {
		this.id = Xc++, this.perNode = !!e.perNode, this.deserialize = e.deserialize || (() => {
	...
	add(e) {
		...
		return typeof e != "function" && (e = q.match(e)), (t) => {
			let n = e(t);
...
}, Qc = Object.create(null), q = class e {
	constructor(e, t, n, r = 0) {
		this.name = e, this.props = t, this.id = n, this.flags = r;
	}
	static define(t) {
		let n = t.props && t.props.length ? Object.create(null) : Qc, r = !!t.top | (t.skipped ? 2 : 0) | (t.error ? 4 : 0) | (t.name == null ? 8 : 0), i = new e(t.name || "", n, t.id, r);
		if (t.props) {
...
var $c = class e {
	...
	extend(...t) {
		...
		for (let e of this.types) {
			...
			n.push(r ? new q(e.name, r, e.id, e.flags) : e);
		}
		return new e(n);
	}
}, el = /* @__PURE__ */ new WeakMap(), tl = /* @__PURE__ */ new WeakMap(), J;
(function(e) {
...
var Y = class e {
	...
	cursor(e = 0) {
		return new hl(this.topNode, e);
	}
	cursorAt(e, t = 0, n = 0) {
		let r = new hl(el.get(this) || this.topNode);
		return r.moveTo(e, t), el.set(this, r._tree), r;
	}
	get topNode() {
		return new sl(this, 0, 0, null);
	}
	resolve(e, t = 0) {
		let n = al(el.get(this) || this.topNode, e, t, !1);
		return el.set(this, n), n;
	}
	resolveInner(e, t = 0) {
		let n = al(tl.get(this) || this.topNode, e, t, !0);
		return tl.set(this, n), n;
	}
	resolveStack(e, t = 0) {
		return ml(this, e, t);
	}
	...
	balance(t = {}) {
		return this.children.length <= 8 ? this : bl(q.none, this.children, this.positions, 0, this.children.length, 0, this.length, (t, n, r) => new e(this.type, t, n, r, this.propValues), t.makeTree || ((t, n, r) => new e(q.none, t, n, r)));
	}
	static build(e) {
		return _l(e);
	}
};
Y.empty = new Y(q.none, [], [], 0);
var nl = class e {
	constructor(e, t) {
	...
	findChild(e, t, n, r, i) {
		...
		for (let s = e; s != t && !(il(i, r, a[s + 1], a[s + 2]) && (o = s, n > 0)); s = a[s + 3]);
		return o;
	}
	slice(t, n, r) {
...
function al(e, t, n, r) {
	for (; e.from == e.to || (n < 1 ? e.from >= t : e.from > t) || (n > -1 ? e.to <= t : e.to < t);) {
		let t = !r && e instanceof sl && e.index < 0 ? null : e.parent;
		if (!t) return e;
		e = t;
	}
	let i = r ? 0 : J.IgnoreOverlays;
	if (r) for (let r = e, a = r.parent; a; r = a, a = r.parent) r instanceof sl && r.index < 0 && a.enter(t, n, i)?.from != r.from && (e = a);
	for (;;) {
		let r = e.enter(t, n, i);
		if (!r) return e;
		e = r;
...
var ol = class {
	...
	nextChild(t, n, r, i, a = 0) {
		for (let o = this;;) {
			for (let { children: s, positions: c } = o._tree, l = n > 0 ? s.length : -1; t != l; t += n) {
				...
				if (!(!(a & J.EnterBracketed && l instanceof Y && (d = Zc.get(l)) && !d.overlay && d.bracketed && r >= u && r <= u + l.length) && !il(i, r, u, u + l.length))) {
					if (l instanceof rl) {
						if (a & J.ExcludeBuffers) continue;
						let e = l.findChild(0, l.buffer.length, n, r - u, i);
						if (e > -1) return new dl(new ul(o, l, t, u), null, e);
					} else if (a & J.IncludeAnonymous || !l.type.isAnonymous || gl(l)) {
						let s;
						if (!(a & J.IgnoreMounts) && (s = Zc.get(l)) && !s.overlay) return new e(s.tree, u, t, o);
						let c = new e(l, u, t, o);
	...
	enter(t, n, r = 0) {
		let i;
		if (!(r & J.IgnoreOverlays) && (i = Zc.get(this._tree)) && i.overlay) {
...
function fl(e) {
	...
	let r = n instanceof sl && n.index < 0 ? null : n.parent, i = e.slice();
	return r ? i[t] = r : i.splice(t, 1), new pl(i, n);
}
var pl = class {
	constructor(e, t) {
	...
	get next() {
		return fl(this.heads);
	}
};
function ml(e, t, n) {
	let r = e.resolveInner(t, n), i = null;
	for (let e = r instanceof sl ? r : r.context.parent; e; e = e.parent) if (e.index < 0) {
		let a = e.parent;
		(i ||= [r]).push(a.resolve(t, n)), e = a;
	} else {
		let a = Zc.get(e.tree);
		if (a && a.overlay && a.overlay[0].from <= t && a.overlay[a.overlay.length - 1].to >= t) {
			let o = new sl(a.tree, a.overlay[0].from + e.from, -1, e);
			(i ||= [r]).push(al(o, t, n, !1));
		}
	}
	return i ? fl(i) : r;
...
var hl = class {
	...
	constructor(e, t = 0) {
		if (this.buffer = null, this.stack = [], this.index = 0, this.bufferNode = null, this.mode = t & ~J.EnterBracketed, e instanceof sl) this.yieldNode(e);
		else {
	...
	yield(e) {
		return e ? e instanceof sl ? (this.buffer = null, this.yieldNode(e)) : (this.buffer = e.context, this.yieldBuf(e.index, e.type)) : !1;
	}
	toString() {
	...
	atLastNode(e) {
		...
		for (; n; {index: t, _parent: n} = n) if (t > -1) for (let r = t + e, i = e < 0 ? -1 : n._tree.children.length; r != i; r += e) {
			...
			if (this.mode & J.IncludeAnonymous || e instanceof rl || !e.type.isAnonymous || gl(e)) return !1;
		}
		return !0;
	}
	move(e, t) {
	...
	matchContext(e) {
		if (!this.buffer) return ll(this.node.parent, e);
		let { buffer: t } = this.buffer, { types: n } = t.set;
		for (let r = e.length - 1, i = this.stack.length - 1; r >= 0; i--) {
			if (i < 0) return ll(this._tree, e, r);
...
function gl(e) {
	return e.children.some((e) => e instanceof rl || !e.type.isAnonymous || gl(e));
}
function _l(e) {
	let { buffer: t, nodeSet: n, maxBufferLength: r = Yc, reused: i = [], minRepeatType: a = n.types.length } = e, o = Array.isArray(t) ? new nl(t, t.length) : t, s = n.types, c = 0, l = 0;
	function u(e, t, _, v, y, ee) {
		...
		if (te < 0) {
			...
			throw RangeError(`Unrecognized record size: ${te}`);
		}
		...
		if (S - x <= r && (oe = h(o.pos - t, y))) {
			...
			ae = new rl(t, S - oe.start, n), C = oe.start - e;
		} else {
			let e = o.pos - te;
			o.next();
			...
			if (i >= 0 && s > 0 && s < t.length && p(t, n, x, s, x, c, i, ne, re), t.reverse(), n.reverse(), i > -1 && s > 0) {
				let e = f(ie, re);
				ae = bl(ie, t, n, 0, t.length, 0, S - x, e, e);
	...
	function d(e, t, i, a) {
		...
		if (c) {
			...
			i.push(new rl(t, s[2] - r, n)), a.push(r - e);
		}
	}
	function f(e, t) {
		return (n, r, i) => {
...
function yl(e, t) {
	if (!e.isAnonymous || t instanceof rl || t.type != e) return 1;
	let n = vl.get(t);
	if (n == null) {
		n = 1;
...
function bl(e, t, n, r, i, a, o, s, c) {
	let l = 0;
	for (let n = r; n < i; n++) l += yl(e, t[n]);
	let u = Math.ceil(l * 1.5 / 8), d = [], f = [];
	function p(t, n, r, i, o) {
		for (let s = r; s < i;) {
			let r = s, l = n[s], m = yl(e, t[s]);
			for (s++; s < i; s++) {
				let n = yl(e, t[s]);
				if (m + n >= u) break;
				m += n;
			...
			if (s == r + 1) {
				...
				d.push(bl(e, t, n, r, s, l, i, null, c));
			}
			f.push(l + o - a);
		}
	}
...
var xl = class {
	...
	set(e, t) {
		e instanceof dl ? this.setBuffer(e.context.buffer, e.index, t) : e instanceof sl && this.map.set(e.tree, t);
	}
	get(e) {
		return e instanceof dl ? this.getBuffer(e.context.buffer, e.index) : e instanceof sl ? this.map.get(e.tree) : void 0;
	}
	cursorSet(e, t) {
	...
	startParse(e, t, n) {
		return typeof e == "string" && (e = new wl(e)), n = n ? n.length ? n.map((e) => new G(e.from, e.to)) : [new G(0, 0)] : [new G(0, e.length)], this.createParse(e, t || [], n);
	}
	parse(e, t, n) {
...
function Tl(e) {
	return (t, n, r, i) => new Al(t, e, n, r, i);
}
var El = class {
	constructor(e, t, n, r, i, a) {
...
var Ol = class {
	...
	advance() {
		...
		if (this.innerDone == this.inner.length) {
			let e = this.baseTree;
			return this.stoppedAt != null && (e = new Y(e.type, e.children, e.positions, e.length, e.propValues.concat([[kl, this.stoppedAt]]))), e;
		}
		let e = this.inner[this.innerDone], t = e.parse.advance();
		if (t) {
			this.innerDone++;
			let n = Object.assign(Object.create(null), e.target.props);
			n[K.mounted.id] = new Zc(t, e.overlay, e.parser, e.bracketed), e.target.props = n;
		}
		return null;
	}
	get parsedPos() {
	...
	startInner() {
		let e = new Fl(this.fragments), t = null, n = null, r = new hl(new sl(this.baseTree, this.ranges[0].from, 0, null), J.IncludeAnonymous | J.IgnoreMounts);
		scan: for (let i, a;;) {
			let o = !0, s;
			if (this.stoppedAt != null && r.from >= this.stoppedAt) o = !1;
				...
				o = !1;
			} else if (n && (a = jl(n.ranges, r.from, r.to))) o = a != 2;
			else if (!r.type.isAnonymous && (i = this.nest(r, this.input)) && (r.from < r.to || !i.overlay)) {
				r.tree || (Nl(r), t && t.depth++, n && n.depth++);
				let a = e.findMounts(r.from, i.parser);
				if (typeof i.overlay == "function") t = new Ol(i.parser, i.overlay, a, this.inner.length, r.from, !!i.bracketed, r.tree, t);
				else {
					let e = Il(this.ranges, i.overlay || (r.from < r.to ? [new G(r.from, r.to)] : []));
					e.length && Dl(e), (e.length || !i.overlay) && this.inner.push(new El(i.parser, e.length ? i.parser.startParse(this.input, Rl(a, e), e) : i.parser.startParse(""), i.overlay ? i.overlay.map((e) => new G(e.from - r.from, e.to - r.from)) : null, !!i.bracketed, r.tree, e.length ? e[0].from : r.from)), i.overlay ? e.length && (n = {
						ranges: e,
						depth: 0,
						prev: n
					}) : o = !1;
				}
			} else if (t && (s = t.predicate(r)) && (s === !0 && (s = new G(r.from, r.to)), s.from < s.to)) {
			...
			if (o && r.firstChild()) t && t.depth++, n && n.depth++;
				...
				if (t && !--t.depth) {
					let e = Il(this.ranges, t.ranges);
					e.length && (Dl(e), this.inner.splice(t.index, 0, new El(t.parser, t.parser.startParse(this.input, Rl(t.mounts, e), e), t.ranges.map((e) => new G(e.from - t.start, e.to - t.start)), t.bracketed, t.target, e[0].from))), t = t.prev;
				}
				n && !--n.depth && (n = n.prev);
			}
		}
...
function Nl(e) {
	...
	function l(e, r, i, a, u, d) {
		...
		return p.push(_), m.push(h - a), Ml(o, s[f + 3], r, p, m, a), new Y(i, p, m, u);
	}
	i.children[a] = l(0, s.length, q.none, 0, o.length, n.length - 1);
	for (let t of c) {
		let n = e.tree.children[t], r = e.tree.positions[t];
		e.yield(new sl(n, r + e.from, t, e._tree));
	}
}
var Pl = class {
	constructor(e, t) {
		this.offset = t, this.done = !1, this.cursor = e.cursor(J.IncludeAnonymous | J.IgnoreMounts);
	}
	moveTo(e) {
		let { cursor: t } = this, n = e - this.offset;
		for (; !this.done && t.from < n;) if (!(t.to >= e && t.enter(n, 1, J.IgnoreOverlays | J.ExcludeBuffers))) {
	...
	hasNode(e) {
		if (this.moveTo(e.from), !this.done && this.cursor.from + this.offset == e.from && this.cursor.tree) for (let t = this.cursor.tree;;) {
			...
			if (t.children.length && t.positions[0] == 0 && t.children[0] instanceof Y) t = t.children[0];
			else break;
		}
		return !1;
	}
	...
	constructor(e) {
		if (this.fragments = e, this.curTo = 0, this.fragI = 0, e.length) {
			...
			this.curTo = t.tree.prop(kl) ?? t.to, this.inner = new Pl(t.tree, -t.offset);
	...
	nextFrag() {
		if (this.fragI++, this.fragI == this.fragments.length) this.curFrag = this.inner = null;
			...
			this.curTo = e.tree.prop(kl) ?? e.to, this.inner = new Pl(e.tree, -e.offset);
		}
	}
	findMounts(e, t) {
		let n = [];
...
function Il(e, t) {
	...
	for (let i = 1, a = 0; i < e.length; i++) {
		...
		for (; a < r.length; a++) {
			let e = r[a];
			if (e.from >= s) break;
			e.to <= o || (n || (r = n = t.slice()), e.from < o ? (n[a] = new G(e.from, o), e.to > s && n.splice(a + 1, 0, new G(s, e.to))) : e.to > s ? n[a--] = new G(s, e.to) : n.splice(a--, 1));
		}
	}
	return r;
}
...
function Rl(e, t) {
	...
	for (let { pos: r, mount: i, frag: a } of e) {
		...
		if (i.overlay) {
			let o = Ll(t, i.overlay.map((e) => new G(e.from + r, e.to + r)), s, c);
			for (let t = 0, r = s;; t++) {
				let s = t == o.length, l = s ? c : o[t].from;
				if (l > r && n.push(new Sl(r, l, i.tree, -e, a.from >= r || a.openStart, a.to <= l || a.openEnd)), s) break;
				r = o[t].to;
			}
		} else n.push(new Sl(s, c, i.tree, -e, a.from >= e || a.openStart, a.to <= o || a.openEnd));
	}
	return n;
}
//#endregion
...
var zl = 0, Bl = class e {
	constructor(e, t, n, r) {
		this.name = e, this.set = t, this.base = n, this.modified = r, this.id = zl++;
	}
	toString() {
		let { name: e } = this;
	...
	constructor(e) {
		this.name = e, this.instances = [], this.id = Vl++;
	}
	static get(t, n) {
		if (!n.length) return t;
		let r = n[0].instances.find((e) => e.base == t && Ul(n, e.modified));
		if (r) return r;
		let i = [], a = new Bl(t.name, i, t, n);
...
function Gl(e) {
	...
	for (let n in e) {
		...
		for (let e of n.split(" ")) if (e) {
			...
			t[s] = new ql(r, i, o > 0 ? n.slice(0, o) : null).sort(t[s]);
		}
	}
	return Kl.add(t);
}
var Kl = new K({ combine(e, t) {
	let n, r, i;
	for (; e || t;) {
		if (!e || t && e.depth >= t.depth ? (i = t, t = t.next) : (i = e, e = e.next), n && n.mode == i.mode && !i.context && !n.context) continue;
		let a = new ql(i.tags, i.mode, i.context);
		n ? n.next = a : r = a, n = a;
	}
	return r;
} }), ql = class {
...
function Xl(e, t, n, r = 0, i = e.length) {
	let a = new Zl(r, Array.isArray(t) ? t : [t], n);
...
var Zl = class {
	...
	highlightRange(e, t, n, r, i) {
		...
		let c = r, l = Ql(e) || ql.empty, u = Yl(i, l.tags);
...
var X = Bl.define, $l = X(), eu = X(), tu = X(eu), nu = X(eu), ru = X(), iu = X(ru), au = X(ru), ou = X(), su = X(ou), cu = X(), lu = X(), uu = X(), du = X(uu), fu = X(), Z = {
	comment: $l,
	lineComment: X($l),
	blockComment: X($l),
	docComment: X($l),
	...
	unit: X(cu),
	modifier: X(cu),
	operatorKeyword: X(cu),
	controlKeyword: X(cu),
	definitionKeyword: X(cu),
	moduleKeyword: X(cu),
	operator: lu,
	derefOperator: X(lu),
	arithmeticOperator: X(lu),
	logicOperator: X(lu),
	bitwiseOperator: X(lu),
	compareOperator: X(lu),
	updateOperator: X(lu),
	definitionOperator: X(lu),
	typeOperator: X(lu),
	controlOperator: X(lu),
	punctuation: uu,
	separator: X(uu),
	bracket: du,
	angleBracket: X(du),
...
var hu = /*@__PURE__*/ new K(), Q = class {
	constructor(e, t, n = [], r = "") {
		this.data = e, this.name = r, k.prototype.hasOwnProperty("tree") || Object.defineProperty(k.prototype, "tree", { get() {
			...
			let r = gu(e, t, n), i = r.type.prop(pu);
			if (!i) return [];
	...
	isActiveAt(e, t, n = -1) {
		return gu(e, t, n).type.prop(pu) == this.data;
	}
	findRegions(e) {
		let t = e.facet(Ou);
...
Q.setState = /*@__PURE__*/ D.define();
function gu(e, t, n) {
	let r = e.facet(Ou), i = vu(e).topNode;
	if (!r || r.allowsNesting) for (let e = i; e; e = e.enter(t, n, J.ExcludeBuffers | J.EnterBracketed)) e.type.isTop && (i = e);
	return i;
}
var _u = class e extends Q {
	constructor(e, t, n) {
		super(e, t, [], n), this.parser = t;
	}
	static define(t) {
		let n = mu(t.languageData);
		return new e(n, t.parser.configure({ props: [pu.add((e) => e.isTop ? n : void 0)] }), t.name);
	}
	configure(t, n) {
...
function yu(e, t, n = 50) {
	let r = e.field(Q.state, !1)?.context;
	if (!r) return null;
	let i = r.viewport;
	r.updateViewport({
		from: 0,
...
var bu = class {
	...
	work(e, t) {
		return t != null && t >= this.state.doc.length && (t = void 0), this.tree != Y.empty && this.isDone(t ?? this.state.doc.length) ? (this.takeTree(), !0) : this.withContext(() => {
			...
			for (this.parse ||= this.startParse(), t != null && (this.parse.stoppedAt == null || this.parse.stoppedAt > t) && t < this.state.doc.length && this.parse.stopAt(t);;) {
				...
				if (n) {
					if (this.fragments = this.withoutTempSkipped(Sl.addTree(n, this.fragments, this.parse.stoppedAt != null)), this.treeLen = this.parse.stoppedAt ?? this.state.doc.length, this.tree = n, this.parse = null, this.treeLen < (t ?? this.state.doc.length)) this.parse = this.startParse();
					else return !0;
				}
				if (e()) return !1;
			}
	...
	takeTree() {
		...
		}), this.treeLen = e, this.tree = t, this.fragments = this.withoutTempSkipped(Sl.addTree(this.tree, this.fragments, !0)), this.parse = null);
	}
	withContext(e) {
		let t = xu;
		xu = this;
	...
	changes(t, n) {
		...
		if (this.takeTree(), !t.empty) {
			...
			if (t.iterChangedRanges((t, n, r, i) => e.push({
				...
				fromB: r,
				toB: i
			})), r = Sl.applyChanges(r, e), i = Y.empty, a = 0, o = {
			...
			createParse(t, n, r) {
				...
				return {
					...
					advance() {
						...
						return this.parsedPos = a, new Y(q.none, [], [], a - i);
					},
					stoppedAt: null,
					stopAt() {}
				};
...
var Eu = typeof navigator < "u" && navigator.scheduling?.isInputPending ? () => navigator.scheduling.isInputPending() : null, Du = /*@__PURE__*/ z.fromClass(class {
	constructor(e) {
	...
	work(e) {
		...
		this.chunkBudget -= Date.now() - t, (s || this.chunkBudget <= 0) && (i.context.takeTree(), this.view.dispatch({ effects: Q.setState.of(new wu(i.context)) })), this.chunkBudget > 0 && !(s && !o) && this.scheduleWork(), this.checkAsyncSchedule(i.context);
	}
...
}, ju = /*@__PURE__*/ E.define(), Mu = /*@__PURE__*/ E.define({ combine: (e) => {
	if (!e.length) return "  ";
	let t = e[0];
...
function Fu(e, t) {
	e instanceof k && (e = new Iu(e));
	for (let n of e.state.facet(ju)) {
		let r = n(e, t);
		if (r !== void 0) return r;
	}
	let n = vu(e.state);
	return n.length >= t ? Ru(e, n, t) : null;
}
var Iu = class {
	constructor(e, t = {}) {
		this.state = e, this.options = t, this.unit = Nu(e);
	}
	lineAt(e, t = 1) {
...
function Vu(e) {
	...
	if (n && (r = n.type.prop(K.closedBy))) {
		...
		return (e) => qu(e, !0, 1, void 0, n && !Bu(e) ? t.from : void 0);
	}
...
var Uu = class e extends Iu {
	...
	continue() {
		return zu(this.context.next, this.base, this.pos);
	}
};
function Wu(e, t) {
...
function Ku({ closing: e, align: t = !0, units: n = 1 }) {
	return (r) => qu(r, t, n, e);
}
function qu(e, t, n, r, i) {
	let a = e.textAfter, o = a.match(/^\s*/)[0].length, s = r && a.slice(o, o + r.length) == r || i == e.pos + o, c = t ? Gu(e) : null;
	return c ? s ? e.column(c.from) : e.column(c.to) : e.baseIndent + (s ? 0 : e.unit * n);
}
var Ju = (e) => e.baseIndent;
function Yu({ except: e, units: t = 1 } = {}) {
	return (n) => {
...
function Zu() {
	return k.transactionFilter.of((e) => {
		...
		for (let { head: e } of o.selection.ranges) {
			...
			let n = Fu(o, t.from);
			if (n == null) continue;
			let r = /^\s*/.exec(t.text)[0], i = Pu(o, n);
			r != i && c.push({
				from: t.from,
				to: t.from + r.length,
				insert: i
...
var Qu = /*@__PURE__*/ E.define(), $u = /*@__PURE__*/ new K();
function ed(e) {
...
function td(e, t, n) {
	...
	for (let o = i; o; o = o.next) {
		...
		if (a && i.from < t) break;
		let s = i.type.prop($u);
		if (s && (i.to < r.length - 50 || r.length == e.doc.length || !nd(i))) {
			let r = s(i, e);
...
var ad = /*@__PURE__*/ D.define({ map: id }), od = /*@__PURE__*/ D.define({ map: id });
function sd(e) {
	let t = [];
	for (let { head: n } of e.state.selection.ranges) t.some((e) => e.from <= n && e.to >= n) || t.push(e.lineBlockAt(n));
	return t;
}
var cd = /*@__PURE__*/ Ce.define({
	create() {
		return F.none;
	},
	update(e, t) {
		t.isUserEvent("delete") && t.changes.iterChangedRanges((t, n) => e = ld(e, t, n)), e = e.map(t.changes);
		let n = [];
		for (let r of t.effects) r.is(ad) && !dd(e, r.value.from, r.value.to) ? n.push(r.value) : r.is(od) && (e = e.update({
			filter: (e, t) => r.value.from != e || r.value.to != t,
			filterFrom: r.value.from,
			filterTo: r.value.to
		}));
		if (n.length) {
			let { preparePlaceholder: r } = t.state.facet(vd), i = n.map((e) => (r ? F.replace({ widget: new Sd(r(t.state, e)) }) : xd).range(e.from, e.to));
			e = e.update({ add: i });
		}
		return t.selection && (e = ld(e, t.selection.main.head)), e;
	},
...
function ud(e, t, n) {
	var r;
	let i = null;
	return (r = e.field(cd, !1)) == null || r.between(t, n, (e, t) => {
		(!i || i.from > e) && (i = {
			from: e,
			to: t
		});
...
function fd(e, t) {
	return e.field(cd, !1) ? t : t.concat(D.appendConfig.of(yd()));
}
var pd = (e) => {
	for (let t of sd(e)) {
		let n = rd(e.state, t.from, t.to);
		if (n) return e.dispatch({ effects: fd(e.state, [ad.of(n), hd(e, n)]) }), !0;
	}
	return !1;
}, md = (e) => {
	if (!e.state.field(cd, !1)) return !1;
	let t = [];
	for (let n of sd(e)) {
		let r = ud(e.state, n.from, n.to);
		r && t.push(od.of(r), hd(e, r, !1));
	}
	return t.length && e.dispatch({ effects: t }), t.length > 0;
};
function hd(e, t, n = !0) {
	let r = e.state.doc.lineAt(t.from).number, i = e.state.doc.lineAt(t.to).number;
	return W.announce.of(`${e.state.phrase(n ? "Folded lines" : "Unfolded lines")} ${r} ${e.state.phrase("to")} ${i}.`);
}
var gd = [
	{
		key: "Ctrl-Shift-[",
	...
	},
	{
		...
		run: (e) => {
			...
			for (let r = 0; r < t.doc.length;) {
				let i = e.lineBlockAt(r), a = rd(t, i.from, i.to);
				a && n.push(ad.of(a)), r = (a ? e.lineBlockAt(a.to) : i).to + 1;
			}
			return n.length && e.dispatch({ effects: fd(e.state, n) }), !!n.length;
		}
	},
	{
		key: "Ctrl-Alt-]",
		run: (e) => {
			let t = e.state.field(cd, !1);
	...
	placeholderText: "…"
}, vd = /*@__PURE__*/ E.define({ combine(e) {
	return rt(e, _d);
} });
function yd(e) {
	let t = [cd, Ed];
	return e && t.push(vd.of(e)), t;
}
function bd(e, t) {
	let { state: n } = e, r = n.facet(vd), i = (t) => {
		let n = e.lineBlockAt(e.posAtDOM(t.target)), r = ud(e.state, n.from, n.to);
		r && e.dispatch({ effects: od.of(r) }), t.preventDefault();
	};
...
var xd = /*@__PURE__*/ F.replace({ widget: /*@__PURE__*/ new class extends en {
	toDOM(e) {
		return bd(e, null);
	}
}() }), Sd = class extends en {
...
function Td(e = {}) {
	let t = {
		...Cd,
		...e
	}, n = new wd(t, !0), r = new wd(t, !1), i = z.fromClass(class {
		constructor(e) {
			this.from = e.viewport.from, this.markers = this.buildMarkers(e);
		}
		update(e) {
			(e.docChanged || e.viewportChanged || e.startState.facet(Ou) != e.state.facet(Ou) || e.startState.field(cd, !1) != e.state.field(cd, !1) || vu(e.startState) != vu(e.state) || t.foldingChanged(e)) && (this.markers = this.buildMarkers(e.view));
		}
		buildMarkers(e) {
			let t = new ut();
			for (let i of e.viewportLineBlocks) {
				let a = ud(e.state, i.from, i.to) ? r : rd(e.state, i.from, i.to) ? n : null;
		...
		Cc({
			...
			domEventHandlers: {
				...
				click: (e, t, n) => {
					...
					let r = ud(e.state, t.from, t.to);
					if (r) return e.dispatch({ effects: od.of(r) }), !0;
					let i = rd(e.state, t.from, t.to);
					return i ? (e.dispatch({ effects: ad.of(i) }), !0) : !1;
				}
			}
		}),
		yd()
...
var Ed = /*@__PURE__*/ W.baseTheme({
	...
	constructor(e, t) {
		...
		this.scope = a instanceof Q ? (e) => e.prop(pu) == a.data : a ? (e) => e == a : void 0, this.style = Jl(e.map((e) => ({
			tag: e.tag,
...
}, Od = /*@__PURE__*/ E.define(), kd = /*@__PURE__*/ E.define({ combine(e) {
	return e.length ? [e[0]] : null;
} });
function Ad(e) {
	let t = e.facet(Od);
	return t.length ? t : e.facet(kd);
}
function jd(e, t) {
	let n = [Nd], r;
	return e instanceof Dd && (e.module && n.push(W.styleModule.of(e.module)), r = e.themeType), t?.fallback ? n.push(kd.of(e)) : r ? n.push(Od.computeN([W.darkTheme], (t) => t.facet(W.darkTheme) == (r == "dark") ? [e] : [])) : n.push(Od.of(e)), n;
}
var Md = class {
	constructor(e) {
		this.markCache = Object.create(null), this.tree = vu(e.state), this.decorations = this.buildDeco(e, Ad(e.state)), this.decoratedTo = e.viewport.to;
	}
	update(e) {
		let t = vu(e.state), n = Ad(e.state), r = n != Ad(e.startState), { viewport: i } = e.view, a = e.changes.mapPos(this.decoratedTo, 1);
	...
	buildDeco(e, t) {
		...
		let n = new ut();
		for (let { from: r, to: i } of e.visibleRanges) Xl(this.tree, t, (e, t, r) => {
			n.add(e, t, this.markCache[r] || (this.markCache[r] = F.mark({ class: r })));
		}, r, i);
		return n.finish();
	}
}, Nd = /*@__PURE__*/ Ee.high(/*@__PURE__*/ z.fromClass(Md, { decorations: (e) => e.decorations })), Pd = /*@__PURE__*/ Dd.define([
	{
		tag: Z.meta,
		color: "#404740"
	},
...
]), Fd = /*@__PURE__*/ W.baseTheme({
	"&.cm-focused .cm-matchingBracket": { backgroundColor: "#328c8252" },
	"&.cm-focused .cm-nonmatchingBracket": { backgroundColor: "#bb555544" }
}), Id = 1e4, Ld = "()[]{}", Rd = /*@__PURE__*/ E.define({ combine(e) {
	return rt(e, {
		afterCursor: !0,
		brackets: Ld,
		maxScanDistance: Id,
...
} }), zd = /*@__PURE__*/ F.mark({ class: "cm-matchingBracket" }), Bd = /*@__PURE__*/ F.mark({ class: "cm-nonmatchingBracket" });
function Vd(e) {
	let t = [], n = e.matched ? zd : Bd;
...
function Hd(e) {
	...
	for (let r of e.selection.ranges) {
		if (!r.empty) continue;
		let i = Jd(e, r.head, -1, n) || r.head > 0 && Jd(e, r.head - 1, 1, n) || n.afterCursor && (Jd(e, r.head, 1, n) || r.head < e.doc.length && Jd(e, r.head + 1, -1, n));
		i && (t = t.concat(n.renderMatch(i, e)));
	}
	return F.set(t, !0);
}
var Ud = [/* @__PURE__ */ z.fromClass(class {
	constructor(e) {
		this.paused = !1, this.decorations = Hd(e.state);
	}
	update(e) {
		(e.docChanged || e.selectionSet || this.paused) && (e.view.composing ? (this.decorations = this.decorations.map(e.changes), this.paused = !0) : (this.decorations = Hd(e.state), this.paused = !1));
	}
}, { decorations: (e) => e.decorations }), Fd];
function Wd(e = {}) {
	return [Rd.of(e), Ud];
}
var Gd = /*@__PURE__*/ new K();
function Kd(e, t, n) {
...
function qd(e) {
	let t = e.type.prop(Gd);
	return t ? t(e.node) : e;
}
function Jd(e, t, n, r = {}) {
	let i = r.maxScanDistance || Id, a = r.brackets || Ld, o = vu(e), s = o.resolveInner(t, n);
	for (let r = s; r; r = r.parent) {
		let i = Kd(r.type, n, a);
		if (i && r.from < r.to) {
			let o = qd(r);
			if (o && (n > 0 ? t >= o.from && t < o.to : t > o.from && t <= o.to)) return Yd(e, t, n, r, o, i, a);
		}
	}
	return Xd(e, t, n, o, s.type, i, a);
}
...
var Qd = class {
	...
	column() {
		return this.lastColumnPos < this.start && (this.lastColumnValue = Zd(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue), this.lastColumnPos = this.start), this.lastColumnValue;
	}
	indentation() {
		return this.overrideIndent ?? Zd(this.string, null, this.tabSize);
	}
	match(e, t, n) {
		if (typeof e == "string") {
...
function $d(e) {
	return {
		...
		copyState: e.copyState || ef,
		indent: e.indent || (() => null),
		languageData: e.languageData || {},
		tokenTable: e.tokenTable || lf,
...
var tf = /*@__PURE__*/ new WeakMap(), nf = class e extends Q {
	constructor(e) {
		let t = mu(e.languageData), n = $d(e), r, i = new class extends Cl {
			createParse(e, t, n) {
				return new sf(r, e, t, n);
			}
		}();
		super(t, i, [], e.name), this.topNode = yf(t, this), r = this, this.streamParser = n, this.stateAfter = new K({ perNode: !0 }), this.tokenTable = e.tokenTable ? new hf(n.tokenTable) : gf;
	}
	static define(t) {
		return new e(t);
	}
	getIndent(e) {
		...
		n && (t = tf.get(e.state), t != null && t < e.pos - 1e4 && (t = void 0));
		let r = rf(this, e.node.tree, e.node.from, e.node.from, t ?? e.pos), i, a;
		...
		for (; i < e.pos;) {
			...
			if (t.length) {
				let i = n ? n(t.from) : -1, o = new Qd(t.text, e.state.tabSize, e.unit, i < 0 ? void 0 : i);
				for (; o.pos < r - t.from;) cf(this.streamParser.token, o, a);
			} else this.streamParser.blankLine(a, e.unit);
			if (r == e.pos) break;
			i = t.to + 1;
		}
		let o = e.lineAt(e.pos);
		return n && t == null && tf.set(e.state, o.from), this.streamParser.indent(a, /^\s*(.*)/.exec(o.text)[1], e);
	}
	get allowsNesting() {
		return !1;
	}
...
function rf(e, t, n, r, i) {
	...
	for (let a = t.children.length - 1; a >= 0; a--) {
		let o = t.children[a], s = n + t.positions[a], c = o instanceof Y && s < i && rf(e, o, s, r, i);
		if (c) return c;
	}
	return null;
}
function af(e, t, n, r, i) {
	...
	for (let a = t.children.length - 1; a >= 0; a--) {
		...
		if (o < r && s instanceof Y) {
			if (!(c = af(e, s, n - o, r - o, i))) break;
			return i ? new Y(t.type, t.children.slice(0, a).concat(c), t.positions.slice(0, a + 1), o + c.length) : c;
		}
	}
	return null;
}
function of(e, t, n, r, i) {
	for (let i of t) {
		let t = i.from + (i.openStart ? 25 : 0), a = i.to - (i.openEnd ? 25 : 0), o = t <= n && a > n && rf(e, i.tree, 0 - i.offset, n, a), s;
		if (o && o.pos <= r && (s = af(e, i.tree, n + i.offset, o.pos + i.offset, !1))) return {
			state: o.state,
			tree: s
		};
	}
	return {
		state: e.streamParser.startState(i ? Nu(i) : 4),
		tree: Y.empty
	};
}
var sf = class {
	constructor(e, t, n, r) {
		...
		let i = Su.get(), a = r[0].from, { state: o, tree: s } = of(e, n, a, this.to, i?.state);
		...
		i && this.parsedPos < i.viewport.from - 1e5 && r.some((e) => e.from <= i.viewport.from && e.to >= i.viewport.from) && (this.state = this.lang.streamParser.startState(Nu(i.state)), i.skipUntilInView(this.parsedPos, i.viewport.from), this.parsedPos = i.viewport.from), this.moveRangeIndex();
	}
	advance() {
		let e = Su.get(), t = this.stoppedAt == null ? this.to : Math.min(this.to, this.stoppedAt), n = Math.min(t, this.chunkStart + 512);
	...
	parseLine(e) {
		let { line: t, end: n } = this.nextLine(), r = 0, { streamParser: i } = this.lang, a = new Qd(t, e ? e.state.tabSize : 4, e ? Nu(e.state) : 2);
		if (a.eol()) i.blankLine(this.state, a.indentUnit);
		else for (; !a.eol();) {
			let e = cf(i.token, a, this.state);
	...
	finishChunk() {
		...
		e = new Y(e.type, e.children, e.positions, e.length, [[this.lang.stateAfter, this.lang.streamParser.copyState(this.state)]]), this.chunks.push(e), this.chunkPos.push(this.chunkStart - this.ranges[0].from), this.chunk = [], this.chunkReused = void 0, this.chunkStart = this.parsedPos;
	}
	finish() {
		return new Y(this.lang.topNode, this.chunks, this.chunkPos, this.parsedPos - this.ranges[0].from).balance();
	}
};
function cf(e, t, n) {
	t.start = t.pos;
...
var lf = /*@__PURE__*/ Object.create(null), uf = [q.none], df = /*@__PURE__*/ new $c(uf), ff = [], pf = /*@__PURE__*/ Object.create(null), mf = /*@__PURE__*/ Object.create(null);
for (let [e, t] of [
...
]) mf[e] = /*@__PURE__*/ vf(lf, t);
var hf = class {
	constructor(e) {
		this.extra = e, this.table = Object.assign(Object.create(null), mf);
	}
	resolve(e) {
		return e ? this.table[e] || (this.table[e] = vf(this.extra, e)) : 0;
	}
}, gf = /*@__PURE__*/ new hf(lf);
function _f(e, t) {
	ff.indexOf(e) > -1 || (ff.push(e), console.warn(t));
}
function vf(e, t) {
	let n = [];
	for (let r of t.split(" ")) {
		...
		for (let n of r.split(".")) {
			let r = e[n] || Z[n];
			r ? typeof r == "function" ? t.length ? t = t.map(r) : _f(n, `Modifier ${n} used at start of tag`) : t.length ? _f(n, `Tag ${n} used as modifier`) : t = Array.isArray(r) ? r : [r] : _f(n, `Unknown highlighting tag ${n}`);
		}
		for (let e of t) n.push(e);
	}
	if (!n.length) return 0;
	let r = t.replace(/ /g, "_"), i = r + " " + n.map((e) => e.id), a = pf[i];
	if (a) return a.id;
	let o = pf[i] = q.define({
		id: uf.length,
		name: r,
...
function yf(e, t) {
	let n = q.define({
		id: uf.length,
		name: "Document",
		props: [pu.add(() => e), Lu.add(() => (e) => t.getIndent(e))],
		top: !0
	});
	return uf.push(n), n;
}
...
var bf = class e {
	...
	static start(t, n, r = 0) {
		...
		return new e(t, [], n, r, r, 0, [], 0, i ? new xf(i, i.start) : null, 0, null);
	}
	get context() {
	...
	updateContext(e) {
		if (e != this.curContext.context) {
			let t = new xf(this.curContext.tracker, e);
...
var Tf = class {
	...
	constructor(e, t) {
		this.input = e, this.ranges = t, this.chunk = "", this.chunkOff = 0, this.chunk2 = "", this.chunk2Pos = 0, this.next = -1, this.token = Ef, this.rangeIndex = 0, this.pos = this.chunkPos = t[0].from, this.range = t[0], this.end = t[t.length - 1].to, this.readNext();
	}
	resolveOffset(e, t) {
	...
	reset(e, t) {
		if (t ? (this.token = t, t.start = e, t.lookAhead = e + 1, t.value = t.extended = -1) : this.token = Ef, this.pos != e) {
	...
	token(e, t) {
		let { parser: n } = t.p;
		jf(this.data, e, t, this.id, n.data, n.tokenPrecTable);
	}
};
Of.prototype.contextual = Of.prototype.fallback = Of.prototype.extend = !1;
var kf = class {
	constructor(e, t, n) {
		this.precTable = t, this.elseToken = n, this.data = typeof e == "string" ? wf(e) : e;
	}
	token(e, t) {
		let n = e.pos, r = 0;
		for (;;) {
			let n = e.next < 0, i = e.resolveOffset(1, 1);
			if (jf(this.data, e, t, 0, this.data, this.precTable), e.token.value > -1) break;
...
kf.prototype.contextual = Of.prototype.fallback = Of.prototype.extend = !1;
var Af = class {
	constructor(e, t = {}) {
...
function jf(e, t, n, r, i, a) {
	...
	scan: for (; (s & e[o]) != 0;) {
		...
		for (let r = o + 3; r < n; r += 2) if ((e[r + 1] & s) > 0) {
			let n = e[r];
			if (c.allows(n) && (t.token.value == -1 || t.token.value == n || Nf(n, t.token.value, i, a))) {
				t.acceptToken(n);
				break;
			}
		}
...
function Nf(e, t, n, r) {
	let i = Mf(n, r, t);
	return i < 0 || Mf(n, r, e) < i;
}
var $ = typeof process < "u" && process.env && /\bparse\b/.test(process.env.LOG), Pf = null;
function Ff(e, t, n) {
...
var If = class {
	...
	constructor(e, t) {
		this.stream = t, this.tokens = [], this.mainToken = null, this.actions = [], this.tokens = e.tokenizers.map((e) => new Tf());
	}
	getActions(e) {
		...
		return s && e.setLookAhead(s), !n && e.pos == this.stream.end && (n = new Tf(), n.value = e.p.parser.eofTerm, n.start = n.end = e.pos, t = this.addActions(e, n.value, n.end, t)), this.mainToken = n, this.actions;
	}
	getMainToken(e) {
		if (this.mainToken) return this.mainToken;
		let t = new Tf(), { pos: n, p: r } = e;
	...
	addActions(e, t, n, r) {
		...
		for (let e = 0; e < 2; e++) for (let s = a.stateSlot(i, e ? 2 : 1);; s += 3) {
			if (o[s] == 65535) {
				if (o[s + 1] == 1) s = Wf(o, s + 2);
				else {
					r == 0 && o[s + 1] == 2 && (r = this.putAction(Wf(o, s + 2), t, n, r));
					break;
				}
			}
			o[s] == t && (r = this.putAction(Wf(o, s + 1), t, n, r));
		}
		return r;
	}
}, Rf = class {
	constructor(e, t, n, r) {
		this.parser = e, this.input = t, this.ranges = r, this.recovering = 0, this.nextStackID = 9812, this.minStackPos = 0, this.reused = [], this.stoppedAt = null, this.lastBigReductionStart = -1, this.lastBigReductionSize = 0, this.bigReductionCount = 0, this.stream = new Df(t, r), this.tokens = new Lf(e, this.stream), this.topTerm = e.top[1];
		let { from: i } = r[0];
		this.stacks = [bf.start(this, e.top[0], i)], this.fragments = n.length && this.stream.end - i > e.bufferLength * 4 ? new If(n, e.nodeSet) : null;
	}
	get parsedPos() {
	...
	advanceStack(e, t, n) {
		...
		if (this.fragments) {
			...
			for (let o = this.fragments.nodeAt(r); o;) {
				...
				if (r > -1 && o.length && (!t || (o.prop(K.contextHash) || 0) == n)) return e.useNode(o, r), $ && console.log(a + this.stackID(e) + ` (via reuse of ${i.getName(o.type.id)})`), !0;
	...
	runRecovery(e, t, n) {
		...
		for (let a = 0; a < e.length; a++) {
			...
			this.stream.end > o.pos ? (c == o.pos && (c++, s = 0), o.recoverByDelete(s, c), $ && console.log(l + this.stackID(o) + ` (via recover-delete ${this.parser.getName(s)})`), zf(o, n)) : (!r || r.score < u.score) && (r = u);
		}
		return r;
	}
	stackToTree(e) {
	...
	stackID(e) {
		let t = (Pf ||= /* @__PURE__ */ new WeakMap()).get(e);
...
var Bf = class {
	...
	constructor(e) {
		this.start = e.start, this.shift = e.shift || Vf, this.reduce = e.reduce || Vf, this.reuse = e.reuse || Vf, this.hash = e.hash || (() => 0), this.strict = e.strict !== !1;
	}
}, Uf = class e extends Cl {
	constructor(e) {
		...
		this.nodeSet = new $c(t.map((t, i) => q.define({
		...
		let a = wf(e.tokenData);
		this.context = e.context, this.specializerSpecs = e.specialized || [], this.specialized = new Uint16Array(this.specializerSpecs.length);
		for (let e = 0; e < this.specializerSpecs.length; e++) this.specialized[e] = this.specializerSpecs[e].term;
		this.specializers = this.specializerSpecs.map(Kf), this.states = wf(e.states, Uint32Array), this.data = wf(e.stateData), this.goto = wf(e.goto), this.maxTerm = e.maxTerm, this.tokenizers = e.tokenizers.map((e) => typeof e == "number" ? new Of(a, e) : e), this.topRules = e.topRules, this.dialects = e.dialects || {}, this.dynamicPrecedences = e.dynamicPrecedences || null, this.tokenPrecTable = e.tokenPrec, this.termNames = e.termNames || null, this.maxNode = this.nodeSet.types.length - 1, this.dialect = this.parseDialect(), this.top = this.topRules[Object.keys(this.topRules)[0]];
	}
	createParse(e, t, n) {
		let r = new Rf(this, e, t, n);
	...
	hasAction(e, t) {
		...
		for (let r = 0; r < 2; r++) for (let i = this.stateSlot(e, r ? 2 : 1), a;; i += 3) {
			if ((a = n[i]) == 65535) {
				if (n[i + 1] == 1) a = n[i = Wf(n, i + 2)];
				else if (n[i + 1] == 2) return Wf(n, i + 2);
				else break;
			}
			if (a == t || a == 0) return Wf(n, i + 1);
		}
		return 0;
	}
	stateSlot(e, t) {
	...
	allActions(e, t) {
		...
		for (let n = this.stateSlot(e, 1); r == null; n += 3) {
			if (this.data[n] == 65535) {
				if (this.data[n + 1] == 1) n = Wf(this.data, n + 2);
				else break;
			}
			r = t(Wf(this.data, n + 1));
		}
		return r;
	}
	nextStates(e) {
	...
	configure(t) {
		...
		return t.tokenizers && (n.tokenizers = this.tokenizers.map((e) => {
			...
			return n.specializers[r] = Kf(a), a;
...
//#endregion
export { z as $, Lu as A, C as At, Gl as B, ae as Bt, Td as C, se as Ct, Qu as D, T as Dt, $u as E, Oe as Et, Jd as F, D as Ft, q as G, J as H, xt as Ht, hu as I, Ce as It, Y as J, xl as K, jd as L, f as Lt, Pu as M, A as Mt, Mu as N, ut as Nt, Nu as O, k as Ot, pu as P, it as Pt, W as Q, vu as R, O as Rt, pd as S, Ve as St, gd as T, Qe as Tt, K as U, S as Ut, Z as V, rt as Vt, $c as W, ie as Wt, F as X, Tl as Y, I as Z, Pd as _, Ro as _t, Dd as a, es as at, yu as b, Js as bt, Q as c, Ds as ct, Su as d, Jc as dt, en as et, nf as f, rc as ft, Yu as g, Fs as gt, Gd as h, R as ht, kf as i, us as it, Zu as j, Ee as jt, Fu as k, E as kt, Au as l, Uc as lt, Wd as m, zc as mt, Af as n, Rs as nt, Iu as o, cc as ot, Qd as p, Fo as pt, Cl as q, Uf as r, $o as rt, _u as s, ac as st, Hf as t, ic as tt, ku as u, bs as ut, mu as v, pc as vt, ed as w, ce as wt, Ju as x, It as xt, Ku as y, fc as yt, Bl as z, re as zt };

//# sourceMappingURL=dist-CVKUUr4R.js.map