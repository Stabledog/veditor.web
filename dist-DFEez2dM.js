...
var Vc = /* @__PURE__ */ F.mark({ class: "cm-highlightTab" }), Hc = /* @__PURE__ */ F.mark({ class: "cm-highlightSpace" }), Uc = /* @__PURE__ */ Bc(/* @__PURE__ */ new ls({
	regexp: /\t| /g,
	decoration: (e) => e[0] == "	" ? Vc : Hc,
	boundary: /\S/
}));
function Wc() {
	return Uc;
...
var Gc = 1024, Kc = 0, G = class {
	constructor(e, t) {
		this.from = e, this.to = t;
	}
}, K = class {
	constructor(e = {}) {
		this.id = Kc++, this.perNode = !!e.perNode, this.deserialize = e.deserialize || (() => {
...
}, Jc = Object.create(null), q = class e {
	constructor(e, t, n, r = 0) {
		this.name = e, this.props = t, this.id = n, this.flags = r;
	}
	static define(t) {
		let n = t.props && t.props.length ? Object.create(null) : Jc, r = !!t.top | (t.skipped ? 2 : 0) | (t.error ? 4 : 0) | (t.name == null ? 8 : 0), i = new e(t.name || "", n, t.id, r);
		if (t.props) {
...
}, Xc = /* @__PURE__ */ new WeakMap(), Zc = /* @__PURE__ */ new WeakMap(), J;
(function(e) {
...
var Y = class e {
	...
	cursorAt(e, t = 0, n = 0) {
		let r = new dl(Xc.get(this) || this.topNode);
		return r.moveTo(e, t), Xc.set(this, r._tree), r;
	}
	get topNode() {
		return new rl(this, 0, 0, null);
	}
	resolve(e, t = 0) {
		let n = tl(Xc.get(this) || this.topNode, e, t, !1);
		return Xc.set(this, n), n;
	}
	resolveInner(e, t = 0) {
		let n = tl(Zc.get(this) || this.topNode, e, t, !0);
		return Zc.set(this, n), n;
	}
	resolveStack(e, t = 0) {
		return ul(this, e, t);
	}
	...
	balance(t = {}) {
		return this.children.length <= 8 ? this : gl(q.none, this.children, this.positions, 0, this.children.length, 0, this.length, (t, n, r) => new e(this.type, t, n, r, this.propValues), t.makeTree || ((t, n, r) => new e(q.none, t, n, r)));
	}
	static build(e) {
		return pl(e);
	}
...
var Qc = class e {
	...
	findChild(e, t, n, r, i) {
		...
		for (let s = e; s != t && !(el(i, r, a[s + 1], a[s + 2]) && (o = s, n > 0)); s = a[s + 3]);
		return o;
	}
	slice(t, n, r) {
...
function tl(e, t, n, r) {
	for (; e.from == e.to || (n < 1 ? e.from >= t : e.from > t) || (n > -1 ? e.to <= t : e.to < t);) {
		let t = !r && e instanceof rl && e.index < 0 ? null : e.parent;
		if (!t) return e;
		e = t;
	}
	let i = r ? 0 : J.IgnoreOverlays;
	if (r) for (let r = e, a = r.parent; a; r = a, a = r.parent) r instanceof rl && r.index < 0 && a.enter(t, n, i)?.from != r.from && (e = a);
	for (;;) {
		let r = e.enter(t, n, i);
		if (!r) return e;
		e = r;
...
var nl = class {
	...
	resolveInner(e, t = 0) {
		return tl(this, e, t, !0);
	}
	matchContext(e) {
		return al(this.parent, e);
	}
	...
	nextChild(t, n, r, i, a = 0) {
		for (let o = this;;) {
			for (let { children: s, positions: c } = o._tree, l = n > 0 ? s.length : -1; t != l; t += n) {
				...
				if (!(!(a & J.EnterBracketed && l instanceof Y && (d = qc.get(l)) && !d.overlay && d.bracketed && r >= u && r <= u + l.length) && !el(i, r, u, u + l.length))) {
					if (l instanceof $c) {
						if (a & J.ExcludeBuffers) continue;
						let e = l.findChild(0, l.buffer.length, n, r - u, i);
						if (e > -1) return new sl(new ol(o, l, t, u), null, e);
					} else if (a & J.IncludeAnonymous || !l.type.isAnonymous || fl(l)) {
						let s;
						if (!(a & J.IgnoreMounts) && (s = qc.get(l)) && !s.overlay) return new e(s.tree, u, t, o);
						let c = new e(l, u, t, o);
	...
	enter(t, n, r = 0) {
		let i;
		if (!(r & J.IgnoreOverlays) && (i = qc.get(this._tree)) && i.overlay) {
...
function cl(e) {
	...
	let r = n instanceof rl && n.index < 0 ? null : n.parent, i = e.slice();
	return r ? i[t] = r : i.splice(t, 1), new ll(i, n);
}
var ll = class {
	constructor(e, t) {
...
function ul(e, t, n) {
	...
	for (let e = r instanceof rl ? r : r.context.parent; e; e = e.parent) if (e.index < 0) {
		let a = e.parent;
		(i ||= [r]).push(a.resolve(t, n)), e = a;
	} else {
		let a = qc.get(e.tree);
		if (a && a.overlay && a.overlay[0].from <= t && a.overlay[a.overlay.length - 1].to >= t) {
			let o = new rl(a.tree, a.overlay[0].from + e.from, -1, e);
			(i ||= [r]).push(tl(o, t, n, !1));
		}
	}
	return i ? cl(i) : r;
...
var dl = class {
	...
	constructor(e, t = 0) {
		if (this.buffer = null, this.stack = [], this.index = 0, this.bufferNode = null, this.mode = t & ~J.EnterBracketed, e instanceof rl) this.yieldNode(e);
		else {
	...
	yield(e) {
		return e ? e instanceof rl ? (this.buffer = null, this.yieldNode(e)) : (this.buffer = e.context, this.yieldBuf(e.index, e.type)) : !1;
	}
	toString() {
	...
	atLastNode(e) {
		...
		for (; n; {index: t, _parent: n} = n) if (t > -1) for (let r = t + e, i = e < 0 ? -1 : n._tree.children.length; r != i; r += e) {
			...
			if (this.mode & J.IncludeAnonymous || e instanceof $c || !e.type.isAnonymous || fl(e)) return !1;
		}
		return !0;
	}
	move(e, t) {
	...
	matchContext(e) {
		if (!this.buffer) return al(this.node.parent, e);
		let { buffer: t } = this.buffer, { types: n } = t.set;
		for (let r = e.length - 1, i = this.stack.length - 1; r >= 0; i--) {
			if (i < 0) return al(this._tree, e, r);
...
function fl(e) {
	return e.children.some((e) => e instanceof $c || !e.type.isAnonymous || fl(e));
}
function pl(e) {
	let { buffer: t, nodeSet: n, maxBufferLength: r = Gc, reused: i = [], minRepeatType: a = n.types.length } = e, o = Array.isArray(t) ? new Qc(t, t.length) : t, s = n.types, c = 0, l = 0;
	function u(e, t, _, v, y, ee) {
		...
		if (S - x <= r && (oe = h(o.pos - t, y))) {
			...
			ae = new $c(t, S - oe.start, n), C = oe.start - e;
		} else {
			let e = o.pos - te;
			o.next();
			...
			if (i >= 0 && s > 0 && s < t.length && p(t, n, x, s, x, c, i, ne, re), t.reverse(), n.reverse(), i > -1 && s > 0) {
				let e = f(ie, re);
				ae = gl(ie, t, n, 0, t.length, 0, S - x, e, e);
	...
	function d(e, t, i, a) {
		...
		if (c) {
			...
			i.push(new $c(t, s[2] - r, n)), a.push(r - e);
		}
	}
	function f(e, t) {
		return (n, r, i) => {
...
function hl(e, t) {
	if (!e.isAnonymous || t instanceof $c || t.type != e) return 1;
	let n = ml.get(t);
	if (n == null) {
		n = 1;
...
function gl(e, t, n, r, i, a, o, s, c) {
	let l = 0;
	for (let n = r; n < i; n++) l += hl(e, t[n]);
	let u = Math.ceil(l * 1.5 / 8), d = [], f = [];
	function p(t, n, r, i, o) {
		for (let s = r; s < i;) {
			let r = s, l = n[s], m = hl(e, t[s]);
			for (s++; s < i; s++) {
				let n = hl(e, t[s]);
				if (m + n >= u) break;
				m += n;
			...
			if (s == r + 1) {
				...
				d.push(gl(e, t, n, r, s, l, i, null, c));
			}
			f.push(l + o - a);
		}
	}
...
var _l = class {
	...
	set(e, t) {
		e instanceof sl ? this.setBuffer(e.context.buffer, e.index, t) : e instanceof rl && this.map.set(e.tree, t);
	}
	get(e) {
		return e instanceof sl ? this.getBuffer(e.context.buffer, e.index) : e instanceof rl ? this.map.get(e.tree) : void 0;
	}
	cursorSet(e, t) {
	...
	startParse(e, t, n) {
		return typeof e == "string" && (e = new bl(e)), n = n ? n.length ? n.map((e) => new G(e.from, e.to)) : [new G(0, 0)] : [new G(0, e.length)], this.createParse(e, t || [], n);
	}
	parse(e, t, n) {
...
function xl(e) {
	return (t, n, r, i) => new El(t, e, n, r, i);
}
var Sl = class {
	constructor(e, t, n, r, i, a) {
...
var wl = class {
	...
	advance() {
		...
		if (this.innerDone == this.inner.length) {
			let e = this.baseTree;
			return this.stoppedAt != null && (e = new Y(e.type, e.children, e.positions, e.length, e.propValues.concat([[Tl, this.stoppedAt]]))), e;
		}
		let e = this.inner[this.innerDone], t = e.parse.advance();
		if (t) {
			this.innerDone++;
			let n = Object.assign(Object.create(null), e.target.props);
			n[K.mounted.id] = new qc(t, e.overlay, e.parser, e.bracketed), e.target.props = n;
		}
		return null;
	}
	get parsedPos() {
	...
	startInner() {
		let e = new jl(this.fragments), t = null, n = null, r = new dl(new rl(this.baseTree, this.ranges[0].from, 0, null), J.IncludeAnonymous | J.IgnoreMounts);
		scan: for (let i, a;;) {
			let o = !0, s;
			if (this.stoppedAt != null && r.from >= this.stoppedAt) o = !1;
				...
				o = !1;
			} else if (n && (a = Dl(n.ranges, r.from, r.to))) o = a != 2;
			else if (!r.type.isAnonymous && (i = this.nest(r, this.input)) && (r.from < r.to || !i.overlay)) {
				r.tree || (kl(r), t && t.depth++, n && n.depth++);
				let a = e.findMounts(r.from, i.parser);
				if (typeof i.overlay == "function") t = new wl(i.parser, i.overlay, a, this.inner.length, r.from, !!i.bracketed, r.tree, t);
				else {
					let e = Ml(this.ranges, i.overlay || (r.from < r.to ? [new G(r.from, r.to)] : []));
					e.length && Cl(e), (e.length || !i.overlay) && this.inner.push(new Sl(i.parser, e.length ? i.parser.startParse(this.input, Pl(a, e), e) : i.parser.startParse(""), i.overlay ? i.overlay.map((e) => new G(e.from - r.from, e.to - r.from)) : null, !!i.bracketed, r.tree, e.length ? e[0].from : r.from)), i.overlay ? e.length && (n = {
						ranges: e,
						depth: 0,
						prev: n
					}) : o = !1;
			...
			if (o && r.firstChild()) t && t.depth++, n && n.depth++;
				...
				if (t && !--t.depth) {
					let e = Ml(this.ranges, t.ranges);
					e.length && (Cl(e), this.inner.splice(t.index, 0, new Sl(t.parser, t.parser.startParse(this.input, Pl(t.mounts, e), e), t.ranges.map((e) => new G(e.from - t.start, e.to - t.start)), t.bracketed, t.target, e[0].from))), t = t.prev;
				}
				n && !--n.depth && (n = n.prev);
			}
		}
...
var Al = class {
	...
	constructor(e) {
		if (this.fragments = e, this.curTo = 0, this.fragI = 0, e.length) {
			...
			this.curTo = t.tree.prop(Tl) ?? t.to, this.inner = new Al(t.tree, -t.offset);
	...
	nextFrag() {
		if (this.fragI++, this.fragI == this.fragments.length) this.curFrag = this.inner = null;
			...
			this.curTo = e.tree.prop(Tl) ?? e.to, this.inner = new Al(e.tree, -e.offset);
		}
	}
	findMounts(e, t) {
		let n = [];
...
function Pl(e, t) {
	...
	for (let { pos: r, mount: i, frag: a } of e) {
		...
		if (i.overlay) {
			let o = Nl(t, i.overlay.map((e) => new G(e.from + r, e.to + r)), s, c);
			for (let t = 0, r = s;; t++) {
				let s = t == o.length, l = s ? c : o[t].from;
				if (l > r && n.push(new vl(r, l, i.tree, -e, a.from >= r || a.openStart, a.to <= l || a.openEnd)), s) break;
				r = o[t].to;
			}
		} else n.push(new vl(s, c, i.tree, -e, a.from >= e || a.openStart, a.to <= o || a.openEnd));
	}
	return n;
}
//#endregion
...
var Fl = 0, Il = class e {
	...
	static defineModifier(e) {
		let t = new Rl(e);
		return (e) => e.modified.indexOf(t) > -1 ? e : Rl.get(e.base || e, e.modified.concat(t).sort((e, t) => e.id - t.id));
	}
}, Ll = 0, Rl = class e {
	constructor(e) {
		this.name = e, this.instances = [], this.id = Ll++;
	}
	static get(t, n) {
		if (!n.length) return t;
		let r = n[0].instances.find((e) => e.base == t && zl(n, e.modified));
		if (r) return r;
		let i = [], a = new Il(t.name, i, t, n);
...
function Vl(e) {
	...
	for (let n in e) {
		...
		for (let e of n.split(" ")) if (e) {
			...
			t[s] = new Ul(r, i, o > 0 ? n.slice(0, o) : null).sort(t[s]);
		}
	}
	return Hl.add(t);
}
var Hl = new K({ combine(e, t) {
	let n, r, i;
	for (; e || t;) {
		if (!e || t && e.depth >= t.depth ? (i = t, t = t.next) : (i = e, e = e.next), n && n.mode == i.mode && !i.context && !n.context) continue;
		let a = new Ul(i.tags, i.mode, i.context);
		n ? n.next = a : r = a, n = a;
	}
	return r;
} }), Ul = class {
...
function Kl(e, t, n, r = 0, i = e.length) {
...
var ql = class {
	...
	highlightRange(e, t, n, r, i) {
		...
		let c = r, l = Jl(e) || Ul.empty, u = Gl(i, l.tags);
...
function Jl(e) {
	let t = e.type.prop(Hl);
	for (; t && t.context && !e.matchContext(t.context);) t = t.next;
	return t || null;
}
var X = Il.define, Yl = X(), Xl = X(), Zl = X(Xl), Ql = X(Xl), $l = X(), eu = X($l), tu = X($l), nu = X(), ru = X(nu), iu = X(), au = X(), ou = X(), su = X(ou), cu = X(), Z = {
	comment: Yl,
	lineComment: X(Yl),
	blockComment: X(Yl),
	docComment: X(Yl),
	...
	unit: X(iu),
	modifier: X(iu),
	operatorKeyword: X(iu),
	controlKeyword: X(iu),
	definitionKeyword: X(iu),
	moduleKeyword: X(iu),
	operator: au,
	derefOperator: X(au),
	arithmeticOperator: X(au),
	logicOperator: X(au),
	bitwiseOperator: X(au),
	compareOperator: X(au),
	updateOperator: X(au),
	definitionOperator: X(au),
	typeOperator: X(au),
	controlOperator: X(au),
	punctuation: ou,
	separator: X(ou),
	bracket: su,
	angleBracket: X(su),
	...
	documentMeta: X(cu),
	annotation: X(cu),
	processingInstruction: X(cu),
	definition: Il.defineModifier("definition"),
	constant: Il.defineModifier("constant"),
	function: Il.defineModifier("function"),
	standard: Il.defineModifier("standard"),
	local: Il.defineModifier("local"),
	special: Il.defineModifier("special")
};
for (let e in Z) {
	let t = Z[e];
	t instanceof Il && (t.name = e);
}
Wl([
	{
		tag: Z.link,
...
var lu = /* @__PURE__ */ new K();
function uu(e) {
	return E.define({ combine: e ? (t) => t.concat(e) : void 0 });
}
var du = /* @__PURE__ */ new K(), Q = class {
	constructor(e, t, n = [], r = "") {
		this.data = e, this.name = r, k.prototype.hasOwnProperty("tree") || Object.defineProperty(k.prototype, "tree", { get() {
			return mu(this);
		} }), this.parser = t, this.extension = [wu.of(this), k.languageData.of((e, t, n) => {
			let r = fu(e, t, n), i = r.type.prop(lu);
			if (!i) return [];
	...
	isActiveAt(e, t, n = -1) {
		return fu(e, t, n).type.prop(lu) == this.data;
	}
	findRegions(e) {
		let t = e.facet(wu);
...
function fu(e, t, n) {
	let r = e.facet(wu), i = mu(e).topNode;
	if (!r || r.allowsNesting) for (let e = i; e; e = e.enter(t, n, J.ExcludeBuffers | J.EnterBracketed)) e.type.isTop && (i = e);
	return i;
}
var pu = class e extends Q {
	constructor(e, t, n) {
		super(e, t, [], n), this.parser = t;
	}
	static define(t) {
		let n = uu(t.languageData);
		return new e(n, t.parser.configure({ props: [lu.add((e) => e.isTop ? n : void 0)] }), t.name);
	}
	configure(t, n) {
...
var gu = class {
	...
	work(e, t) {
		return t != null && t >= this.state.doc.length && (t = void 0), this.tree != Y.empty && this.isDone(t ?? this.state.doc.length) ? (this.takeTree(), !0) : this.withContext(() => {
			...
			for (this.parse ||= this.startParse(), t != null && (this.parse.stoppedAt == null || this.parse.stoppedAt > t) && t < this.state.doc.length && this.parse.stopAt(t);;) {
				...
				if (n) if (this.fragments = this.withoutTempSkipped(vl.addTree(n, this.fragments, this.parse.stoppedAt != null)), this.treeLen = this.parse.stoppedAt ?? this.state.doc.length, this.tree = n, this.parse = null, this.treeLen < (t ?? this.state.doc.length)) this.parse = this.startParse();
				else return !0;
				if (e()) return !1;
			}
		});
	...
	takeTree() {
		...
		}), this.treeLen = e, this.tree = t, this.fragments = this.withoutTempSkipped(vl.addTree(this.tree, this.fragments, !0)), this.parse = null);
	}
	withContext(e) {
		let t = _u;
		_u = this;
	...
	changes(t, n) {
		...
		if (this.takeTree(), !t.empty) {
			...
			if (t.iterChangedRanges((t, n, r, i) => e.push({
				...
				fromB: r,
				toB: i
			})), r = vl.applyChanges(r, e), i = Y.empty, a = 0, o = {
...
var Su = typeof navigator < "u" && navigator.scheduling?.isInputPending ? () => navigator.scheduling.isInputPending() : null, Cu = /* @__PURE__ */ z.fromClass(class {
	...
	work(e) {
		...
		this.chunkBudget -= Date.now() - t, (s || this.chunkBudget <= 0) && (i.context.takeTree(), this.view.dispatch({ effects: Q.setState.of(new bu(i.context)) })), this.chunkBudget > 0 && !(s && !o) && this.scheduleWork(), this.checkAsyncSchedule(i.context);
	}
...
}, Du = /* @__PURE__ */ E.define(), Ou = /* @__PURE__ */ E.define({ combine: (e) => {
	if (!e.length) return "  ";
	let t = e[0];
...
function Lu(e) {
	...
	if (n && (r = n.type.prop(K.closedBy))) {
		...
		return (e) => Uu(e, !0, 1, void 0, n && !Iu(e) ? t.from : void 0);
	}
...
function Hu({ closing: e, align: t = !0, units: n = 1 }) {
	return (r) => Uu(r, t, n, e);
}
...
var Wu = (e) => e.baseIndent;
function Gu({ except: e, units: t = 1 } = {}) {
	return (n) => {
...
var Ju = /* @__PURE__ */ E.define(), Yu = /* @__PURE__ */ new K();
function Xu(e) {
...
var td = /* @__PURE__ */ D.define({ map: ed }), nd = /* @__PURE__ */ D.define({ map: ed });
function rd(e) {
	let t = [];
	for (let { head: n } of e.state.selection.ranges) t.some((e) => e.from <= n && e.to >= n) || t.push(e.lineBlockAt(n));
	return t;
}
var id = /* @__PURE__ */ Ce.define({
	create() {
		return F.none;
	},
	update(e, t) {
		t.isUserEvent("delete") && t.changes.iterChangedRanges((t, n) => e = ad(e, t, n)), e = e.map(t.changes);
		for (let n of t.effects) if (n.is(td) && !sd(e, n.value.from, n.value.to)) {
			let { preparePlaceholder: r } = t.state.facet(md), i = r ? F.replace({ widget: new vd(r(t.state, n.value)) }) : _d;
			e = e.update({ add: [i.range(n.value.from, n.value.to)] });
		} else n.is(nd) && (e = e.update({
			filter: (e, t) => n.value.from != e || n.value.to != t,
			filterFrom: n.value.from,
			filterTo: n.value.to
		}));
		return t.selection && (e = ad(e, t.selection.main.head)), e;
	},
...
function od(e, t, n) {
	var r;
	let i = null;
	return (r = e.field(id, !1)) == null || r.between(t, n, (e, t) => {
		(!i || i.from > e) && (i = {
			from: e,
			to: t
		});
...
function cd(e, t) {
	return e.field(id, !1) ? t : t.concat(D.appendConfig.of(hd()));
}
var ld = (e) => {
	for (let t of rd(e)) {
		let n = $u(e.state, t.from, t.to);
		if (n) return e.dispatch({ effects: cd(e.state, [td.of(n), dd(e, n)]) }), !0;
	}
	return !1;
}, ud = (e) => {
	if (!e.state.field(id, !1)) return !1;
	let t = [];
	for (let n of rd(e)) {
		let r = od(e.state, n.from, n.to);
		r && t.push(nd.of(r), dd(e, r, !1));
	}
...
var fd = [
	...
	},
	{
		...
		run: (e) => {
			...
			for (let r = 0; r < t.doc.length;) {
				let i = e.lineBlockAt(r), a = $u(t, i.from, i.to);
				a && n.push(td.of(a)), r = (a ? e.lineBlockAt(a.to) : i).to + 1;
			}
			return n.length && e.dispatch({ effects: cd(e.state, n) }), !!n.length;
		}
	},
	{
		key: "Ctrl-Alt-]",
		run: (e) => {
			let t = e.state.field(id, !1);
	...
	placeholderText: "…"
}, md = /* @__PURE__ */ E.define({ combine(e) {
	return rt(e, pd);
} });
function hd(e) {
	let t = [id, Sd];
	return e && t.push(md.of(e)), t;
}
function gd(e, t) {
	let { state: n } = e, r = n.facet(md), i = (t) => {
		let n = e.lineBlockAt(e.posAtDOM(t.target)), r = od(e.state, n.from, n.to);
		r && e.dispatch({ effects: nd.of(r) }), t.preventDefault();
	};
...
var _d = /* @__PURE__ */ F.replace({ widget: /* @__PURE__ */ new class extends en {
	toDOM(e) {
		return gd(e, null);
	}
}() }), vd = class extends en {
...
function xd(e = {}) {
	let t = {
		...yd,
		...e
	}, n = new bd(t, !0), r = new bd(t, !1), i = z.fromClass(class {
		constructor(e) {
			this.from = e.viewport.from, this.markers = this.buildMarkers(e);
		}
		update(e) {
			(e.docChanged || e.viewportChanged || e.startState.facet(wu) != e.state.facet(wu) || e.startState.field(id, !1) != e.state.field(id, !1) || mu(e.startState) != mu(e.state) || t.foldingChanged(e)) && (this.markers = this.buildMarkers(e.view));
		}
		buildMarkers(e) {
			let t = new ut();
			for (let i of e.viewportLineBlocks) {
				let a = od(e.state, i.from, i.to) ? r : $u(e.state, i.from, i.to) ? n : null;
		...
		yc({
			...
			domEventHandlers: {
				...
				click: (e, t, n) => {
					...
					let r = od(e.state, t.from, t.to);
					if (r) return e.dispatch({ effects: nd.of(r) }), !0;
					let i = $u(e.state, t.from, t.to);
					return i ? (e.dispatch({ effects: td.of(i) }), !0) : !1;
				}
			}
		}),
		hd()
...
var Sd = /* @__PURE__ */ W.baseTheme({
	...
	constructor(e, t) {
		...
		this.scope = a instanceof Q ? (e) => e.prop(lu) == a.data : a ? (e) => e == a : void 0, this.style = Wl(e.map((e) => ({
			tag: e.tag,
...
}, wd = /* @__PURE__ */ E.define(), Td = /* @__PURE__ */ E.define({ combine(e) {
	return e.length ? [e[0]] : null;
} });
function Ed(e) {
	let t = e.facet(wd);
	return t.length ? t : e.facet(Td);
}
function Dd(e, t) {
	let n = [kd], r;
	return e instanceof Cd && (e.module && n.push(W.styleModule.of(e.module)), r = e.themeType), t?.fallback ? n.push(Td.of(e)) : r ? n.push(wd.computeN([W.darkTheme], (t) => t.facet(W.darkTheme) == (r == "dark") ? [e] : [])) : n.push(wd.of(e)), n;
}
var Od = class {
	constructor(e) {
		this.markCache = Object.create(null), this.tree = mu(e.state), this.decorations = this.buildDeco(e, Ed(e.state)), this.decoratedTo = e.viewport.to;
	}
	update(e) {
		let t = mu(e.state), n = Ed(e.state), r = n != Ed(e.startState), { viewport: i } = e.view, a = e.changes.mapPos(this.decoratedTo, 1);
	...
	buildDeco(e, t) {
		...
		let n = new ut();
		for (let { from: r, to: i } of e.visibleRanges) Kl(this.tree, t, (e, t, r) => {
			n.add(e, t, this.markCache[r] || (this.markCache[r] = F.mark({ class: r })));
		}, r, i);
		return n.finish();
	}
}, kd = /* @__PURE__ */ Ee.high(/* @__PURE__ */ z.fromClass(Od, { decorations: (e) => e.decorations })), Ad = /* @__PURE__ */ Cd.define([
	{
		tag: Z.meta,
		color: "#404740"
	},
...
]), jd = /* @__PURE__ */ W.baseTheme({
	"&.cm-focused .cm-matchingBracket": { backgroundColor: "#328c8252" },
	"&.cm-focused .cm-nonmatchingBracket": { backgroundColor: "#bb555544" }
}), Md = 1e4, Nd = "()[]{}", Pd = /* @__PURE__ */ E.define({ combine(e) {
	return rt(e, {
		afterCursor: !0,
		brackets: Nd,
		maxScanDistance: Md,
...
} }), Fd = /* @__PURE__ */ F.mark({ class: "cm-matchingBracket" }), Id = /* @__PURE__ */ F.mark({ class: "cm-nonmatchingBracket" });
function Ld(e) {
	let t = [], n = e.matched ? Fd : Id;
...
function Rd(e) {
	...
	for (let r of e.selection.ranges) {
		if (!r.empty) continue;
		let i = Wd(e, r.head, -1, n) || r.head > 0 && Wd(e, r.head - 1, 1, n) || n.afterCursor && (Wd(e, r.head, 1, n) || r.head < e.doc.length && Wd(e, r.head + 1, -1, n));
		i && (t = t.concat(n.renderMatch(i, e)));
	}
	return F.set(t, !0);
}
var zd = [/* @__PURE__ */ z.fromClass(class {
	constructor(e) {
		this.paused = !1, this.decorations = Rd(e.state);
	}
	update(e) {
		(e.docChanged || e.selectionSet || this.paused) && (e.view.composing ? (this.decorations = this.decorations.map(e.changes), this.paused = !0) : (this.decorations = Rd(e.state), this.paused = !1));
	}
}, { decorations: (e) => e.decorations }), jd];
function Bd(e = {}) {
	return [Pd.of(e), zd];
}
var Vd = /* @__PURE__ */ new K();
function Hd(e, t, n) {
...
function Ud(e) {
	let t = e.type.prop(Vd);
	return t ? t(e.node) : e;
}
function Wd(e, t, n, r = {}) {
	let i = r.maxScanDistance || Md, a = r.brackets || Nd, o = mu(e), s = o.resolveInner(t, n);
	for (let r = s; r; r = r.parent) {
		let i = Hd(r.type, n, a);
		if (i && r.from < r.to) {
			let o = Ud(r);
			if (o && (n > 0 ? t >= o.from && t < o.to : t > o.from && t <= o.to)) return Gd(e, t, n, r, o, i, a);
		}
	}
	return Kd(e, t, n, o, s.type, i, a);
}
function Gd(e, t, n, r, i, a, o) {
	...
	if (u && (n < 0 ? u.childBefore(r.from) : u.childAfter(r.to))) do
		if (n < 0 ? u.to <= r.from : u.from >= r.to) {
			...
			} else if (Hd(u.type, n, o)) l++;
			else if (Hd(u.type, -n, o)) {
				if (l == 0) {
					let e = Ud(u);
					return {
						start: c,
...
var Jd = class {
	...
	column() {
		return this.lastColumnPos < this.start && (this.lastColumnValue = qd(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue), this.lastColumnPos = this.start), this.lastColumnValue;
	}
	indentation() {
		return this.overrideIndent ?? qd(this.string, null, this.tabSize);
	}
	match(e, t, n) {
		if (typeof e == "string") {
...
function Yd(e) {
	return {
		...
		copyState: e.copyState || Xd,
		indent: e.indent || (() => null),
		languageData: e.languageData || {},
		tokenTable: e.tokenTable || af,
...
var Zd = /* @__PURE__ */ new WeakMap(), Qd = class e extends Q {
	constructor(e) {
		let t = uu(e.languageData), n = Yd(e), r, i = new class extends yl {
			createParse(e, t, n) {
				return new nf(r, e, t, n);
			}
		}();
		super(t, i, [], e.name), this.topNode = hf(t, this), r = this, this.streamParser = n, this.stateAfter = new K({ perNode: !0 }), this.tokenTable = e.tokenTable ? new df(n.tokenTable) : ff;
	}
	static define(t) {
		return new e(t);
	}
	getIndent(e) {
		...
		n && (t = Zd.get(e.state), t != null && t < e.pos - 1e4 && (t = void 0));
		let r = $d(this, e.node.tree, e.node.from, e.node.from, t ?? e.pos), i, a;
		...
		for (; i < e.pos;) {
			...
			if (t.length) {
				let i = n ? n(t.from) : -1, o = new Jd(t.text, e.state.tabSize, e.unit, i < 0 ? void 0 : i);
				for (; o.pos < r - t.from;) rf(this.streamParser.token, o, a);
			} else this.streamParser.blankLine(a, e.unit);
			if (r == e.pos) break;
			i = t.to + 1;
		}
		let o = e.lineAt(e.pos);
		return n && t == null && Zd.set(e.state, o.from), this.streamParser.indent(a, /^\s*(.*)/.exec(o.text)[1], e);
	}
	get allowsNesting() {
		return !1;
	}
...
function $d(e, t, n, r, i) {
	...
	for (let a = t.children.length - 1; a >= 0; a--) {
		let o = t.children[a], s = n + t.positions[a], c = o instanceof Y && s < i && $d(e, o, s, r, i);
		if (c) return c;
	}
	return null;
}
...
function tf(e, t, n, r, i) {
	for (let i of t) {
		let t = i.from + (i.openStart ? 25 : 0), a = i.to - (i.openEnd ? 25 : 0), o = t <= n && a > n && $d(e, i.tree, 0 - i.offset, n, a), s;
		if (o && o.pos <= r && (s = ef(e, i.tree, n + i.offset, o.pos + i.offset, !1))) return {
			state: o.state,
			tree: s
		};
	}
	return {
		state: e.streamParser.startState(i ? ku(i) : 4),
		tree: Y.empty
	};
}
var nf = class {
	constructor(e, t, n, r) {
		...
		let i = vu.get(), a = r[0].from, { state: o, tree: s } = tf(e, n, a, this.to, i?.state);
		...
		i && this.parsedPos < i.viewport.from - 1e5 && r.some((e) => e.from <= i.viewport.from && e.to >= i.viewport.from) && (this.state = this.lang.streamParser.startState(ku(i.state)), i.skipUntilInView(this.parsedPos, i.viewport.from), this.parsedPos = i.viewport.from), this.moveRangeIndex();
	}
	advance() {
		let e = vu.get(), t = this.stoppedAt == null ? this.to : Math.min(this.to, this.stoppedAt), n = Math.min(t, this.chunkStart + 512);
	...
	parseLine(e) {
		let { line: t, end: n } = this.nextLine(), r = 0, { streamParser: i } = this.lang, a = new Jd(t, e ? e.state.tabSize : 4, e ? ku(e.state) : 2);
		if (a.eol()) i.blankLine(this.state, a.indentUnit);
		else for (; !a.eol();) {
			let e = rf(i.token, a, this.state);
...
var af = /* @__PURE__ */ Object.create(null), of = [q.none], sf = /* @__PURE__ */ new Yc(of), cf = [], lf = /* @__PURE__ */ Object.create(null), uf = /* @__PURE__ */ Object.create(null);
for (let [e, t] of [
...
]) uf[e] = /* @__PURE__ */ mf(af, t);
var df = class {
	constructor(e) {
		this.extra = e, this.table = Object.assign(Object.create(null), uf);
	}
	resolve(e) {
		return e ? this.table[e] || (this.table[e] = mf(this.extra, e)) : 0;
	}
}, ff = /* @__PURE__ */ new df(af);
function pf(e, t) {
	cf.indexOf(e) > -1 || (cf.push(e), console.warn(t));
}
function mf(e, t) {
	let n = [];
	for (let r of t.split(" ")) {
		...
		for (let n of r.split(".")) {
			let r = e[n] || Z[n];
			r ? typeof r == "function" ? t.length ? t = t.map(r) : pf(n, `Modifier ${n} used at start of tag`) : t.length ? pf(n, `Tag ${n} used as modifier`) : t = Array.isArray(r) ? r : [r] : pf(n, `Unknown highlighting tag ${n}`);
		}
		for (let e of t) n.push(e);
	}
	if (!n.length) return 0;
	let r = t.replace(/ /g, "_"), i = r + " " + n.map((e) => e.id), a = lf[i];
	if (a) return a.id;
	let o = lf[i] = q.define({
		id: of.length,
		name: r,
	...
	return of.push(o), o.id;
}
function hf(e, t) {
	let n = q.define({
		id: of.length,
		name: "Document",
		props: [lu.add(() => e), Nu.add(() => (e) => t.getIndent(e))],
		top: !0
	});
	return of.push(n), n;
}
...
var gf = class e {
	...
	static start(t, n, r = 0) {
		...
		return new e(t, [], n, r, r, 0, [], 0, i ? new _f(i, i.start) : null, 0, null);
	}
	get context() {
	...
	updateContext(e) {
		if (e != this.curContext.context) {
			let t = new _f(this.curContext.tracker, e);
...
var xf = class {
	...
	token(e, t) {
		let { parser: n } = t.p;
		Df(this.data, e, t, this.id, n.data, n.tokenPrecTable);
	}
};
wf.prototype.contextual = wf.prototype.fallback = wf.prototype.extend = !1;
var Tf = class {
	constructor(e, t, n) {
		this.precTable = t, this.elseToken = n, this.data = typeof e == "string" ? bf(e) : e;
	}
	token(e, t) {
		let n = e.pos, r = 0;
		for (;;) {
...
Tf.prototype.contextual = wf.prototype.fallback = wf.prototype.extend = !1;
var Ef = class {
	constructor(e, t = {}) {
...
function Df(e, t, n, r, i, a) {
	...
	scan: for (; (s & e[o]) != 0;) {
		...
		for (let r = o + 3; r < n; r += 2) if ((e[r + 1] & s) > 0) {
			let n = e[r];
			if (c.allows(n) && (t.token.value == -1 || t.token.value == n || kf(n, t.token.value, i, a))) {
				t.acceptToken(n);
				break;
			}
		}
...
function kf(e, t, n, r) {
	let i = Of(n, r, t);
	return i < 0 || Of(n, r, e) < i;
}
var $ = typeof process < "u" && process.env && /\bparse\b/.test(process.env.LOG), Af = null;
function jf(e, t, n) {
...
var Mf = class {
	...
	nextFragment() {
		...
		if (e) {
			for (this.safeFrom = e.openStart ? jf(e.tree, e.from + e.offset, 1) - e.offset : e.from, this.safeTo = e.openEnd ? jf(e.tree, e.to + e.offset, -1) - e.offset : e.to; this.trees.length;) this.trees.pop(), this.start.pop(), this.index.pop();
	...
	constructor(e, t) {
		this.stream = t, this.tokens = [], this.mainToken = null, this.actions = [], this.tokens = e.tokenizers.map((e) => new xf());
	}
	getActions(e) {
		...
		return s && e.setLookAhead(s), !n && e.pos == this.stream.end && (n = new xf(), n.value = e.p.parser.eofTerm, n.start = n.end = e.pos, t = this.addActions(e, n.value, n.end, t)), this.mainToken = n, this.actions;
	}
	getMainToken(e) {
		if (this.mainToken) return this.mainToken;
		let t = new xf(), { pos: n, p: r } = e;
	...
	addActions(e, t, n, r) {
		...
		for (let e = 0; e < 2; e++) for (let s = a.stateSlot(i, e ? 2 : 1);; s += 3) {
			if (o[s] == 65535) if (o[s + 1] == 1) s = Bf(o, s + 2);
			else {
				r == 0 && o[s + 1] == 2 && (r = this.putAction(Bf(o, s + 2), t, n, r));
				break;
			}
			o[s] == t && (r = this.putAction(Bf(o, s + 1), t, n, r));
		}
		return r;
	}
}, Pf = class {
	constructor(e, t, n, r) {
		this.parser = e, this.input = t, this.ranges = r, this.recovering = 0, this.nextStackID = 9812, this.minStackPos = 0, this.reused = [], this.stoppedAt = null, this.lastBigReductionStart = -1, this.lastBigReductionSize = 0, this.bigReductionCount = 0, this.stream = new Cf(t, r), this.tokens = new Nf(e, this.stream), this.topTerm = e.top[1];
		let { from: i } = r[0];
		this.stacks = [gf.start(this, e.top[0], i)], this.fragments = n.length && this.stream.end - i > e.bufferLength * 4 ? new Mf(n, e.nodeSet) : null;
	}
	get parsedPos() {
	...
	runRecovery(e, t, n) {
		...
		for (let a = 0; a < e.length; a++) {
			...
			this.stream.end > o.pos ? (c == o.pos && (c++, s = 0), o.recoverByDelete(s, c), $ && console.log(l + this.stackID(o) + ` (via recover-delete ${this.parser.getName(s)})`), Ff(o, n)) : (!r || r.score < u.score) && (r = u);
		}
		return r;
	}
	stackToTree(e) {
	...
	stackID(e) {
		let t = (Af ||= /* @__PURE__ */ new WeakMap()).get(e);
		return t || Af.set(e, t = String.fromCodePoint(this.nextStackID++)), t + e;
	}
};
function Ff(e, t) {
...
var If = class {
	...
	constructor(e) {
		this.start = e.start, this.shift = e.shift || Lf, this.reduce = e.reduce || Lf, this.reuse = e.reuse || Lf, this.hash = e.hash || (() => 0), this.strict = e.strict !== !1;
	}
}, zf = class e extends yl {
	constructor(e) {
		...
		this.nodeSet = new Yc(t.map((t, i) => q.define({
		...
		let a = bf(e.tokenData);
		this.context = e.context, this.specializerSpecs = e.specialized || [], this.specialized = new Uint16Array(this.specializerSpecs.length);
		for (let e = 0; e < this.specializerSpecs.length; e++) this.specialized[e] = this.specializerSpecs[e].term;
		this.specializers = this.specializerSpecs.map(Hf), this.states = bf(e.states, Uint32Array), this.data = bf(e.stateData), this.goto = bf(e.goto), this.maxTerm = e.maxTerm, this.tokenizers = e.tokenizers.map((e) => typeof e == "number" ? new wf(a, e) : e), this.topRules = e.topRules, this.dialects = e.dialects || {}, this.dynamicPrecedences = e.dynamicPrecedences || null, this.tokenPrecTable = e.tokenPrec, this.termNames = e.termNames || null, this.maxNode = this.nodeSet.types.length - 1, this.dialect = this.parseDialect(), this.top = this.topRules[Object.keys(this.topRules)[0]];
	}
	createParse(e, t, n) {
		let r = new Pf(this, e, t, n);
	...
	hasAction(e, t) {
		...
		for (let r = 0; r < 2; r++) for (let i = this.stateSlot(e, r ? 2 : 1), a;; i += 3) {
			if ((a = n[i]) == 65535) if (n[i + 1] == 1) a = n[i = Bf(n, i + 2)];
			else if (n[i + 1] == 2) return Bf(n, i + 2);
			else break;
			if (a == t || a == 0) return Bf(n, i + 1);
		}
		return 0;
	}
	stateSlot(e, t) {
	...
	allActions(e, t) {
		...
		for (let n = this.stateSlot(e, 1); r == null; n += 3) {
			if (this.data[n] == 65535) if (this.data[n + 1] == 1) n = Bf(this.data, n + 2);
			else break;
			r = t(Bf(this.data, n + 1));
		}
		return r;
	}
	nextStates(e) {
	...
	configure(t) {
		...
		return t.tokenizers && (n.tokenizers = this.tokenizers.map((e) => {
			...
			return n.specializers[r] = Hf(a), a;
...
//#endregion
export { z as $, Nu as A, C as At, Vl as B, ae as Bt, xd as C, se as Ct, Ju as D, T as Dt, Yu as E, Oe as Et, Wd as F, D as Ft, q as G, J as H, xt as Ht, du as I, Ce as It, Y as J, _l as K, Dd as L, f as Lt, Au as M, A as Mt, Ou as N, ut as Nt, ku as O, k as Ot, lu as P, it as Pt, W as Q, mu as R, O as Rt, ld as S, Ve as St, fd as T, Qe as Tt, K as U, S as Ut, Z as V, rt as Vt, Yc as W, ie as Wt, F as X, xl as Y, I as Z, Ad as _, Fo as _t, Cd as a, Zo as at, hu as b, Ws as bt, Q as c, Cs as ct, vu as d, Wc as dt, en as et, Qd as f, $s as ft, Gu as g, js as gt, Vd as h, R as ht, Tf as i, os as it, qu as j, Ee as jt, ju as k, E as kt, Eu as l, zc as lt, Bd as m, Fc as mt, Ef as n, Ps as nt, Mu as o, ic as ot, Jd as p, Mo as pt, yl as q, zf as r, Xo as rt, pu as s, tc as st, Rf as t, ec as tt, Tu as u, gs as ut, uu as v, lc as vt, Xu as w, ce as wt, Wu as x, It as xt, Hu as y, cc as yt, Il as z, re as zt };

//# sourceMappingURL=dist-DFEez2dM.js.map