...
function e(e) {
	var t = e.client || {}, n = e.atoms || {
		false: !0,
		true: !0,
		null: !0
	}, r = e.builtin || o(s), i = e.keywords || o(a), c = e.operatorChars || /^[*+\-%<>!=&|~^\/]/, l = e.support || {}, u = e.hooks || {}, d = e.dateSQL || {
		date: !0,
		time: !0,
		timestamp: !0
	}, f = e.backslashStringEscapes !== !1, p = e.brackets || /^[\{}\(\)\[\]]/, m = e.punctuation || /^[;.,:]/;
	function h(e, a) {
		var o = e.next();
		if (u[o]) {
			var s = u[o](e, a);
		...
		if (l.hexNumber && (o == "0" && e.match(/^[xX][0-9a-fA-F]+/) || (o == "x" || o == "X") && e.match(/^'[0-9a-fA-F]*'/)) || l.binaryNumber && ((o == "b" || o == "B") && e.match(/^'[01]+'/) || o == "0" && e.match(/^b[01]*/))) return "number";
		if (o.charCodeAt(0) > 47 && o.charCodeAt(0) < 58) return e.match(/^[0-9]*(\.[0-9]+)?([eE][-+]?[0-9]+)?/), l.decimallessFloat && e.match(/^\.(?!\.)/), "number";
		if (o == "?" && (e.eatSpace() || e.eol() || e.eat(";"))) return "macroName";
		if (o == "'" || o == "\"" && l.doubleQuote) return a.tokenize = g(o), a.tokenize(e, a);
		if ((l.nCharCast && (o == "n" || o == "N") || l.charsetCast && o == "_" && e.match(/[a-z][a-z0-9]*/i)) && (e.peek() == "'" || e.peek() == "\"")) return "keyword";
		if (l.escapeConstant && (o == "e" || o == "E") && (e.peek() == "'" || e.peek() == "\"" && l.doubleQuote)) return a.tokenize = function(e, t) {
			return (t.tokenize = g(e.next(), !0))(e, t);
		}, "keyword";
		if (l.commentSlashSlash && o == "/" && e.eat("/") || l.commentHash && o == "#" || o == "-" && e.eat("-") && (!l.commentSpaceRequired || e.eat(" "))) return e.skipToEnd(), "comment";
		if (o == "/" && e.eat("*")) return a.tokenize = _(1), a.tokenize(e, a);
		if (o == ".") {
			if (l.zerolessFloat && e.match(/^(?:\d+(?:e[+-]?\d+)?)/i)) return "number";
			if (e.match(/^\.+/)) return null;
			if (l.ODBCdotTable && e.match(/^[\w\d_$#]+/)) return "type";
		} else if (c.test(o)) return e.eatWhile(c), "operator";
		else if (p.test(o)) return "bracket";
		else if (m.test(o)) return e.eatWhile(m), "punctuation";
		else if (o == "{" && (e.match(/^( )*(d|D|t|T|ts|TS)( )*'[^']*'( )*}/) || e.match(/^( )*(d|D|t|T|ts|TS)( )*"[^"]*"( )*}/))) return "number";
		else {
			e.eatWhile(/^[_\w\d]/);
			var f = e.current().toLowerCase();
			return d.hasOwnProperty(f) && (e.match(/^( )+'[^']*'/) || e.match(/^( )+"[^"]*"/)) ? "number" : n.hasOwnProperty(f) ? "atom" : r.hasOwnProperty(f) ? "type" : i.hasOwnProperty(f) ? "keyword" : t.hasOwnProperty(f) ? "builtin" : null;
		}
	}
	function g(e, t) {
		return function(n, r) {
	...
	function _(e) {
		return function(t, n) {
			var r = t.match(/^.*?(\/\*|\*\/)/);
			return r ? r[1] == "/*" ? n.tokenize = _(e + 1) : e > 1 ? n.tokenize = _(e - 1) : n.tokenize = h : t.skipToEnd(), "comment";
		};
	}
	function v(e, t, n) {
		t.context = {
	...
	return {
		...
		token: function(e, t) {
			if (e.sol() && t.context && t.context.align == null && (t.context.align = !1), t.tokenize == h && e.eatSpace()) return null;
			var n = t.tokenize(e, t);
			if (n == "comment") return n;
			t.context && t.context.align == null && (t.context.align = !0);
			var r = e.current();
			return r == "(" ? v(e, t, ")") : r == "[" ? v(e, t, "]") : t.context && t.context.type == r && y(t), n;
		},
		indent: function(e, t, n) {
			var r = e.context;
			if (!r) return null;
			var i = t.charAt(0) == r.type;
			return r.align ? r.col + (i ? 0 : 1) : r.indent + (i ? 0 : n.unit);
		},
		languageData: {
			commentTokens: {
...
function r(e) {
	return e.eat("@") && (e.match("session."), e.match("local."), e.match("global.")), e.eat("'") ? (e.match(/^.*'/), "string.special") : e.eat("\"") ? (e.match(/^.*"/), "string.special") : e.eat("`") ? (e.match(/^.*`/), "string.special") : e.match(/^[0-9a-zA-Z$\.\_]+/) ? "string.special" : null;
}
function i(e) {
...
//# sourceMappingURL=sql-_ZRNYlXI.js.map