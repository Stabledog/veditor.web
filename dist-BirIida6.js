import { A as e, B as t, E as n, R as r, V as i, g as a, n as o, r as s, s as c, u as l } from "./dist-DGDkAs66.js";
import { a as u, s as ee } from "./dist-CSQ4JRyB.js";
//#region node_modules/@codemirror/lang-sql/dist/index.js
var te = 36, d = 1, ne = 2, f = 3, p = 4, m = 5, h = 6, g = 7, re = 8, ie = 9, ae = 10, oe = 11, se = 12, ce = 13, le = 14, _ = 15, v = 16, y = 17, b = 18, ue = 19, x = 20, S = 21, C = 22, w = 23, T = 24;
function E(e) {
...
function O(e, t) {
	for (; !(e.next != 95 && !E(e.next));) t != null && (t += String.fromCharCode(e.next)), e.advance();
	return t;
}
function me(e) {
...
function P(e, t, n) {
	...
	r.true = r.false = m, r.null = r.unknown = h;
	for (let t of e.split(" ")) t && (r[t] = x);
	for (let e of t.split(" ")) e && (r[e] = S);
	for (let e of (n || "").split(" ")) e && (r[e] = T);
	return r;
}
var F = {
	backslashEscapes: !1,
...
function L(e) {
	return new o((t) => {
		...
		if (t.advance(), M(n, N)) {
			...
			t.acceptToken(ne);
		} else if ((n == 101 || n == 69) && t.next == 39) t.advance(), D(t, 39, !0), t.acceptToken(f);
		else if ((n == 110 || n == 78) && t.next == 39 && e.charSetCasts) t.advance(), D(t, 39, e.backslashEscapes), t.acceptToken(f);
		else if (n == 95 && e.charSetCasts) for (let n = 0;; n++) {
			if (t.next == 39 && n > 1) {
				t.advance(), D(t, 39, e.backslashEscapes), t.acceptToken(f);
				break;
			}
			if (!E(t.next)) break;
			t.advance();
		}
		else if (e.plsqlQuotingMechanism && (n == 113 || n == 81) && t.next == 39 && t.peek(1) > 0 && !M(t.peek(1), N)) {
			let e = t.peek(1);
			t.advance(2), pe(t, e), t.acceptToken(f);
		} else if (M(n, e.identifierQuotes)) D(t, n == 91 ? 93 : n, !1), t.acceptToken(ue);
		else if (n == 40) t.acceptToken(g);
		else if (n == 41) t.acceptToken(re);
		else if (n == 123) t.acceptToken(ie);
		else if (n == 125) t.acceptToken(ae);
		else if (n == 91) t.acceptToken(oe);
		else if (n == 93) t.acceptToken(se);
		else if (n == 59) t.acceptToken(ce);
		else if (e.unquotedBitLiterals && n == 48 && t.next == 98) t.advance(), k(t), t.acceptToken(C);
		else if ((n == 98 || n == 66) && (t.next == 39 || t.next == 34)) {
			let n = t.next;
			t.advance(), e.treatBitsAsBytes ? (D(t, n, e.backslashEscapes), t.acceptToken(w)) : (k(t, n), t.acceptToken(C));
		} else if (n == 48 && (t.next == 120 || t.next == 88) || (n == 120 || n == 88) && t.next == 39) {
			let e = t.next == 39;
			for (t.advance(); de(t.next);) t.advance();
			e && t.next == 39 && t.advance(), t.acceptToken(p);
		} else if (n == 46 && t.next >= 48 && t.next <= 57) A(t, !0), t.acceptToken(p);
		else if (n == 46) t.acceptToken(le);
		else if (n >= 48 && n <= 57) A(t, !1), t.acceptToken(p);
		else if (M(n, e.operatorChars)) {
			for (; M(t.next, e.operatorChars);) t.advance();
			t.acceptToken(_);
		} else if (M(n, e.specialVar)) t.next == n && t.advance(), me(t), t.acceptToken(y);
		else if (n == 58 || n == 44) t.acceptToken(v);
		else if (E(n)) {
			let r = O(t, String.fromCharCode(n));
			t.acceptToken(t.next == 46 || t.peek(-r.length - 1) == 46 ? b : e.words[r.toLowerCase()] ?? b);
		}
	});
}
var R = /*@__PURE__*/ L(F), z = /*@__PURE__*/ s.deserialize({
	version: 14,
...
function ge(e, t) {
	let n = r(e).resolveInner(t, -1), i = _e(e.doc, n);
...
var W = /*@__PURE__*/ new Set(/*@__PURE__*/ "where group having order union intersect except all distinct limit offset fetch for".split(" "));
function _e(e, t) {
	let n;
	...
	for (let t = n.firstChild, i = !1, a = null; t; t = t.nextSibling) {
		...
		else if (n && W.has(n)) break;
		else a && H(t) && (o = V(e, t));
		o && (r ||= Object.create(null), r[o] = he(e, a)), a = /Identifier$/.test(t.name) ? t : null;
	}
	return r;
}
function ve(e, t, n) {
...
function Se(e, t, n, r, i, a) {
	let o = new xe(a?.spec.identifierQuotes?.[0] || "\"", !!a?.spec.caseInsensitiveIdentifiers), s = i ? o.child(i) : null;
	return o.addNamespace(e), t && (s || o).addCompletions(t), n && o.addCompletions(n), s && o.addCompletions(s.list), r && o.addCompletions((s || o).child(r).list), (e) => {
		let { parents: t, from: n, quoted: i, empty: a, aliases: c } = ge(e.state, e.pos);
...
function Ce(e) {
	return e == S ? "type" : e == x ? "keyword" : "variable";
}
function we(e, t, n) {
	return ee([
		"QuotedIdentifier",
		...
		"BlockComment",
		"."
	], u(Object.keys(e).map((r) => n(t ? r.toUpperCase() : r, Ce(e[r])))));
}
var Te = /*@__PURE__*/ z.configure({ props: [
	...
	static define(t) {
		let n = I(t, t.keywords, t.types, t.builtin);
		return new e(n, c.define({
			name: "sql",
			parser: Te.configure({ tokenizers: [{
				from: R,
				to: L(n)
			}] }),
			languageData: {
...
function Y(e, t = !1, n) {
	return we(e.dialect.words, t, n || Ee);
}
function X(e) {
	return e.schema ? Se(e.schema, e.tables, e.schemas, e.defaultTable, e.defaultSchema, e.dialect || Z) : () => null;
}
function De(e) {
...
function Oe(e = {}) {
	let t = e.dialect || Z;
	return new l(t.language, [De(e), t.language.data.of({ autocomplete: Y(t, e.upperCaseKeywords, e.keywordCompletion) })]);
}
var Z = /*@__PURE__*/ J.define({}), ke = /*@__PURE__*/ J.define({
	charSetCasts: !0,
...
//#endregion
export { Pe as Cassandra, Me as MSSQL, je as MariaSQL, Ae as MySQL, Fe as PLSQL, ke as PostgreSQL, J as SQLDialect, Ne as SQLite, Z as StandardSQL, Y as keywordCompletionSource, X as schemaCompletionSource, Oe as sql };

//# sourceMappingURL=dist-BirIida6.js.map