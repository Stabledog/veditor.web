import { A as e, B as t, E as n, Et as r, Q as i, R as a, V as o, Y as s, n as c, r as l, s as u, u as d, y as f } from "./dist-CXEBfo4y.js";
import { n as p } from "./dist-GoPv4FTn.js";
...
var V = /* @__PURE__ */ i.inputHandler.of((e, t, n, i) => i != "%" || t != n || e.state.doc.sliceString(t - 1, n + 1) != "{}" ? !1 : (e.dispatch(e.state.changeByRange((e) => ({
	changes: {
		from: e.from,
		to: e.to,
		insert: "%%"
...
var U = /* @__PURE__ */ u.define({
	...
	parser: /* @__PURE__ */ j.configure({ props: [
		...
		/* @__PURE__ */ n.add({ "UnlessDirective ForDirective TablerowDirective CaptureDirective IfDirective CaseDirective RawDirective Comment"(e) {
...
//# sourceMappingURL=dist-CembPuXE.js.map